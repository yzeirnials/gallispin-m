...
class Element { public:
    ...
    CLICK_NOINLINE void checked_output_push(int port, Packet *p) const;
    CLICK_NOINLINE Packet* checked_input_pull(int port) const;
    ...
    class Port;
    CLICK_NOINLINE const Port &port(bool isoutput, int port) const;
    CLICK_NOINLINE const Port &input(int port) const;
    CLICK_NOINLINE const Port &output(int port) const;
    ...
    class Port { public:
        ...
        CLICK_NOINLINE void push(Packet* p) const;
...
/* function that dumps memory ^_^ */
void dump_memory_hex(void *ptr, unsigned size);
