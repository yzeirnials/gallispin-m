...
class Vector {
  ...
  public:
    ...
    CLICK_NOINLINE iterator begin();
    CLICK_NOINLINE iterator end();
    CLICK_NOINLINE const_iterator begin() const;
    CLICK_NOINLINE const_iterator end() const;
    CLICK_NOINLINE const_iterator cbegin() const;
    CLICK_NOINLINE const_iterator cend() const;
    ...
    CLICK_NOINLINE T &operator[](size_type i);
    CLICK_NOINLINE const T &operator[](size_type i) const;
