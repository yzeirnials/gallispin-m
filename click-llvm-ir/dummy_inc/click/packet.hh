...
class Packet { public:
    ...
    CLICK_NOINLINE void kill();

    CLICK_NOINLINE bool shared() const;
    Packet *clone() CLICK_WARN_UNUSED_RESULT;
    CLICK_NOINLINE WritablePacket *uniqueify() CLICK_WARN_UNUSED_RESULT;

    CLICK_NOINLINE const unsigned char *data() const;
    CLICK_NOINLINE const unsigned char *end_data() const;
    CLICK_NOINLINE uint32_t length() const;
    ...
    CLICK_NOINLINE WritablePacket *push(uint32_t len) CLICK_WARN_UNUSED_RESULT;
     ...
     *
     * @sa push */
    CLICK_NOINLINE WritablePacket *push_mac_header(uint32_t len) CLICK_WARN_UNUSED_RESULT;
     ...
     *
     * @sa push */
    CLICK_NOINLINE void pull(uint32_t len);
     ...
     *
     * @sa push */
    CLICK_NOINLINE void take(uint32_t len);
    ...
    CLICK_NOINLINE bool has_network_header() const;
    CLICK_NOINLINE const unsigned char *network_header() const;
    inline int network_header_offset() const;
    inline uint32_t network_header_length() const;
    CLICK_NOINLINE int network_length() const;
    ...
    CLICK_NOINLINE bool has_transport_header() const;
    CLICK_NOINLINE const unsigned char *transport_header() const;
    inline int transport_header_offset() const;
    CLICK_NOINLINE int transport_length() const;
    ...
    CLICK_NOINLINE const click_ip *ip_header() const;
    inline int ip_header_offset() const;
    inline uint32_t ip_header_length() const;
    CLICK_NOINLINE void set_ip_header(const click_ip *iph, uint32_t len);

    CLICK_NOINLINE const click_ip6 *ip6_header() const;
    CLICK_NOINLINE int ip6_header_offset() const;
    CLICK_NOINLINE uint32_t ip6_header_length() const;
    CLICK_NOINLINE void set_ip6_header(const click_ip6 *ip6h);
    CLICK_NOINLINE void set_ip6_header(const click_ip6 *ip6h, uint32_t len);
...
#else
    CLICK_NOINLINE const Anno *xanno() const;//		{ return &_aa.cb; }
    CLICK_NOINLINE Anno *xanno();//			{ return &_aa.cb; }
#endif
    /** @endcond never */
  public:
    ...
    CLICK_NOINLINE const Timestamp &timestamp_anno() const;
    /** @overload */
    CLICK_NOINLINE Timestamp &timestamp_anno();
    ...
    CLICK_NOINLINE PacketType packet_type_anno() const;
    /** @brief Set the packet type annotation. */
    CLICK_NOINLINE void set_packet_type_anno(PacketType t);
    ...
    CLICK_NOINLINE void set_dst_ip_anno(IPAddress addr);
	...
	*reinterpret_cast<click_aliasable_int16_t *>(xanno()->c + i) = x;
     ...
     *
     * Affects user annotation bytes [@a i, @a i+3]. */
    CLICK_NOINLINE void set_anno_u32(int i, uint32_t x);
...
class WritablePacket : public Packet { public:
    ...
    CLICK_NOINLINE unsigned char *data() const;
    CLICK_NOINLINE unsigned char *end_data() const;
    ...
    CLICK_NOINLINE unsigned char *network_header() const;
    CLICK_NOINLINE click_ip *ip_header() const;
    CLICK_NOINLINE click_ip6 *ip6_header() const;
