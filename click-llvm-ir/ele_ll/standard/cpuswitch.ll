; ModuleID = '../elements/standard/cpuswitch.cc'
source_filename = "../elements/standard/cpuswitch.cc"
...
@_ZTV9CPUSwitch = dso_local unnamed_addr constant { [29 x i8*] } { [29 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTI9CPUSwitch to i8*), i8* bitcast (void (%class.CPUSwitch*)* @_ZN9CPUSwitchD2Ev to i8*), i8* bitcast (void (%class.CPUSwitch*)* @_ZN9CPUSwitchD0Ev to i8*), i8* bitcast (void (%class.CPUSwitch*, i32, %class.Packet*)* @_ZN9CPUSwitch4pushEiP6Packet to i8*), i8* bitcast (%class.Packet* (%class.Element*, i32)* @_ZN7Element4pullEi to i8*), i8* bitcast (%class.Packet* (%class.Element*, %class.Packet*)* @_ZN7Element13simple_actionEP6Packet to i8*), i8* bitcast (i1 (%class.Element*, %class.Task*)* @_ZN7Element8run_taskEP4Task to i8*), i8* bitcast (void (%class.Element*, %class.Timer*)* @_ZN7Element9run_timerEP5Timer to i8*), i8* bitcast (void (%class.Element*, i32, i32)* @_ZN7Element8selectedEii to i8*), i8* bitcast (void (%class.Element*, i32)* @_ZN7Element8selectedEi to i8*), i8* bitcast (i8* (%class.CPUSwitch*)* @_ZNK9CPUSwitch10class_nameEv to i8*), i8* bitcast (i8* (%class.CPUSwitch*)* @_ZNK9CPUSwitch10port_countEv to i8*), i8* bitcast (i8* (%class.CPUSwitch*)* @_ZNK9CPUSwitch10processingEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element9flow_codeEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element5flagsEv to i8*), i8* bitcast (i8* (%class.Element*, i8*)* @_ZN7Element4castEPKc to i8*), i8* bitcast (i8* (%class.Element*, i1, i32, i8*)* @_ZN7Element9port_castEbiPKc to i8*), i8* bitcast (i32 (%class.Element*)* @_ZNK7Element15configure_phaseEv to i8*), i8* bitcast (i32 (%class.Element*, %class.Vector*, %class.ErrorHandler*)* @_ZN7Element9configureER6VectorI6StringEP12ErrorHandler to i8*), i8* bitcast (void (%class.Element*)* @_ZN7Element12add_handlersEv to i8*), i8* bitcast (i32 (%class.Element*, %class.ErrorHandler*)* @_ZN7Element10initializeEP12ErrorHandler to i8*), i8* bitcast (void (%class.Element*, %class.Element*, %class.ErrorHandler*)* @_ZN7Element10take_stateEPS_P12ErrorHandler to i8*), i8* bitcast (%class.Element* (%class.Element*)* @_ZNK7Element15hotswap_elementEv to i8*), i8* bitcast (void (%class.Element*, i32)* @_ZN7Element7cleanupENS_12CleanupStageE to i8*), i8* bitcast (void (%class.String*, %class.Element*)* @_ZNK7Element11declarationEv to i8*), i8* bitcast (i1 (%class.Element*)* @_ZNK7Element20can_live_reconfigureEv to i8*), i8* bitcast (i32 (%class.Element*, %class.Vector*, %class.ErrorHandler*)* @_ZN7Element16live_reconfigureER6VectorI6StringEP12ErrorHandler to i8*), i8* bitcast (i32 (%class.Element*, i32, i8*)* @_ZN7Element5llrpcEjPv to i8*)] }, align 8
@_ZTVN10__cxxabiv120__si_class_type_infoE = external global i8*
@_ZTS9CPUSwitch = dso_local constant [11 x i8] c"9CPUSwitch\00", align 1
@_ZTI7Element = external constant i8*
@_ZTI9CPUSwitch = dso_local constant { i8*, i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @_ZTS9CPUSwitch, i32 0, i32 0), i8* bitcast (i8** @_ZTI7Element to i8*) }, align 8
...
@_ZN9CPUSwitchC1Ev = dso_local unnamed_addr alias void (%class.CPUSwitch*), void (%class.CPUSwitch*)* @_ZN9CPUSwitchC2Ev
@_ZN9CPUSwitchD1Ev = dso_local unnamed_addr alias void (%class.CPUSwitch*), void (%class.CPUSwitch*)* @_ZN9CPUSwitchD2Ev

; Function Attrs: sspstrong uwtable
define dso_local void @_ZN9CPUSwitchC2Ev(%class.CPUSwitch* %0) unnamed_addr #0 align 2 !dbg !1792 {
  call void @llvm.dbg.value(metadata %class.CPUSwitch* %0, metadata !1815, metadata !DIExpression()), !dbg !1817
  %2 = bitcast %class.CPUSwitch* %0 to %class.Element*, !dbg !1818
  tail call void @_ZN7ElementC2Ev(%class.Element* %2), !dbg !1819
  %3 = getelementptr %class.CPUSwitch, %class.CPUSwitch* %0, i64 0, i32 0, i32 0, !dbg !1818
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [29 x i8*] }, { [29 x i8*] }* @_ZTV9CPUSwitch, i64 0, inrange i32 0, i64 2) to i32 (...)**), i32 (...)*** %3, align 8, !dbg !1818, !tbaa !1820
  ret void, !dbg !1823
}
...
define dso_local void @_ZN9CPUSwitchD2Ev(%class.CPUSwitch* %0) unnamed_addr #4 align 2 !dbg !1824 {
  call void @llvm.dbg.value(metadata %class.CPUSwitch* %0, metadata !1826, metadata !DIExpression()), !dbg !1827
  %2 = bitcast %class.CPUSwitch* %0 to %class.Element*, !dbg !1828
  tail call void @_ZN7ElementD2Ev(%class.Element* %2) #9, !dbg !1828
  ret void, !dbg !1830
}

; Function Attrs: nounwind sspstrong uwtable
define dso_local void @_ZN9CPUSwitchD0Ev(%class.CPUSwitch* %0) unnamed_addr #4 align 2 !dbg !1831 {
  call void @llvm.dbg.value(metadata %class.CPUSwitch* %0, metadata !1833, metadata !DIExpression()), !dbg !1834
  call void @llvm.dbg.value(metadata %class.CPUSwitch* %0, metadata !1826, metadata !DIExpression()) #9, !dbg !1835
  %2 = bitcast %class.CPUSwitch* %0 to %class.Element*, !dbg !1837
  tail call void @_ZN7ElementD2Ev(%class.Element* %2) #9, !dbg !1837
  %3 = bitcast %class.CPUSwitch* %0 to i8*, !dbg !1838
  tail call void @_ZdlPv(i8* %3) #10, !dbg !1838
  ret void, !dbg !1839
}
...
; Function Attrs: sspstrong uwtable
define dso_local void @_ZN9CPUSwitch4pushEiP6Packet(%class.CPUSwitch* %0, i32 %1, %class.Packet* %2) unnamed_addr #0 align 2 !dbg !1840 {
  call void @llvm.dbg.value(metadata %class.CPUSwitch* %0, metadata !1842, metadata !DIExpression()), !dbg !1846
  call void @llvm.dbg.value(metadata i32 undef, metadata !1843, metadata !DIExpression()), !dbg !1846
  call void @llvm.dbg.value(metadata %class.Packet* %2, metadata !1844, metadata !DIExpression()), !dbg !1846
  %4 = bitcast %class.CPUSwitch* %0 to %class.Element*, !dbg !1847
  call void @llvm.dbg.value(metadata i32 0, metadata !1845, metadata !DIExpression()), !dbg !1846
  %5 = tail call dereferenceable(16) %"class.Element::Port"* @_ZNK7Element6outputEi(%class.Element* %4, i32 0), !dbg !1848
  tail call void @_ZNK7Element4Port4pushEP6Packet(%"class.Element::Port"* nonnull %5, %class.Packet* %2), !dbg !1849
  ret void, !dbg !1850
}

; Function Attrs: noinline optnone sspstrong uwtable
define linkonce_odr dso_local dereferenceable(16) %"class.Element::Port"* @_ZNK7Element6outputEi(%class.Element* %0, i32 %1) local_unnamed_addr #6 comdat align 2 !dbg !1851 {
  %3 = alloca %class.Element*, align 8
  %4 = alloca i32, align 4
  store %class.Element* %0, %class.Element** %3, align 8, !tbaa !1894
  call void @llvm.dbg.declare(metadata %class.Element** %3, metadata !1891, metadata !DIExpression()), !dbg !1897
  store i32 %1, i32* %4, align 4, !tbaa !1898
  call void @llvm.dbg.declare(metadata i32* %4, metadata !1893, metadata !DIExpression()), !dbg !1900
  %5 = load %class.Element*, %class.Element** %3, align 8
  %6 = load i32, i32* %4, align 4, !dbg !1901, !tbaa !1898
  %7 = call dereferenceable(16) %"class.Element::Port"* @_ZNK7Element4portEbi(%class.Element* %5, i1 zeroext true, i32 %6), !dbg !1902
  ret %"class.Element::Port"* %7, !dbg !1903
}

; Function Attrs: noinline optnone sspstrong uwtable
define linkonce_odr dso_local void @_ZNK7Element4Port4pushEP6Packet(%"class.Element::Port"* %0, %class.Packet* %1) local_unnamed_addr #6 comdat align 2 !dbg !1904 {
  %3 = alloca %"class.Element::Port"*, align 8
  %4 = alloca %class.Packet*, align 8
  store %"class.Element::Port"* %0, %"class.Element::Port"** %3, align 8, !tbaa !1894
  call void @llvm.dbg.declare(metadata %"class.Element::Port"** %3, metadata !1906, metadata !DIExpression()), !dbg !1909
  store %class.Packet* %1, %class.Packet** %4, align 8, !tbaa !1894
  call void @llvm.dbg.declare(metadata %class.Packet** %4, metadata !1908, metadata !DIExpression()), !dbg !1910
  %5 = load %"class.Element::Port"*, %"class.Element::Port"** %3, align 8
  %6 = getelementptr inbounds %"class.Element::Port", %"class.Element::Port"* %5, i32 0, i32 0, !dbg !1911
  %7 = load %class.Element*, %class.Element** %6, align 8, !dbg !1911, !tbaa !1912
  %8 = icmp ne %class.Element* %7, null, !dbg !1911
  br i1 %8, label %9, label %12, !dbg !1911

9:                                                ; preds = %2
  %10 = load %class.Packet*, %class.Packet** %4, align 8, !dbg !1911, !tbaa !1894
  %11 = icmp ne %class.Packet* %10, null, !dbg !1911
  br label %12

12:                                               ; preds = %9, %2
  %13 = phi i1 [ false, %2 ], [ %11, %9 ], !dbg !1909
  br i1 %13, label %14, label %15, !dbg !1911

14:                                               ; preds = %12
  br label %16, !dbg !1911

15:                                               ; preds = %12
  call void @__assert_fail(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.1, i64 0, i64 0), i32 611, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @__PRETTY_FUNCTION__._ZNK7Element4Port4pushEP6Packet, i64 0, i64 0)) #11, !dbg !1911
  unreachable, !dbg !1911

16:                                               ; preds = %14
  %17 = getelementptr inbounds %"class.Element::Port", %"class.Element::Port"* %5, i32 0, i32 0, !dbg !1914
  %18 = load %class.Element*, %class.Element** %17, align 8, !dbg !1914, !tbaa !1912
  %19 = getelementptr inbounds %"class.Element::Port", %"class.Element::Port"* %5, i32 0, i32 1, !dbg !1915
  %20 = load i32, i32* %19, align 8, !dbg !1915, !tbaa !1916
  %21 = load %class.Packet*, %class.Packet** %4, align 8, !dbg !1917, !tbaa !1894
  %22 = bitcast %class.Element* %18 to void (%class.Element*, i32, %class.Packet*)***, !dbg !1918
  %23 = load void (%class.Element*, i32, %class.Packet*)**, void (%class.Element*, i32, %class.Packet*)*** %22, align 8, !dbg !1918, !tbaa !1820
  %24 = getelementptr inbounds void (%class.Element*, i32, %class.Packet*)*, void (%class.Element*, i32, %class.Packet*)** %23, i64 2, !dbg !1918
  %25 = load void (%class.Element*, i32, %class.Packet*)*, void (%class.Element*, i32, %class.Packet*)** %24, align 8, !dbg !1918
  call void %25(%class.Element* %18, i32 %20, %class.Packet* %21), !dbg !1918
  ret void, !dbg !1919
}
...
; Function Attrs: nounwind sspstrong uwtable
define linkonce_odr dso_local i8* @_ZNK9CPUSwitch10class_nameEv(%class.CPUSwitch* %0) unnamed_addr #4 comdat align 2 !dbg !1920 {
  call void @llvm.dbg.value(metadata %class.CPUSwitch* %0, metadata !1922, metadata !DIExpression()), !dbg !1924
  ret i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.3, i64 0, i64 0), !dbg !1925
}

; Function Attrs: nounwind sspstrong uwtable
define linkonce_odr dso_local i8* @_ZNK9CPUSwitch10port_countEv(%class.CPUSwitch* %0) unnamed_addr #4 comdat align 2 !dbg !1926 {
  call void @llvm.dbg.value(metadata %class.CPUSwitch* %0, metadata !1928, metadata !DIExpression()), !dbg !1929
  ret i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.4, i64 0, i64 0), !dbg !1930
}

; Function Attrs: nounwind sspstrong uwtable
define linkonce_odr dso_local i8* @_ZNK9CPUSwitch10processingEv(%class.CPUSwitch* %0) unnamed_addr #4 comdat align 2 !dbg !1931 {
  call void @llvm.dbg.value(metadata %class.CPUSwitch* %0, metadata !1933, metadata !DIExpression()), !dbg !1934
  ret i8* getelementptr inbounds ([0 x i8], [0 x i8]* @_ZN7Element4PUSHE, i64 0, i64 0), !dbg !1935
}
...
define linkonce_odr dso_local dereferenceable(16) %"class.Element::Port"* @_ZNK7Element4portEbi(%class.Element* %0, i1 zeroext %1, i32 %2) local_unnamed_addr #7 comdat align 2 !dbg !1936 {
  %4 = alloca %class.Element*, align 8
  %5 = alloca i8, align 1
  %6 = alloca i32, align 4
  store %class.Element* %0, %class.Element** %4, align 8, !tbaa !1894
  call void @llvm.dbg.declare(metadata %class.Element** %4, metadata !1941, metadata !DIExpression()), !dbg !1944
  %7 = zext i1 %1 to i8
  store i8 %7, i8* %5, align 1, !tbaa !1945
  call void @llvm.dbg.declare(metadata i8* %5, metadata !1942, metadata !DIExpression()), !dbg !1947
  store i32 %2, i32* %6, align 4, !tbaa !1898
  call void @llvm.dbg.declare(metadata i32* %6, metadata !1943, metadata !DIExpression()), !dbg !1948
  %8 = load %class.Element*, %class.Element** %4, align 8
  %9 = load i32, i32* %6, align 4, !dbg !1949, !tbaa !1898
  %10 = getelementptr inbounds %class.Element, %class.Element* %8, i32 0, i32 3, !dbg !1949
  %11 = load i8, i8* %5, align 1, !dbg !1949, !tbaa !1945, !range !1950
  %12 = trunc i8 %11 to i1, !dbg !1949
  %13 = zext i1 %12 to i64, !dbg !1949
  %14 = getelementptr inbounds [2 x i32], [2 x i32]* %10, i64 0, i64 %13, !dbg !1949
  %15 = load i32, i32* %14, align 4, !dbg !1949, !tbaa !1898
  %16 = icmp ult i32 %9, %15, !dbg !1949
  br i1 %16, label %17, label %18, !dbg !1949

17:                                               ; preds = %3
  br label %19, !dbg !1949

18:                                               ; preds = %3
  call void @__assert_fail(i8* getelementptr inbounds ([47 x i8], [47 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.1, i64 0, i64 0), i32 437, i8* getelementptr inbounds ([52 x i8], [52 x i8]* @__PRETTY_FUNCTION__._ZNK7Element4portEbi, i64 0, i64 0)) #11, !dbg !1949
  unreachable, !dbg !1949

19:                                               ; preds = %17
  %20 = getelementptr inbounds %class.Element, %class.Element* %8, i32 0, i32 1, !dbg !1951
  %21 = load i8, i8* %5, align 1, !dbg !1952, !tbaa !1945, !range !1950
  %22 = trunc i8 %21 to i1, !dbg !1952
  %23 = zext i1 %22 to i64, !dbg !1951
  %24 = getelementptr inbounds [2 x %"class.Element::Port"*], [2 x %"class.Element::Port"*]* %20, i64 0, i64 %23, !dbg !1951
  %25 = load %"class.Element::Port"*, %"class.Element::Port"** %24, align 8, !dbg !1951, !tbaa !1894
  %26 = load i32, i32* %6, align 4, !dbg !1953, !tbaa !1898
  %27 = sext i32 %26 to i64, !dbg !1951
  %28 = getelementptr inbounds %"class.Element::Port", %"class.Element::Port"* %25, i64 %27, !dbg !1951
  ret %"class.Element::Port"* %28, !dbg !1954
}
...
!1 = !DIFile(filename: "../elements/standard/cpuswitch.cc", directory: "/home/john/projects/click/ir-dir")
!2 = !{!3, !857}
...
!1792 = distinct !DISubprogram(name: "CPUSwitch", linkageName: "_ZN9CPUSwitchC2Ev", scope: !1793, file: !1, line: 21, type: !1800, scopeLine: 22, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1799, retainedNodes: !1814)
!1793 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "CPUSwitch", file: !1794, line: 18, size: 896, flags: DIFlagTypePassByReference | DIFlagNonTrivial, elements: !1795, vtableHolder: !1797)
!1794 = !DIFile(filename: "../elements/standard/cpuswitch.hh", directory: "/home/john/projects/click/ir-dir")
!1795 = !{!1796, !1799, !1803, !1804, !1809, !1810, !1811}
...
!1799 = !DISubprogram(name: "CPUSwitch", scope: !1793, file: !1794, line: 22, type: !1800, scopeLine: 22, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1800 = !DISubroutineType(types: !1801)
!1801 = !{null, !1802}
!1802 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1793, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1803 = !DISubprogram(name: "~CPUSwitch", scope: !1793, file: !1794, line: 23, type: !1800, scopeLine: 23, containingType: !1793, virtualIndex: 0, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual | DISPFlagOptimized)
!1804 = !DISubprogram(name: "class_name", linkageName: "_ZNK9CPUSwitch10class_nameEv", scope: !1793, file: !1794, line: 25, type: !1805, scopeLine: 25, containingType: !1793, virtualIndex: 9, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual | DISPFlagOptimized)
...
!1809 = !DISubprogram(name: "port_count", linkageName: "_ZNK9CPUSwitch10port_countEv", scope: !1793, file: !1794, line: 26, type: !1805, scopeLine: 26, containingType: !1793, virtualIndex: 10, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual | DISPFlagOptimized)
!1810 = !DISubprogram(name: "processing", linkageName: "_ZNK9CPUSwitch10processingEv", scope: !1793, file: !1794, line: 27, type: !1805, scopeLine: 27, containingType: !1793, virtualIndex: 11, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual | DISPFlagOptimized)
!1811 = !DISubprogram(name: "push", linkageName: "_ZN9CPUSwitch4pushEiP6Packet", scope: !1793, file: !1794, line: 29, type: !1812, scopeLine: 29, containingType: !1793, virtualIndex: 2, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual | DISPFlagOptimized)
...
!1818 = !DILocation(line: 22, column: 1, scope: !1792)
!1819 = !DILocation(line: 21, column: 12, scope: !1792)
!1820 = !{!1821, !1821, i64 0}
!1821 = !{!"vtable pointer", !1822, i64 0}
!1822 = !{!"Simple C++ TBAA"}
!1823 = !DILocation(line: 23, column: 1, scope: !1792)
!1824 = distinct !DISubprogram(name: "~CPUSwitch", linkageName: "_ZN9CPUSwitchD2Ev", scope: !1793, file: !1, line: 25, type: !1800, scopeLine: 26, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1803, retainedNodes: !1825)
!1825 = !{!1826}
...
!1828 = !DILocation(line: 27, column: 1, scope: !1829)
!1829 = distinct !DILexicalBlock(scope: !1824, file: !1, line: 26, column: 1)
!1830 = !DILocation(line: 27, column: 1, scope: !1824)
!1831 = distinct !DISubprogram(name: "~CPUSwitch", linkageName: "_ZN9CPUSwitchD0Ev", scope: !1793, file: !1, line: 25, type: !1800, scopeLine: 26, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1803, retainedNodes: !1832)
!1832 = !{!1833}
!1833 = !DILocalVariable(name: "this", arg: 1, scope: !1831, type: !1816, flags: DIFlagArtificial | DIFlagObjectPointer)
!1834 = !DILocation(line: 0, scope: !1831)
!1835 = !DILocation(line: 0, scope: !1824, inlinedAt: !1836)
!1836 = distinct !DILocation(line: 26, column: 1, scope: !1831)
!1837 = !DILocation(line: 27, column: 1, scope: !1829, inlinedAt: !1836)
!1838 = !DILocation(line: 26, column: 1, scope: !1831)
!1839 = !DILocation(line: 27, column: 1, scope: !1831)
!1840 = distinct !DISubprogram(name: "push", linkageName: "_ZN9CPUSwitch4pushEiP6Packet", scope: !1793, file: !1, line: 30, type: !1812, scopeLine: 31, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1811, retainedNodes: !1841)
!1841 = !{!1842, !1843, !1844, !1845}
!1842 = !DILocalVariable(name: "this", arg: 1, scope: !1840, type: !1816, flags: DIFlagArtificial | DIFlagObjectPointer)
!1843 = !DILocalVariable(arg: 2, scope: !1840, file: !1, line: 30, type: !34)
!1844 = !DILocalVariable(name: "p", arg: 3, scope: !1840, file: !1, line: 30, type: !78)
!1845 = !DILocalVariable(name: "n", scope: !1840, file: !1, line: 32, type: !34)
!1846 = !DILocation(line: 0, scope: !1840)
!1847 = !DILocation(line: 32, column: 36, scope: !1840)
!1848 = !DILocation(line: 33, column: 3, scope: !1840)
!1849 = !DILocation(line: 33, column: 13, scope: !1840)
!1850 = !DILocation(line: 34, column: 1, scope: !1840)
!1851 = distinct !DISubprogram(name: "output", linkageName: "_ZNK7Element6outputEi", scope: !1797, file: !1798, line: 460, type: !1852, scopeLine: 461, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1889, retainedNodes: !1890)
...
!1856 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "Port", scope: !1797, file: !1798, line: 214, size: 128, flags: DIFlagTypePassByValue | DIFlagNonTrivial, elements: !1857, identifier: "_ZTSN7Element4PortE")
!1857 = !{!1858, !1860, !1861, !1865, !1868, !1871, !1874, !1877, !1881, !1884}
!1858 = !DIDerivedType(tag: DW_TAG_member, name: "_e", scope: !1856, file: !1798, line: 231, baseType: !1859, size: 64)
!1859 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1797, size: 64)
!1860 = !DIDerivedType(tag: DW_TAG_member, name: "_port", scope: !1856, file: !1798, line: 232, baseType: !34, size: 32, offset: 64)
!1861 = !DISubprogram(name: "active", linkageName: "_ZNK7Element4Port6activeEv", scope: !1856, file: !1798, line: 216, type: !1862, scopeLine: 216, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1862 = !DISubroutineType(types: !1863)
!1863 = !{!53, !1864}
!1864 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1855, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1865 = !DISubprogram(name: "element", linkageName: "_ZNK7Element4Port7elementEv", scope: !1856, file: !1798, line: 217, type: !1866, scopeLine: 217, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1866 = !DISubroutineType(types: !1867)
!1867 = !{!1859, !1864}
!1868 = !DISubprogram(name: "port", linkageName: "_ZNK7Element4Port4portEv", scope: !1856, file: !1798, line: 218, type: !1869, scopeLine: 218, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1869 = !DISubroutineType(types: !1870)
!1870 = !{!34, !1864}
!1871 = !DISubprogram(name: "push", linkageName: "_ZNK7Element4Port4pushEP6Packet", scope: !1856, file: !1798, line: 220, type: !1872, scopeLine: 220, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1872 = !DISubroutineType(types: !1873)
!1873 = !{null, !1864, !78}
!1874 = !DISubprogram(name: "pull", linkageName: "_ZNK7Element4Port4pullEv", scope: !1856, file: !1798, line: 221, type: !1875, scopeLine: 221, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1875 = !DISubroutineType(types: !1876)
!1876 = !{!78, !1864}
!1877 = !DISubprogram(name: "assign", linkageName: "_ZN7Element4Port6assignEbPS_i", scope: !1856, file: !1798, line: 227, type: !1878, scopeLine: 227, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1878 = !DISubroutineType(types: !1879)
!1879 = !{null, !1880, !53, !1859, !34}
!1880 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1856, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1881 = !DISubprogram(name: "Port", scope: !1856, file: !1798, line: 247, type: !1882, scopeLine: 247, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1882 = !DISubroutineType(types: !1883)
!1883 = !{null, !1880}
!1884 = !DISubprogram(name: "assign", linkageName: "_ZN7Element4Port6assignEbPS_S1_i", scope: !1856, file: !1798, line: 248, type: !1885, scopeLine: 248, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1885 = !DISubroutineType(types: !1886)
!1886 = !{null, !1880, !53, !1859, !1859, !34}
!1887 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1888, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1888 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1797)
!1889 = !DISubprogram(name: "output", linkageName: "_ZNK7Element6outputEi", scope: !1797, file: !1798, line: 137, type: !1852, scopeLine: 137, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1890 = !{!1891, !1893}
!1891 = !DILocalVariable(name: "this", arg: 1, scope: !1851, type: !1892, flags: DIFlagArtificial | DIFlagObjectPointer)
!1892 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1888, size: 64)
!1893 = !DILocalVariable(name: "port", arg: 2, scope: !1851, file: !1798, line: 460, type: !34)
!1894 = !{!1895, !1895, i64 0}
!1895 = !{!"any pointer", !1896, i64 0}
!1896 = !{!"omnipotent char", !1822, i64 0}
!1897 = !DILocation(line: 0, scope: !1851)
!1898 = !{!1899, !1899, i64 0}
!1899 = !{!"int", !1896, i64 0}
!1900 = !DILocation(line: 460, column: 21, scope: !1851)
!1901 = !DILocation(line: 462, column: 32, scope: !1851)
!1902 = !DILocation(line: 462, column: 21, scope: !1851)
!1903 = !DILocation(line: 462, column: 5, scope: !1851)
!1904 = distinct !DISubprogram(name: "push", linkageName: "_ZNK7Element4Port4pushEP6Packet", scope: !1856, file: !1798, line: 609, type: !1872, scopeLine: 610, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1871, retainedNodes: !1905)
!1905 = !{!1906, !1908}
!1906 = !DILocalVariable(name: "this", arg: 1, scope: !1904, type: !1907, flags: DIFlagArtificial | DIFlagObjectPointer)
!1907 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1855, size: 64)
!1908 = !DILocalVariable(name: "p", arg: 2, scope: !1904, file: !1798, line: 609, type: !78)
!1909 = !DILocation(line: 0, scope: !1904)
!1910 = !DILocation(line: 609, column: 29, scope: !1904)
!1911 = !DILocation(line: 611, column: 5, scope: !1904)
!1912 = !{!1913, !1895, i64 0}
!1913 = !{!"_ZTSN7Element4PortE", !1895, i64 0, !1899, i64 8}
!1914 = !DILocation(line: 633, column: 5, scope: !1904)
!1915 = !DILocation(line: 633, column: 14, scope: !1904)
!1916 = !{!1913, !1899, i64 8}
!1917 = !DILocation(line: 633, column: 21, scope: !1904)
!1918 = !DILocation(line: 633, column: 9, scope: !1904)
!1919 = !DILocation(line: 636, column: 1, scope: !1904)
!1920 = distinct !DISubprogram(name: "class_name", linkageName: "_ZNK9CPUSwitch10class_nameEv", scope: !1793, file: !1794, line: 25, type: !1805, scopeLine: 25, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1804, retainedNodes: !1921)
!1921 = !{!1922}
!1922 = !DILocalVariable(name: "this", arg: 1, scope: !1920, type: !1923, flags: DIFlagArtificial | DIFlagObjectPointer)
!1923 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1808, size: 64)
!1924 = !DILocation(line: 0, scope: !1920)
!1925 = !DILocation(line: 25, column: 37, scope: !1920)
!1926 = distinct !DISubprogram(name: "port_count", linkageName: "_ZNK9CPUSwitch10port_countEv", scope: !1793, file: !1794, line: 26, type: !1805, scopeLine: 26, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1809, retainedNodes: !1927)
!1927 = !{!1928}
!1928 = !DILocalVariable(name: "this", arg: 1, scope: !1926, type: !1923, flags: DIFlagArtificial | DIFlagObjectPointer)
!1929 = !DILocation(line: 0, scope: !1926)
!1930 = !DILocation(line: 26, column: 37, scope: !1926)
!1931 = distinct !DISubprogram(name: "processing", linkageName: "_ZNK9CPUSwitch10processingEv", scope: !1793, file: !1794, line: 27, type: !1805, scopeLine: 27, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1810, retainedNodes: !1932)
!1932 = !{!1933}
!1933 = !DILocalVariable(name: "this", arg: 1, scope: !1931, type: !1923, flags: DIFlagArtificial | DIFlagObjectPointer)
!1934 = !DILocation(line: 0, scope: !1931)
!1935 = !DILocation(line: 27, column: 37, scope: !1931)
!1936 = distinct !DISubprogram(name: "port", linkageName: "_ZNK7Element4portEbi", scope: !1797, file: !1798, line: 435, type: !1937, scopeLine: 436, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1939, retainedNodes: !1940)
!1937 = !DISubroutineType(types: !1938)
!1938 = !{!1854, !1887, !53, !34}
!1939 = !DISubprogram(name: "port", linkageName: "_ZNK7Element4portEbi", scope: !1797, file: !1798, line: 135, type: !1937, scopeLine: 135, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1940 = !{!1941, !1942, !1943}
!1941 = !DILocalVariable(name: "this", arg: 1, scope: !1936, type: !1892, flags: DIFlagArtificial | DIFlagObjectPointer)
!1942 = !DILocalVariable(name: "isoutput", arg: 2, scope: !1936, file: !1798, line: 435, type: !53)
!1943 = !DILocalVariable(name: "port", arg: 3, scope: !1936, file: !1798, line: 435, type: !34)
!1944 = !DILocation(line: 0, scope: !1936)
!1945 = !{!1946, !1946, i64 0}
!1946 = !{!"bool", !1896, i64 0}
!1947 = !DILocation(line: 435, column: 20, scope: !1936)
!1948 = !DILocation(line: 435, column: 34, scope: !1936)
!1949 = !DILocation(line: 437, column: 5, scope: !1936)
!1950 = !{i8 0, i8 2}
!1951 = !DILocation(line: 438, column: 12, scope: !1936)
!1952 = !DILocation(line: 438, column: 19, scope: !1936)
!1953 = !DILocation(line: 438, column: 29, scope: !1936)
!1954 = !DILocation(line: 438, column: 5, scope: !1936)
