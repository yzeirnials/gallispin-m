; ModuleID = '../elements/standard/errorelement.cc'
source_filename = "../elements/standard/errorelement.cc"
...
@_ZN12ErrorElementC1Ev = dso_local unnamed_addr alias void (%class.ErrorElement*), void (%class.ErrorElement*)* @_ZN12ErrorElementC2Ev

; Function Attrs: sspstrong uwtable
define dso_local void @_ZN12ErrorElementC2Ev(%class.ErrorElement* %0) unnamed_addr #0 align 2 !dbg !653 {
  call void @llvm.dbg.value(metadata %class.ErrorElement* %0, metadata !685, metadata !DIExpression()), !dbg !687
  %2 = bitcast %class.ErrorElement* %0 to %class.Element*, !dbg !688
  tail call void @_ZN7ElementC2Ev(%class.Element* %2), !dbg !689
  %3 = getelementptr %class.ErrorElement, %class.ErrorElement* %0, i64 0, i32 0, i32 0, !dbg !688
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [29 x i8*] }, { [29 x i8*] }* @_ZTV12ErrorElement, i64 0, inrange i32 0, i64 2) to i32 (...)**), i32 (...)*** %3, align 8, !dbg !688, !tbaa !690
  ret void, !dbg !693
}
...
define dso_local i32 @_ZN12ErrorElement9configureER6VectorI6StringEP12ErrorHandler(%class.ErrorElement* nocapture readnone %0, %class.Vector* nocapture nonnull readnone %1, %class.ErrorHandler* nocapture readnone %2) unnamed_addr #2 align 2 !dbg !694 {
  call void @llvm.dbg.value(metadata %class.ErrorElement* undef, metadata !696, metadata !DIExpression()), !dbg !699
  call void @llvm.dbg.value(metadata %class.Vector* undef, metadata !697, metadata !DIExpression()), !dbg !699
  call void @llvm.dbg.value(metadata %class.ErrorHandler* undef, metadata !698, metadata !DIExpression()), !dbg !699
  ret i32 0, !dbg !700
}

; Function Attrs: norecurse nounwind readnone sspstrong uwtable
define dso_local i32 @_ZN12ErrorElement10initializeEP12ErrorHandler(%class.ErrorElement* nocapture readnone %0, %class.ErrorHandler* nocapture readnone %1) unnamed_addr #2 align 2 !dbg !701 {
  call void @llvm.dbg.value(metadata %class.ErrorElement* undef, metadata !703, metadata !DIExpression()), !dbg !705
  call void @llvm.dbg.value(metadata %class.ErrorHandler* undef, metadata !704, metadata !DIExpression()), !dbg !705
  ret i32 -1, !dbg !706
}
...
define linkonce_odr dso_local void @_ZN12ErrorElementD0Ev(%class.ErrorElement* %0) unnamed_addr #4 comdat align 2 !dbg !707 {
  call void @llvm.dbg.value(metadata %class.ErrorElement* %0, metadata !710, metadata !DIExpression()), !dbg !711
  %2 = bitcast %class.ErrorElement* %0 to %class.Element*, !dbg !712
  tail call void @_ZN7ElementD2Ev(%class.Element* %2) #8, !dbg !712
  %3 = bitcast %class.ErrorElement* %0 to i8*, !dbg !712
  tail call void @_ZdlPv(i8* %3) #9, !dbg !712
  ret void, !dbg !712
}
...
define linkonce_odr dso_local i8* @_ZNK12ErrorElement10class_nameEv(%class.ErrorElement* %0) unnamed_addr #5 comdat align 2 !dbg !713 {
  call void @llvm.dbg.value(metadata %class.ErrorElement* %0, metadata !715, metadata !DIExpression()), !dbg !717
  ret i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), !dbg !718
}

; Function Attrs: nounwind sspstrong uwtable
define linkonce_odr dso_local i8* @_ZNK12ErrorElement10port_countEv(%class.ErrorElement* %0) unnamed_addr #5 comdat align 2 !dbg !719 {
  call void @llvm.dbg.value(metadata %class.ErrorElement* %0, metadata !721, metadata !DIExpression()), !dbg !722
  ret i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), !dbg !723
}

; Function Attrs: nounwind sspstrong uwtable
define linkonce_odr dso_local i8* @_ZNK12ErrorElement10processingEv(%class.ErrorElement* %0) unnamed_addr #5 comdat align 2 !dbg !724 {
  call void @llvm.dbg.value(metadata %class.ErrorElement* %0, metadata !726, metadata !DIExpression()), !dbg !727
  ret i8* getelementptr inbounds ([0 x i8], [0 x i8]* @_ZN7Element8AGNOSTICE, i64 0, i64 0), !dbg !728
}

; Function Attrs: nounwind sspstrong uwtable
define linkonce_odr dso_local i8* @_ZNK12ErrorElement9flow_codeEv(%class.ErrorElement* %0) unnamed_addr #5 comdat align 2 !dbg !729 {
  call void @llvm.dbg.value(metadata %class.ErrorElement* %0, metadata !731, metadata !DIExpression()), !dbg !732
  ret i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), !dbg !733
}
...
!1 = !DIFile(filename: "../elements/standard/errorelement.cc", directory: "/home/john/projects/click/ir-dir")
!2 = !{}
...
!653 = distinct !DISubprogram(name: "ErrorElement", linkageName: "_ZN12ErrorElementC2Ev", scope: !654, file: !1, line: 24, type: !661, scopeLine: 25, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !660, retainedNodes: !684)
!654 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "ErrorElement", file: !655, line: 20, size: 896, flags: DIFlagTypePassByReference | DIFlagNonTrivial, elements: !656, vtableHolder: !658)
!655 = !DIFile(filename: "../dummy_inc/click/standard/errorelement.hh", directory: "/home/john/projects/click/ir-dir")
!656 = !{!657, !660, !664, !669, !670, !671, !672, !681}
...
!660 = !DISubprogram(name: "ErrorElement", scope: !654, file: !655, line: 22, type: !661, scopeLine: 22, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!661 = !DISubroutineType(types: !662)
!662 = !{null, !663}
!663 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !654, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!664 = !DISubprogram(name: "class_name", linkageName: "_ZNK12ErrorElement10class_nameEv", scope: !654, file: !655, line: 24, type: !665, scopeLine: 24, containingType: !654, virtualIndex: 9, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual | DISPFlagOptimized)
...
!669 = !DISubprogram(name: "port_count", linkageName: "_ZNK12ErrorElement10port_countEv", scope: !654, file: !655, line: 25, type: !665, scopeLine: 25, containingType: !654, virtualIndex: 10, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual | DISPFlagOptimized)
!670 = !DISubprogram(name: "processing", linkageName: "_ZNK12ErrorElement10processingEv", scope: !654, file: !655, line: 26, type: !665, scopeLine: 26, containingType: !654, virtualIndex: 11, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual | DISPFlagOptimized)
!671 = !DISubprogram(name: "flow_code", linkageName: "_ZNK12ErrorElement9flow_codeEv", scope: !654, file: !655, line: 27, type: !665, scopeLine: 27, containingType: !654, virtualIndex: 12, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual | DISPFlagOptimized)
!672 = !DISubprogram(name: "configure", linkageName: "_ZN12ErrorElement9configureER6VectorI6StringEP12ErrorHandler", scope: !654, file: !655, line: 29, type: !673, scopeLine: 29, containingType: !654, virtualIndex: 17, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual | DISPFlagOptimized)
!673 = !DISubroutineType(types: !674)
!674 = !{!71, !663, !675, !678}
!675 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !676, size: 64)
!676 = !DICompositeType(tag: DW_TAG_class_type, name: "Vector<String>", file: !677, line: 13, flags: DIFlagFwdDecl, identifier: "_ZTS6VectorI6StringE")
!677 = !DIFile(filename: "../dummy_inc/click/ipaddress.hh", directory: "/home/john/projects/click/ir-dir")
!678 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !679, size: 64)
!679 = !DICompositeType(tag: DW_TAG_class_type, name: "ErrorHandler", file: !680, line: 6, flags: DIFlagFwdDecl, identifier: "_ZTS12ErrorHandler")
!680 = !DIFile(filename: "../dummy_inc/click/handler.hh", directory: "/home/john/projects/click/ir-dir")
!681 = !DISubprogram(name: "initialize", linkageName: "_ZN12ErrorElement10initializeEP12ErrorHandler", scope: !654, file: !655, line: 30, type: !682, scopeLine: 30, containingType: !654, virtualIndex: 19, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual | DISPFlagOptimized)
!682 = !DISubroutineType(types: !683)
!683 = !{!71, !663, !678}
!684 = !{!685}
!685 = !DILocalVariable(name: "this", arg: 1, scope: !653, type: !686, flags: DIFlagArtificial | DIFlagObjectPointer)
!686 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !654, size: 64)
!687 = !DILocation(line: 0, scope: !653)
!688 = !DILocation(line: 25, column: 1, scope: !653)
!689 = !DILocation(line: 24, column: 15, scope: !653)
!690 = !{!691, !691, i64 0}
!691 = !{!"vtable pointer", !692, i64 0}
!692 = !{!"Simple C++ TBAA"}
!693 = !DILocation(line: 26, column: 1, scope: !653)
!694 = distinct !DISubprogram(name: "configure", linkageName: "_ZN12ErrorElement9configureER6VectorI6StringEP12ErrorHandler", scope: !654, file: !1, line: 29, type: !673, scopeLine: 30, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !672, retainedNodes: !695)
!695 = !{!696, !697, !698}
!696 = !DILocalVariable(name: "this", arg: 1, scope: !694, type: !686, flags: DIFlagArtificial | DIFlagObjectPointer)
!697 = !DILocalVariable(arg: 2, scope: !694, file: !1, line: 29, type: !675)
!698 = !DILocalVariable(arg: 3, scope: !694, file: !1, line: 29, type: !678)
!699 = !DILocation(line: 0, scope: !694)
!700 = !DILocation(line: 32, column: 5, scope: !694)
!701 = distinct !DISubprogram(name: "initialize", linkageName: "_ZN12ErrorElement10initializeEP12ErrorHandler", scope: !654, file: !1, line: 36, type: !682, scopeLine: 37, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !681, retainedNodes: !702)
!702 = !{!703, !704}
!703 = !DILocalVariable(name: "this", arg: 1, scope: !701, type: !686, flags: DIFlagArtificial | DIFlagObjectPointer)
!704 = !DILocalVariable(arg: 2, scope: !701, file: !1, line: 36, type: !678)
!705 = !DILocation(line: 0, scope: !701)
!706 = !DILocation(line: 39, column: 5, scope: !701)
!707 = distinct !DISubprogram(name: "~ErrorElement", linkageName: "_ZN12ErrorElementD0Ev", scope: !654, file: !655, line: 20, type: !661, scopeLine: 20, flags: DIFlagArtificial | DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !708, retainedNodes: !709)
!708 = !DISubprogram(name: "~ErrorElement", scope: !654, type: !661, containingType: !654, virtualIndex: 0, flags: DIFlagPublic | DIFlagArtificial | DIFlagPrototyped, spFlags: DISPFlagVirtual | DISPFlagOptimized)
!709 = !{!710}
!710 = !DILocalVariable(name: "this", arg: 1, scope: !707, type: !686, flags: DIFlagArtificial | DIFlagObjectPointer)
!711 = !DILocation(line: 0, scope: !707)
!712 = !DILocation(line: 20, column: 7, scope: !707)
!713 = distinct !DISubprogram(name: "class_name", linkageName: "_ZNK12ErrorElement10class_nameEv", scope: !654, file: !655, line: 24, type: !665, scopeLine: 24, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !664, retainedNodes: !714)
!714 = !{!715}
!715 = !DILocalVariable(name: "this", arg: 1, scope: !713, type: !716, flags: DIFlagArtificial | DIFlagObjectPointer)
!716 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !668, size: 64)
!717 = !DILocation(line: 0, scope: !713)
!718 = !DILocation(line: 24, column: 39, scope: !713)
!719 = distinct !DISubprogram(name: "port_count", linkageName: "_ZNK12ErrorElement10port_countEv", scope: !654, file: !655, line: 25, type: !665, scopeLine: 25, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !669, retainedNodes: !720)
!720 = !{!721}
!721 = !DILocalVariable(name: "this", arg: 1, scope: !719, type: !716, flags: DIFlagArtificial | DIFlagObjectPointer)
!722 = !DILocation(line: 0, scope: !719)
!723 = !DILocation(line: 25, column: 39, scope: !719)
!724 = distinct !DISubprogram(name: "processing", linkageName: "_ZNK12ErrorElement10processingEv", scope: !654, file: !655, line: 26, type: !665, scopeLine: 26, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !670, retainedNodes: !725)
!725 = !{!726}
!726 = !DILocalVariable(name: "this", arg: 1, scope: !724, type: !716, flags: DIFlagArtificial | DIFlagObjectPointer)
!727 = !DILocation(line: 0, scope: !724)
!728 = !DILocation(line: 26, column: 39, scope: !724)
!729 = distinct !DISubprogram(name: "flow_code", linkageName: "_ZNK12ErrorElement9flow_codeEv", scope: !654, file: !655, line: 27, type: !665, scopeLine: 27, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !671, retainedNodes: !730)
!730 = !{!731}
!731 = !DILocalVariable(name: "this", arg: 1, scope: !729, type: !716, flags: DIFlagArtificial | DIFlagObjectPointer)
!732 = !DILocation(line: 0, scope: !729)
!733 = !DILocation(line: 27, column: 38, scope: !729)
