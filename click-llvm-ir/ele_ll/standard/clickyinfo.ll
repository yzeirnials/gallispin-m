; ModuleID = '../elements/standard/clickyinfo.cc'
source_filename = "../elements/standard/clickyinfo.cc"
...
@_ZTV10ClickyInfo = dso_local unnamed_addr constant { [29 x i8*] } { [29 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTI10ClickyInfo to i8*), i8* bitcast (void (%class.Element*)* @_ZN7ElementD2Ev to i8*), i8* bitcast (void (%class.ClickyInfo*)* @_ZN10ClickyInfoD0Ev to i8*), i8* bitcast (void (%class.Element*, i32, %class.Packet*)* @_ZN7Element4pushEiP6Packet to i8*), i8* bitcast (%class.Packet* (%class.Element*, i32)* @_ZN7Element4pullEi to i8*), i8* bitcast (%class.Packet* (%class.Element*, %class.Packet*)* @_ZN7Element13simple_actionEP6Packet to i8*), i8* bitcast (i1 (%class.Element*, %class.Task*)* @_ZN7Element8run_taskEP4Task to i8*), i8* bitcast (void (%class.Element*, %class.Timer*)* @_ZN7Element9run_timerEP5Timer to i8*), i8* bitcast (void (%class.Element*, i32, i32)* @_ZN7Element8selectedEii to i8*), i8* bitcast (void (%class.Element*, i32)* @_ZN7Element8selectedEi to i8*), i8* bitcast (i8* (%class.ClickyInfo*)* @_ZNK10ClickyInfo10class_nameEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element10port_countEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element10processingEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element9flow_codeEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element5flagsEv to i8*), i8* bitcast (i8* (%class.Element*, i8*)* @_ZN7Element4castEPKc to i8*), i8* bitcast (i8* (%class.Element*, i1, i32, i8*)* @_ZN7Element9port_castEbiPKc to i8*), i8* bitcast (i32 (%class.Element*)* @_ZNK7Element15configure_phaseEv to i8*), i8* bitcast (i32 (%class.ClickyInfo*, %class.Vector*, %class.ErrorHandler*)* @_ZN10ClickyInfo9configureER6VectorI6StringEP12ErrorHandler to i8*), i8* bitcast (void (%class.Element*)* @_ZN7Element12add_handlersEv to i8*), i8* bitcast (i32 (%class.Element*, %class.ErrorHandler*)* @_ZN7Element10initializeEP12ErrorHandler to i8*), i8* bitcast (void (%class.Element*, %class.Element*, %class.ErrorHandler*)* @_ZN7Element10take_stateEPS_P12ErrorHandler to i8*), i8* bitcast (%class.Element* (%class.Element*)* @_ZNK7Element15hotswap_elementEv to i8*), i8* bitcast (void (%class.Element*, i32)* @_ZN7Element7cleanupENS_12CleanupStageE to i8*), i8* bitcast (void (%class.String*, %class.Element*)* @_ZNK7Element11declarationEv to i8*), i8* bitcast (i1 (%class.Element*)* @_ZNK7Element20can_live_reconfigureEv to i8*), i8* bitcast (i32 (%class.Element*, %class.Vector*, %class.ErrorHandler*)* @_ZN7Element16live_reconfigureER6VectorI6StringEP12ErrorHandler to i8*), i8* bitcast (i32 (%class.Element*, i32, i8*)* @_ZN7Element5llrpcEjPv to i8*)] }, align 8
@_ZTVN10__cxxabiv120__si_class_type_infoE = external global i8*
@_ZTS10ClickyInfo = dso_local constant [13 x i8] c"10ClickyInfo\00", align 1
@_ZTI7Element = external constant i8*
@_ZTI10ClickyInfo = dso_local constant { i8*, i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([13 x i8], [13 x i8]* @_ZTS10ClickyInfo, i32 0, i32 0), i8* bitcast (i8** @_ZTI7Element to i8*) }, align 8
@.str = private unnamed_addr constant [11 x i8] c"ClickyInfo\00", align 1

@_ZN10ClickyInfoC1Ev = dso_local unnamed_addr alias void (%class.ClickyInfo*), void (%class.ClickyInfo*)* @_ZN10ClickyInfoC2Ev

; Function Attrs: sspstrong uwtable
define dso_local void @_ZN10ClickyInfoC2Ev(%class.ClickyInfo* %0) unnamed_addr #0 align 2 !dbg !653 {
  call void @llvm.dbg.value(metadata %class.ClickyInfo* %0, metadata !679, metadata !DIExpression()), !dbg !681
  %2 = bitcast %class.ClickyInfo* %0 to %class.Element*, !dbg !682
  tail call void @_ZN7ElementC2Ev(%class.Element* %2), !dbg !683
  %3 = getelementptr %class.ClickyInfo, %class.ClickyInfo* %0, i64 0, i32 0, i32 0, !dbg !682
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [29 x i8*] }, { [29 x i8*] }* @_ZTV10ClickyInfo, i64 0, inrange i32 0, i64 2) to i32 (...)**), i32 (...)*** %3, align 8, !dbg !682, !tbaa !684
  ret void, !dbg !687
}
...
define dso_local i32 @_ZN10ClickyInfo9configureER6VectorI6StringEP12ErrorHandler(%class.ClickyInfo* nocapture readnone %0, %class.Vector* nocapture nonnull readnone %1, %class.ErrorHandler* nocapture readnone %2) unnamed_addr #2 align 2 !dbg !688 {
  call void @llvm.dbg.value(metadata %class.ClickyInfo* undef, metadata !690, metadata !DIExpression()), !dbg !693
...
define linkonce_odr dso_local void @_ZN10ClickyInfoD0Ev(%class.ClickyInfo* %0) unnamed_addr #4 comdat align 2 !dbg !695 {
  call void @llvm.dbg.value(metadata %class.ClickyInfo* %0, metadata !698, metadata !DIExpression()), !dbg !699
  %2 = bitcast %class.ClickyInfo* %0 to %class.Element*, !dbg !700
  tail call void @_ZN7ElementD2Ev(%class.Element* %2) #8, !dbg !700
  %3 = bitcast %class.ClickyInfo* %0 to i8*, !dbg !700
...
define linkonce_odr dso_local i8* @_ZNK10ClickyInfo10class_nameEv(%class.ClickyInfo* %0) unnamed_addr #5 comdat align 2 !dbg !701 {
  call void @llvm.dbg.value(metadata %class.ClickyInfo* %0, metadata !703, metadata !DIExpression()), !dbg !705
  ret i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i64 0, i64 0), !dbg !706
}
...
!1 = !DIFile(filename: "../elements/standard/clickyinfo.cc", directory: "/home/john/projects/click/ir-dir")
!2 = !{}
...
!653 = distinct !DISubprogram(name: "ClickyInfo", linkageName: "_ZN10ClickyInfoC2Ev", scope: !654, file: !1, line: 22, type: !661, scopeLine: 23, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !660, retainedNodes: !678)
!654 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "ClickyInfo", file: !655, line: 20, size: 896, flags: DIFlagTypePassByReference | DIFlagNonTrivial, elements: !656, vtableHolder: !658)
!655 = !DIFile(filename: "../elements/standard/clickyinfo.hh", directory: "/home/john/projects/click/ir-dir")
!656 = !{!657, !660, !664, !669}
...
!660 = !DISubprogram(name: "ClickyInfo", scope: !654, file: !655, line: 22, type: !661, scopeLine: 22, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!661 = !DISubroutineType(types: !662)
!662 = !{null, !663}
!663 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !654, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!664 = !DISubprogram(name: "class_name", linkageName: "_ZNK10ClickyInfo10class_nameEv", scope: !654, file: !655, line: 24, type: !665, scopeLine: 24, containingType: !654, virtualIndex: 9, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual | DISPFlagOptimized)
...
!669 = !DISubprogram(name: "configure", linkageName: "_ZN10ClickyInfo9configureER6VectorI6StringEP12ErrorHandler", scope: !654, file: !655, line: 25, type: !670, scopeLine: 25, containingType: !654, virtualIndex: 17, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual | DISPFlagOptimized)
...
!682 = !DILocation(line: 23, column: 1, scope: !653)
!683 = !DILocation(line: 22, column: 13, scope: !653)
!684 = !{!685, !685, i64 0}
!685 = !{!"vtable pointer", !686, i64 0}
!686 = !{!"Simple C++ TBAA"}
!687 = !DILocation(line: 24, column: 1, scope: !653)
!688 = distinct !DISubprogram(name: "configure", linkageName: "_ZN10ClickyInfo9configureER6VectorI6StringEP12ErrorHandler", scope: !654, file: !1, line: 27, type: !670, scopeLine: 28, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !669, retainedNodes: !689)
!689 = !{!690, !691, !692}
!690 = !DILocalVariable(name: "this", arg: 1, scope: !688, type: !680, flags: DIFlagArtificial | DIFlagObjectPointer)
!691 = !DILocalVariable(arg: 2, scope: !688, file: !1, line: 27, type: !672)
!692 = !DILocalVariable(arg: 3, scope: !688, file: !1, line: 27, type: !675)
!693 = !DILocation(line: 0, scope: !688)
!694 = !DILocation(line: 29, column: 5, scope: !688)
!695 = distinct !DISubprogram(name: "~ClickyInfo", linkageName: "_ZN10ClickyInfoD0Ev", scope: !654, file: !655, line: 20, type: !661, scopeLine: 20, flags: DIFlagArtificial | DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !696, retainedNodes: !697)
!696 = !DISubprogram(name: "~ClickyInfo", scope: !654, type: !661, containingType: !654, virtualIndex: 0, flags: DIFlagPublic | DIFlagArtificial | DIFlagPrototyped, spFlags: DISPFlagVirtual | DISPFlagOptimized)
!697 = !{!698}
...
!700 = !DILocation(line: 20, column: 7, scope: !695)
!701 = distinct !DISubprogram(name: "class_name", linkageName: "_ZNK10ClickyInfo10class_nameEv", scope: !654, file: !655, line: 24, type: !665, scopeLine: 24, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !664, retainedNodes: !702)
!702 = !{!703}
...
!706 = !DILocation(line: 24, column: 38, scope: !701)
