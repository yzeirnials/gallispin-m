; ModuleID = '../elements/standard/rrsched.cc'
source_filename = "../elements/standard/rrsched.cc"
...
@_ZN7RRSchedC1Ev = dso_local unnamed_addr alias void (%class.RRSched*), void (%class.RRSched*)* @_ZN7RRSchedC2Ev

; Function Attrs: sspstrong uwtable
define dso_local void @_ZN7RRSchedC2Ev(%class.RRSched* %0) unnamed_addr #0 align 2 !dbg !1889 {
  call void @llvm.dbg.value(metadata %class.RRSched* %0, metadata !1922, metadata !DIExpression()), !dbg !1924
  %2 = bitcast %class.RRSched* %0 to %class.Element*, !dbg !1925
  tail call void @_ZN7ElementC2Ev(%class.Element* %2), !dbg !1926
  %3 = getelementptr %class.RRSched, %class.RRSched* %0, i64 0, i32 0, i32 0, !dbg !1925
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [29 x i8*] }, { [29 x i8*] }* @_ZTV7RRSched, i64 0, inrange i32 0, i64 2) to i32 (...)**), i32 (...)*** %3, align 8, !dbg !1925, !tbaa !1927
  %4 = getelementptr inbounds %class.RRSched, %class.RRSched* %0, i64 0, i32 1, !dbg !1930
  store i32 0, i32* %4, align 4, !dbg !1930, !tbaa !1931
  %5 = getelementptr inbounds %class.RRSched, %class.RRSched* %0, i64 0, i32 2, !dbg !1936
  store %class.NotifierSignal* null, %class.NotifierSignal** %5, align 8, !dbg !1936, !tbaa !1937
  ret void, !dbg !1938
}
...
; Function Attrs: sspstrong uwtable
define dso_local i32 @_ZN7RRSched10initializeEP12ErrorHandler(%class.RRSched* %0, %class.ErrorHandler* nocapture readnone %1) unnamed_addr #0 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) !dbg !1939 {
  %3 = alloca %class.NotifierSignal, align 8
  call void @llvm.dbg.value(metadata %class.RRSched* %0, metadata !1941, metadata !DIExpression()), !dbg !1945
  call void @llvm.dbg.value(metadata %class.ErrorHandler* undef, metadata !1942, metadata !DIExpression()), !dbg !1945
  %4 = bitcast %class.RRSched* %0 to %class.Element*, !dbg !1946
  call void @llvm.dbg.value(metadata %class.Element* %4, metadata !1948, metadata !DIExpression()), !dbg !1957
  %5 = getelementptr inbounds %class.RRSched, %class.RRSched* %0, i64 0, i32 0, i32 3, i64 0, !dbg !1959
  %6 = load i32, i32* %5, align 8, !dbg !1959, !tbaa !1960
  %7 = sext i32 %6 to i64, !dbg !1946
  %8 = tail call { i64, i1 } @llvm.umul.with.overflow.i64(i64 %7, i64 16), !dbg !1961
  %9 = extractvalue { i64, i1 } %8, 1, !dbg !1961
  %10 = extractvalue { i64, i1 } %8, 0, !dbg !1961
  %11 = or i64 %10, 8, !dbg !1961
  %12 = select i1 %9, i64 -1, i64 %11, !dbg !1961
  %13 = tail call i8* @_Znam(i64 %12) #13, !dbg !1961
  %14 = bitcast i8* %13 to i64*, !dbg !1961
  store i64 %7, i64* %14, align 16, !dbg !1961
  %15 = getelementptr inbounds i8, i8* %13, i64 8, !dbg !1961
  %16 = bitcast i8* %15 to %class.NotifierSignal*, !dbg !1961
  %17 = icmp eq i32 %6, 0, !dbg !1961
  br i1 %17, label %18, label %21, !dbg !1961

18:                                               ; preds = %2
  %19 = getelementptr inbounds %class.RRSched, %class.RRSched* %0, i64 0, i32 2, !dbg !1962
  %20 = bitcast %class.NotifierSignal** %19 to i8**, !dbg !1963
  store i8* %15, i8** %20, align 8, !dbg !1963, !tbaa !1937
  call void @llvm.dbg.value(metadata i32 0, metadata !1943, metadata !DIExpression()), !dbg !1964
  call void @llvm.dbg.value(metadata %class.Element* %4, metadata !1948, metadata !DIExpression()), !dbg !1965
  br label %116, !dbg !1968

21:                                               ; preds = %2
  %22 = getelementptr inbounds %class.NotifierSignal, %class.NotifierSignal* %16, i64 %7, !dbg !1961
  %23 = shl nsw i64 %7, 4, !dbg !1961
  %24 = add nsw i64 %23, -16, !dbg !1961
  %25 = lshr exact i64 %24, 4, !dbg !1961
  %26 = add nuw nsw i64 %25, 1, !dbg !1961
  %27 = and i64 %26, 7, !dbg !1961
  %28 = icmp eq i64 %27, 0, !dbg !1961
  br i1 %28, label %37, label %29, !dbg !1961

29:                                               ; preds = %21, %29
  %30 = phi %class.NotifierSignal* [ %34, %29 ], [ %16, %21 ], !dbg !1961
  %31 = phi i64 [ %35, %29 ], [ %27, %21 ]
  call void @llvm.dbg.value(metadata %class.NotifierSignal* %30, metadata !1969, metadata !DIExpression()), !dbg !1972
  %32 = getelementptr inbounds %class.NotifierSignal, %class.NotifierSignal* %30, i64 0, i32 1, !dbg !1974
  store i32 1, i32* %32, align 8, !dbg !1974, !tbaa !1975
  %33 = getelementptr inbounds %class.NotifierSignal, %class.NotifierSignal* %30, i64 0, i32 0, i32 0, !dbg !1977
  store %class.atomic_uint32_t* @_ZN14NotifierSignal12static_valueE, %class.atomic_uint32_t** %33, align 8, !dbg !1979, !tbaa !1980
  %34 = getelementptr inbounds %class.NotifierSignal, %class.NotifierSignal* %30, i64 1, !dbg !1961
  %35 = add i64 %31, -1, !dbg !1961
  %36 = icmp eq i64 %35, 0, !dbg !1961
  br i1 %36, label %37, label %29, !dbg !1961, !llvm.loop !1981

37:                                               ; preds = %29, %21
  %38 = phi %class.NotifierSignal* [ %16, %21 ], [ %34, %29 ]
  %39 = icmp ult i64 %24, 112, !dbg !1961
  br i1 %39, label %60, label %40, !dbg !1961

40:                                               ; preds = %37, %40
  %41 = phi %class.NotifierSignal* [ %58, %40 ], [ %38, %37 ], !dbg !1961
  call void @llvm.dbg.value(metadata %class.NotifierSignal* %41, metadata !1969, metadata !DIExpression()), !dbg !1972
  %42 = getelementptr inbounds %class.NotifierSignal, %class.NotifierSignal* %41, i64 0, i32 1, !dbg !1974
  store i32 1, i32* %42, align 8, !dbg !1974, !tbaa !1975
  %43 = getelementptr inbounds %class.NotifierSignal, %class.NotifierSignal* %41, i64 0, i32 0, i32 0, !dbg !1977
  store %class.atomic_uint32_t* @_ZN14NotifierSignal12static_valueE, %class.atomic_uint32_t** %43, align 8, !dbg !1979, !tbaa !1980
  call void @llvm.dbg.value(metadata %class.NotifierSignal* %41, metadata !1969, metadata !DIExpression(DW_OP_plus_uconst, 16, DW_OP_stack_value)), !dbg !1972
  %44 = getelementptr inbounds %class.NotifierSignal, %class.NotifierSignal* %41, i64 1, i32 1, !dbg !1974
  store i32 1, i32* %44, align 8, !dbg !1974, !tbaa !1975
  %45 = getelementptr inbounds %class.NotifierSignal, %class.NotifierSignal* %41, i64 1, i32 0, i32 0, !dbg !1977
  store %class.atomic_uint32_t* @_ZN14NotifierSignal12static_valueE, %class.atomic_uint32_t** %45, align 8, !dbg !1979, !tbaa !1980
  call void @llvm.dbg.value(metadata %class.NotifierSignal* %41, metadata !1969, metadata !DIExpression(DW_OP_plus_uconst, 32, DW_OP_stack_value)), !dbg !1972
  %46 = getelementptr inbounds %class.NotifierSignal, %class.NotifierSignal* %41, i64 2, i32 1, !dbg !1974
  store i32 1, i32* %46, align 8, !dbg !1974, !tbaa !1975
  %47 = getelementptr inbounds %class.NotifierSignal, %class.NotifierSignal* %41, i64 2, i32 0, i32 0, !dbg !1977
  store %class.atomic_uint32_t* @_ZN14NotifierSignal12static_valueE, %class.atomic_uint32_t** %47, align 8, !dbg !1979, !tbaa !1980
  call void @llvm.dbg.value(metadata %class.NotifierSignal* %41, metadata !1969, metadata !DIExpression(DW_OP_plus_uconst, 48, DW_OP_stack_value)), !dbg !1972
  %48 = getelementptr inbounds %class.NotifierSignal, %class.NotifierSignal* %41, i64 3, i32 1, !dbg !1974
  store i32 1, i32* %48, align 8, !dbg !1974, !tbaa !1975
  %49 = getelementptr inbounds %class.NotifierSignal, %class.NotifierSignal* %41, i64 3, i32 0, i32 0, !dbg !1977
  store %class.atomic_uint32_t* @_ZN14NotifierSignal12static_valueE, %class.atomic_uint32_t** %49, align 8, !dbg !1979, !tbaa !1980
  call void @llvm.dbg.value(metadata %class.NotifierSignal* %41, metadata !1969, metadata !DIExpression(DW_OP_plus_uconst, 64, DW_OP_stack_value)), !dbg !1972
  %50 = getelementptr inbounds %class.NotifierSignal, %class.NotifierSignal* %41, i64 4, i32 1, !dbg !1974
  store i32 1, i32* %50, align 8, !dbg !1974, !tbaa !1975
  %51 = getelementptr inbounds %class.NotifierSignal, %class.NotifierSignal* %41, i64 4, i32 0, i32 0, !dbg !1977
  store %class.atomic_uint32_t* @_ZN14NotifierSignal12static_valueE, %class.atomic_uint32_t** %51, align 8, !dbg !1979, !tbaa !1980
  call void @llvm.dbg.value(metadata %class.NotifierSignal* %41, metadata !1969, metadata !DIExpression(DW_OP_plus_uconst, 80, DW_OP_stack_value)), !dbg !1972
  %52 = getelementptr inbounds %class.NotifierSignal, %class.NotifierSignal* %41, i64 5, i32 1, !dbg !1974
  store i32 1, i32* %52, align 8, !dbg !1974, !tbaa !1975
  %53 = getelementptr inbounds %class.NotifierSignal, %class.NotifierSignal* %41, i64 5, i32 0, i32 0, !dbg !1977
  store %class.atomic_uint32_t* @_ZN14NotifierSignal12static_valueE, %class.atomic_uint32_t** %53, align 8, !dbg !1979, !tbaa !1980
  call void @llvm.dbg.value(metadata %class.NotifierSignal* %41, metadata !1969, metadata !DIExpression(DW_OP_plus_uconst, 96, DW_OP_stack_value)), !dbg !1972
  %54 = getelementptr inbounds %class.NotifierSignal, %class.NotifierSignal* %41, i64 6, i32 1, !dbg !1974
  store i32 1, i32* %54, align 8, !dbg !1974, !tbaa !1975
  %55 = getelementptr inbounds %class.NotifierSignal, %class.NotifierSignal* %41, i64 6, i32 0, i32 0, !dbg !1977
  store %class.atomic_uint32_t* @_ZN14NotifierSignal12static_valueE, %class.atomic_uint32_t** %55, align 8, !dbg !1979, !tbaa !1980
  call void @llvm.dbg.value(metadata %class.NotifierSignal* %41, metadata !1969, metadata !DIExpression(DW_OP_plus_uconst, 112, DW_OP_stack_value)), !dbg !1972
  %56 = getelementptr inbounds %class.NotifierSignal, %class.NotifierSignal* %41, i64 7, i32 1, !dbg !1974
  store i32 1, i32* %56, align 8, !dbg !1974, !tbaa !1975
  %57 = getelementptr inbounds %class.NotifierSignal, %class.NotifierSignal* %41, i64 7, i32 0, i32 0, !dbg !1977
  store %class.atomic_uint32_t* @_ZN14NotifierSignal12static_valueE, %class.atomic_uint32_t** %57, align 8, !dbg !1979, !tbaa !1980
  %58 = getelementptr inbounds %class.NotifierSignal, %class.NotifierSignal* %41, i64 8, !dbg !1961
  %59 = icmp eq %class.NotifierSignal* %58, %22, !dbg !1961
  br i1 %59, label %60, label %40, !dbg !1961

60:                                               ; preds = %40, %37
  %61 = load i32, i32* %5, align 8, !dbg !1983, !tbaa !1960
  %62 = icmp sgt i32 %61, 0, !dbg !1962
  %63 = getelementptr inbounds %class.RRSched, %class.RRSched* %0, i64 0, i32 2, !dbg !1962
  %64 = bitcast %class.NotifierSignal** %63 to i8**, !dbg !1963
  store i8* %15, i8** %64, align 8, !dbg !1963, !tbaa !1937
  call void @llvm.dbg.value(metadata i32 0, metadata !1943, metadata !DIExpression()), !dbg !1964
  call void @llvm.dbg.value(metadata %class.Element* %4, metadata !1948, metadata !DIExpression()), !dbg !1965
  br i1 %62, label %65, label %116, !dbg !1968

65:                                               ; preds = %60
  %66 = bitcast %class.NotifierSignal* %3 to i8*, !dbg !1984
  %67 = getelementptr inbounds %class.NotifierSignal, %class.NotifierSignal* %3, i64 0, i32 1, !dbg !1985
  %68 = bitcast %class.NotifierSignal* %3 to i64*, !dbg !1993
  %69 = bitcast %class.NotifierSignal* %3 to %"struct.NotifierSignal::vmpair"**, !dbg !1995
  br label %70, !dbg !1968

70:                                               ; preds = %65, %101
  %71 = phi i64 [ 0, %65 ], [ %102, %101 ]
  call void @llvm.dbg.value(metadata i64 %71, metadata !1943, metadata !DIExpression()), !dbg !1964
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %66) #14, !dbg !2002
  call void @llvm.dbg.value(metadata %class.Element* %4, metadata !2003, metadata !DIExpression()), !dbg !2011
  call void @llvm.dbg.value(metadata i64 %71, metadata !2010, metadata !DIExpression()), !dbg !2011
  %72 = trunc i64 %71 to i32, !dbg !2013
  call void @_ZN8Notifier21upstream_empty_signalEP7ElementiPFvPvPS_ES2_(%class.NotifierSignal* nonnull sret %3, %class.Element* nonnull %4, i32 %72, void (i8*, %class.Notifier*)* null, i8* null), !dbg !2013
  %73 = load %class.NotifierSignal*, %class.NotifierSignal** %63, align 8, !dbg !2014, !tbaa !1937
  %74 = getelementptr inbounds %class.NotifierSignal, %class.NotifierSignal* %73, i64 %71, !dbg !2014
  call void @llvm.dbg.value(metadata %class.NotifierSignal* %74, metadata !1990, metadata !DIExpression()), !dbg !2015
  call void @llvm.dbg.value(metadata %class.NotifierSignal* %3, metadata !1991, metadata !DIExpression()), !dbg !2015
  %75 = icmp eq %class.NotifierSignal* %74, %3, !dbg !2016
  br i1 %75, label %93, label %76, !dbg !2017, !prof !2018, !misexpect !2019

76:                                               ; preds = %70
  %77 = getelementptr inbounds %class.NotifierSignal, %class.NotifierSignal* %73, i64 %71, i32 1, !dbg !2020
  %78 = load i32, i32* %77, align 8, !dbg !2020, !tbaa !1975
  %79 = icmp eq i32 %78, 0, !dbg !2020
  br i1 %79, label %80, label %86, !dbg !2022, !prof !2018, !misexpect !2023

80:                                               ; preds = %76
  %81 = bitcast %class.NotifierSignal* %74 to %"struct.NotifierSignal::vmpair"**, !dbg !2024
  %82 = load %"struct.NotifierSignal::vmpair"*, %"struct.NotifierSignal::vmpair"** %81, align 8, !dbg !2024, !tbaa !1980
  %83 = icmp eq %"struct.NotifierSignal::vmpair"* %82, null, !dbg !2025
  br i1 %83, label %86, label %84, !dbg !2025

84:                                               ; preds = %80
  %85 = bitcast %"struct.NotifierSignal::vmpair"* %82 to i8*, !dbg !2025
  call void @_ZdaPv(i8* %85) #15, !dbg !2025
  br label %86, !dbg !2025

86:                                               ; preds = %84, %80, %76
  %87 = load i32, i32* %67, align 8, !dbg !2026, !tbaa !1975
  store i32 %87, i32* %77, align 8, !dbg !2027, !tbaa !1975
  %88 = icmp eq i32 %87, 0, !dbg !2028
  br i1 %88, label %92, label %89, !dbg !2029, !prof !2018, !misexpect !2019

89:                                               ; preds = %86
  %90 = load i64, i64* %68, align 8, !dbg !2030, !tbaa !1980
  %91 = bitcast %class.NotifierSignal* %74 to i64*, !dbg !2031
  store i64 %90, i64* %91, align 8, !dbg !2031, !tbaa !1980
  br label %93, !dbg !2032
...
92:                                               ; preds = %86
  invoke void @_ZN14NotifierSignal14hard_assign_vmERKS_(%class.NotifierSignal* nonnull %74, %class.NotifierSignal* nonnull dereferenceable(16) %3)
          to label %93 unwind label %106, !dbg !2033

93:                                               ; preds = %89, %70, %92
  call void @llvm.dbg.value(metadata %class.NotifierSignal* %3, metadata !2000, metadata !DIExpression()) #14, !dbg !2034
  %94 = load i32, i32* %67, align 8, !dbg !2035, !tbaa !1975
  %95 = icmp eq i32 %94, 0, !dbg !2035
  br i1 %95, label %96, label %101, !dbg !2036, !prof !2018, !misexpect !2023

96:                                               ; preds = %93
  %97 = load %"struct.NotifierSignal::vmpair"*, %"struct.NotifierSignal::vmpair"** %69, align 8, !dbg !2037, !tbaa !1980
  %98 = icmp eq %"struct.NotifierSignal::vmpair"* %97, null, !dbg !2038
  br i1 %98, label %101, label %99, !dbg !2038

99:                                               ; preds = %96
  %100 = bitcast %"struct.NotifierSignal::vmpair"* %97 to i8*, !dbg !2038
  call void @_ZdaPv(i8* %100) #15, !dbg !2038
  br label %101, !dbg !2038

101:                                              ; preds = %93, %96, %99
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %66) #14, !dbg !2014
  %102 = add nuw nsw i64 %71, 1, !dbg !2039
  call void @llvm.dbg.value(metadata i64 %102, metadata !1943, metadata !DIExpression()), !dbg !1964
  call void @llvm.dbg.value(metadata %class.Element* %4, metadata !1948, metadata !DIExpression()), !dbg !1965
  %103 = load i32, i32* %5, align 8, !dbg !1983, !tbaa !1960
  %104 = sext i32 %103 to i64, !dbg !2040
  %105 = icmp slt i64 %102, %104, !dbg !2040
  br i1 %105, label %70, label %116, !dbg !1968, !llvm.loop !2041

106:                                              ; preds = %92
  %107 = landingpad { i8*, i32 }
          cleanup, !dbg !2043
  call void @llvm.dbg.value(metadata %class.NotifierSignal* %3, metadata !2000, metadata !DIExpression()) #14, !dbg !2044
  %108 = load i32, i32* %67, align 8, !dbg !2046, !tbaa !1975
  %109 = icmp eq i32 %108, 0, !dbg !2046
  br i1 %109, label %110, label %115, !dbg !2047, !prof !2018, !misexpect !2023

110:                                              ; preds = %106
  %111 = load %"struct.NotifierSignal::vmpair"*, %"struct.NotifierSignal::vmpair"** %69, align 8, !dbg !2048, !tbaa !1980
  %112 = icmp eq %"struct.NotifierSignal::vmpair"* %111, null, !dbg !2049
  br i1 %112, label %115, label %113, !dbg !2049

113:                                              ; preds = %110
  %114 = bitcast %"struct.NotifierSignal::vmpair"* %111 to i8*, !dbg !2049
  call void @_ZdaPv(i8* %114) #15, !dbg !2049
  br label %115, !dbg !2049

115:                                              ; preds = %106, %110, %113
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %66) #14, !dbg !2014
  resume { i8*, i32 } %107, !dbg !1961
...
define dso_local void @_ZN7RRSched7cleanupEN7Element12CleanupStageE(%class.RRSched* nocapture readonly %0, i32 %1) unnamed_addr #6 align 2 !dbg !2051 {
  call void @llvm.dbg.value(metadata %class.RRSched* %0, metadata !2053, metadata !DIExpression()), !dbg !2055
  call void @llvm.dbg.value(metadata i32 undef, metadata !2054, metadata !DIExpression()), !dbg !2055
  %3 = getelementptr inbounds %class.RRSched, %class.RRSched* %0, i64 0, i32 2, !dbg !2056
  %4 = load %class.NotifierSignal*, %class.NotifierSignal** %3, align 8, !dbg !2056, !tbaa !1937
  %5 = icmp eq %class.NotifierSignal* %4, null, !dbg !2057
  br i1 %5, label %29, label %6, !dbg !2057

6:                                                ; preds = %2
  %7 = getelementptr inbounds %class.NotifierSignal, %class.NotifierSignal* %4, i64 -1, i32 1, !dbg !2057
  %8 = bitcast i32* %7 to i8*, !dbg !2057
  %9 = bitcast i32* %7 to i64*, !dbg !2057
  %10 = load i64, i64* %9, align 8, !dbg !2057
  %11 = icmp eq i64 %10, 0, !dbg !2057
  br i1 %11, label %28, label %12, !dbg !2057

12:                                               ; preds = %6
  %13 = getelementptr inbounds %class.NotifierSignal, %class.NotifierSignal* %4, i64 %10, !dbg !2057
  br label %14, !dbg !2058

14:                                               ; preds = %12, %26
  %15 = phi %class.NotifierSignal* [ %16, %26 ], [ %13, %12 ], !dbg !2057
  %16 = getelementptr inbounds %class.NotifierSignal, %class.NotifierSignal* %15, i64 -1, !dbg !2057
  call void @llvm.dbg.value(metadata %class.NotifierSignal* %16, metadata !2000, metadata !DIExpression()) #14, !dbg !2060
  %17 = getelementptr inbounds %class.NotifierSignal, %class.NotifierSignal* %15, i64 -1, i32 1, !dbg !2061
  %18 = load i32, i32* %17, align 8, !dbg !2061, !tbaa !1975
  %19 = icmp eq i32 %18, 0, !dbg !2061
  br i1 %19, label %20, label %26, !dbg !2058, !prof !2018, !misexpect !2023

20:                                               ; preds = %14
  %21 = bitcast %class.NotifierSignal* %16 to %"struct.NotifierSignal::vmpair"**, !dbg !2062
  %22 = load %"struct.NotifierSignal::vmpair"*, %"struct.NotifierSignal::vmpair"** %21, align 8, !dbg !2062, !tbaa !1980
  %23 = icmp eq %"struct.NotifierSignal::vmpair"* %22, null, !dbg !2063
  br i1 %23, label %26, label %24, !dbg !2063

24:                                               ; preds = %20
  %25 = bitcast %"struct.NotifierSignal::vmpair"* %22 to i8*, !dbg !2063
  tail call void @_ZdaPv(i8* %25) #15, !dbg !2063
  br label %26, !dbg !2063

26:                                               ; preds = %14, %20, %24
  %27 = icmp eq %class.NotifierSignal* %16, %4, !dbg !2057
  br i1 %27, label %28, label %14, !dbg !2057

28:                                               ; preds = %26, %6
  tail call void @_ZdaPv(i8* nonnull %8) #15, !dbg !2057
...
; Function Attrs: sspstrong uwtable
define dso_local %class.Packet* @_ZN7RRSched4pullEi(%class.RRSched* %0, i32 %1) unnamed_addr #0 align 2 !dbg !2065 {
  call void @llvm.dbg.value(metadata %class.RRSched* %0, metadata !2067, metadata !DIExpression()), !dbg !2076
  call void @llvm.dbg.value(metadata i32 undef, metadata !2068, metadata !DIExpression()), !dbg !2076
  %3 = bitcast %class.RRSched* %0 to %class.Element*, !dbg !2077
  call void @llvm.dbg.value(metadata %class.Element* %3, metadata !1948, metadata !DIExpression()), !dbg !2078
  %4 = getelementptr inbounds %class.RRSched, %class.RRSched* %0, i64 0, i32 0, i32 3, i64 0, !dbg !2080
  %5 = load i32, i32* %4, align 8, !dbg !2080, !tbaa !1960
  call void @llvm.dbg.value(metadata i32 %5, metadata !2069, metadata !DIExpression()), !dbg !2076
  %6 = getelementptr inbounds %class.RRSched, %class.RRSched* %0, i64 0, i32 1, !dbg !2081
  call void @llvm.dbg.value(metadata i32 undef, metadata !2070, metadata !DIExpression()), !dbg !2076
  call void @llvm.dbg.value(metadata i32 0, metadata !2071, metadata !DIExpression()), !dbg !2082
  %7 = icmp sgt i32 %5, 0, !dbg !2083
  br i1 %7, label %8, label %79, !dbg !2084

8:                                                ; preds = %2
  %9 = load i32, i32* %6, align 4, !dbg !2081, !tbaa !1931
  call void @llvm.dbg.value(metadata i32 %9, metadata !2070, metadata !DIExpression()), !dbg !2076
  %10 = getelementptr inbounds %class.RRSched, %class.RRSched* %0, i64 0, i32 2, !dbg !2085
  br label %11, !dbg !2084

11:                                               ; preds = %74, %8
  %12 = phi i32 [ 0, %8 ], [ %76, %74 ]
  %13 = phi i32 [ %9, %8 ], [ %75, %74 ]
  call void @llvm.dbg.value(metadata i32 %12, metadata !2071, metadata !DIExpression()), !dbg !2082
  call void @llvm.dbg.value(metadata i32 %13, metadata !2070, metadata !DIExpression()), !dbg !2076
  %14 = load %class.NotifierSignal*, %class.NotifierSignal** %10, align 8, !dbg !2086, !tbaa !1937
  %15 = sext i32 %13 to i64, !dbg !2086
  %16 = getelementptr inbounds %class.NotifierSignal, %class.NotifierSignal* %14, i64 %15, !dbg !2086
  call void @llvm.dbg.value(metadata %class.NotifierSignal* %16, metadata !2087, metadata !DIExpression()), !dbg !2091
  call void @llvm.dbg.value(metadata %class.NotifierSignal* %16, metadata !2093, metadata !DIExpression()), !dbg !2100
  tail call void asm sideeffect "", "~{memory},~{dirflag},~{fpsr},~{flags}"() #14, !dbg !2102, !srcloc !2108
  %17 = getelementptr inbounds %class.NotifierSignal, %class.NotifierSignal* %14, i64 %15, i32 1, !dbg !2109
  %18 = load i32, i32* %17, align 8, !dbg !2109, !tbaa !1975
  %19 = icmp eq i32 %18, 0, !dbg !2109
  br i1 %19, label %20, label %40, !dbg !2110, !prof !2018, !misexpect !2019

20:                                               ; preds = %11
  %21 = bitcast %class.NotifierSignal* %16 to %"struct.NotifierSignal::vmpair"**, !dbg !2111
  %22 = load %"struct.NotifierSignal::vmpair"*, %"struct.NotifierSignal::vmpair"** %21, align 8, !dbg !2111, !tbaa !1980
  call void @llvm.dbg.value(metadata %"struct.NotifierSignal::vmpair"* %22, metadata !2096, metadata !DIExpression()), !dbg !2112
  %23 = getelementptr inbounds %"struct.NotifierSignal::vmpair", %"struct.NotifierSignal::vmpair"* %22, i64 0, i32 1, !dbg !2113
  %24 = load i32, i32* %23, align 8, !dbg !2113, !tbaa !2115
  %25 = icmp eq i32 %24, 0, !dbg !2117
  br i1 %25, label %48, label %31, !dbg !2118

26:                                               ; preds = %31
  %27 = getelementptr inbounds %"struct.NotifierSignal::vmpair", %"struct.NotifierSignal::vmpair"* %33, i64 1, !dbg !2119
  call void @llvm.dbg.value(metadata %"struct.NotifierSignal::vmpair"* %27, metadata !2096, metadata !DIExpression()), !dbg !2112
  call void @llvm.dbg.value(metadata %"struct.NotifierSignal::vmpair"* %27, metadata !2096, metadata !DIExpression()), !dbg !2112
  %28 = getelementptr inbounds %"struct.NotifierSignal::vmpair", %"struct.NotifierSignal::vmpair"* %33, i64 1, i32 1, !dbg !2113
  %29 = load i32, i32* %28, align 8, !dbg !2113, !tbaa !2115
  %30 = icmp eq i32 %29, 0, !dbg !2117
  br i1 %30, label %48, label %31, !dbg !2118, !llvm.loop !2120

31:                                               ; preds = %20, %26
  %32 = phi i32 [ %29, %26 ], [ %24, %20 ]
  %33 = phi %"struct.NotifierSignal::vmpair"* [ %27, %26 ], [ %22, %20 ]
  call void @llvm.dbg.value(metadata %"struct.NotifierSignal::vmpair"* %33, metadata !2096, metadata !DIExpression()), !dbg !2112
  %34 = getelementptr inbounds %"struct.NotifierSignal::vmpair", %"struct.NotifierSignal::vmpair"* %33, i64 0, i32 0, !dbg !2122
  %35 = load %class.atomic_uint32_t*, %class.atomic_uint32_t** %34, align 8, !dbg !2122, !tbaa !2124
  call void @llvm.dbg.value(metadata %class.atomic_uint32_t* %35, metadata !2125, metadata !DIExpression()), !dbg !2129
  call void @llvm.dbg.value(metadata %class.atomic_uint32_t* %35, metadata !2131, metadata !DIExpression()), !dbg !2134
  %36 = getelementptr inbounds %class.atomic_uint32_t, %class.atomic_uint32_t* %35, i64 0, i32 0, !dbg !2136
  %37 = load i32, i32* %36, align 4, !dbg !2136, !tbaa !2137
  %38 = and i32 %37, %32, !dbg !2139
  %39 = icmp eq i32 %38, 0, !dbg !2140
  call void @llvm.dbg.value(metadata %"struct.NotifierSignal::vmpair"* %33, metadata !2096, metadata !DIExpression(DW_OP_plus_uconst, 16, DW_OP_stack_value)), !dbg !2112
  br i1 %39, label %26, label %47, !dbg !2141

40:                                               ; preds = %11
  %41 = getelementptr inbounds %class.NotifierSignal, %class.NotifierSignal* %16, i64 0, i32 0, i32 0, !dbg !2142
  %42 = load %class.atomic_uint32_t*, %class.atomic_uint32_t** %41, align 8, !dbg !2142, !tbaa !1980
  call void @llvm.dbg.value(metadata %class.atomic_uint32_t* %42, metadata !2125, metadata !DIExpression()), !dbg !2143
  call void @llvm.dbg.value(metadata %class.atomic_uint32_t* %42, metadata !2131, metadata !DIExpression()), !dbg !2145
  %43 = getelementptr inbounds %class.atomic_uint32_t, %class.atomic_uint32_t* %42, i64 0, i32 0, !dbg !2147
  %44 = load i32, i32* %43, align 4, !dbg !2147, !tbaa !2137
  %45 = and i32 %44, %18, !dbg !2148
  %46 = icmp eq i32 %45, 0, !dbg !2149
  br i1 %46, label %48, label %47, !dbg !2150

47:                                               ; preds = %31, %40
  br label %48, !dbg !2150

48:                                               ; preds = %26, %20, %40, %47
  %49 = phi { i64, i64 } [ { i64 ptrtoint (i1 (%class.NotifierSignal*)* @_ZNK14NotifierSignal6activeEv to i64), i64 0 }, %47 ], [ zeroinitializer, %40 ], [ zeroinitializer, %20 ], [ zeroinitializer, %26 ]
  %50 = extractvalue { i64, i64 } %49, 0, !dbg !2086
  %51 = icmp eq i64 %50, 0, !dbg !2086
  br i1 %51, label %52, label %56, !dbg !2086

52:                                               ; preds = %48
  call void @llvm.dbg.value(metadata %class.Packet* %69, metadata !2073, metadata !DIExpression()), !dbg !2085
  %53 = add nsw i32 %13, 1, !dbg !2151
  call void @llvm.dbg.value(metadata i32 %70, metadata !2070, metadata !DIExpression()), !dbg !2076
  %54 = icmp slt i32 %53, %5, !dbg !2152
  %55 = select i1 %54, i32 %53, i32 0, !dbg !2154
  call void @llvm.dbg.value(metadata i32 %72, metadata !2070, metadata !DIExpression()), !dbg !2076
  br label %74, !dbg !2155

56:                                               ; preds = %48
  %57 = tail call dereferenceable(16) %"class.Element::Port"* @_ZNK7Element5inputEi(%class.Element* %3, i32 %13), !dbg !2156
  call void @llvm.dbg.value(metadata %"class.Element::Port"* %57, metadata !2157, metadata !DIExpression()), !dbg !2193
  %58 = getelementptr inbounds %"class.Element::Port", %"class.Element::Port"* %57, i64 0, i32 0, !dbg !2195
  %59 = load %class.Element*, %class.Element** %58, align 8, !dbg !2195, !tbaa !2196
  %60 = icmp eq %class.Element* %59, null, !dbg !2195
  br i1 %60, label %61, label %62, !dbg !2195

61:                                               ; preds = %56
  tail call void @__assert_fail(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0), i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.2, i64 0, i64 0), i32 657, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @__PRETTY_FUNCTION__._ZNK7Element4Port4pullEv, i64 0, i64 0)) #16, !dbg !2195
  unreachable, !dbg !2195

62:                                               ; preds = %56
  %63 = getelementptr inbounds %"class.Element::Port", %"class.Element::Port"* %57, i64 0, i32 1, !dbg !2198
  %64 = load i32, i32* %63, align 8, !dbg !2198, !tbaa !2199
  %65 = bitcast %class.Element* %59 to %class.Packet* (%class.Element*, i32)***, !dbg !2200
  %66 = load %class.Packet* (%class.Element*, i32)**, %class.Packet* (%class.Element*, i32)*** %65, align 8, !dbg !2200, !tbaa !1927
  %67 = getelementptr inbounds %class.Packet* (%class.Element*, i32)*, %class.Packet* (%class.Element*, i32)** %66, i64 3, !dbg !2200
  %68 = load %class.Packet* (%class.Element*, i32)*, %class.Packet* (%class.Element*, i32)** %67, align 8, !dbg !2200
  %69 = tail call %class.Packet* %68(%class.Element* nonnull %59, i32 %64), !dbg !2200
  call void @llvm.dbg.value(metadata %class.Packet* %69, metadata !2191, metadata !DIExpression()), !dbg !2193
  call void @llvm.dbg.value(metadata %class.Packet* %69, metadata !2073, metadata !DIExpression()), !dbg !2085
  %70 = add nsw i32 %13, 1, !dbg !2151
  call void @llvm.dbg.value(metadata i32 %70, metadata !2070, metadata !DIExpression()), !dbg !2076
  %71 = icmp slt i32 %70, %5, !dbg !2152
  %72 = select i1 %71, i32 %70, i32 0, !dbg !2154
  call void @llvm.dbg.value(metadata i32 %72, metadata !2070, metadata !DIExpression()), !dbg !2076
  %73 = icmp eq %class.Packet* %69, null, !dbg !2201
  br i1 %73, label %74, label %78, !dbg !2155

74:                                               ; preds = %62, %52
  %75 = phi i32 [ %55, %52 ], [ %72, %62 ]
  %76 = add nuw nsw i32 %12, 1, !dbg !2203
  call void @llvm.dbg.value(metadata i32 %76, metadata !2071, metadata !DIExpression()), !dbg !2082
  call void @llvm.dbg.value(metadata i32 %75, metadata !2070, metadata !DIExpression()), !dbg !2076
  %77 = icmp eq i32 %76, %5, !dbg !2083
  br i1 %77, label %79, label %11, !dbg !2084, !llvm.loop !2204

78:                                               ; preds = %62
  store i32 %72, i32* %6, align 4, !dbg !2206, !tbaa !1931
  br label %79

79:                                               ; preds = %74, %2, %78
  %80 = phi %class.Packet* [ %69, %78 ], [ null, %2 ], [ null, %74 ]
  ret %class.Packet* %80, !dbg !2208
}

; Function Attrs: noinline optnone sspstrong uwtable
define linkonce_odr dso_local dereferenceable(16) %"class.Element::Port"* @_ZNK7Element5inputEi(%class.Element* %0, i32 %1) local_unnamed_addr #7 comdat align 2 !dbg !2209 {
  %3 = alloca %class.Element*, align 8
  %4 = alloca i32, align 4
  store %class.Element* %0, %class.Element** %3, align 8, !tbaa !2217
  call void @llvm.dbg.declare(metadata %class.Element** %3, metadata !2215, metadata !DIExpression()), !dbg !2218
  store i32 %1, i32* %4, align 4, !tbaa !1960
  call void @llvm.dbg.declare(metadata i32* %4, metadata !2216, metadata !DIExpression()), !dbg !2219
  %5 = load %class.Element*, %class.Element** %3, align 8
  %6 = load i32, i32* %4, align 4, !dbg !2220, !tbaa !1960
  %7 = call dereferenceable(16) %"class.Element::Port"* @_ZNK7Element4portEbi(%class.Element* %5, i1 zeroext false, i32 %6), !dbg !2221
  ret %"class.Element::Port"* %7, !dbg !2222
}
...
define linkonce_odr dso_local void @_ZN7RRSchedD0Ev(%class.RRSched* %0) unnamed_addr #9 comdat align 2 !dbg !2223 {
  call void @llvm.dbg.value(metadata %class.RRSched* %0, metadata !2226, metadata !DIExpression()), !dbg !2227
  %2 = bitcast %class.RRSched* %0 to %class.Element*, !dbg !2228
  tail call void @_ZN7ElementD2Ev(%class.Element* %2) #14, !dbg !2228
  %3 = bitcast %class.RRSched* %0 to i8*, !dbg !2228
  tail call void @_ZdlPv(i8* %3) #15, !dbg !2228
  ret void, !dbg !2228
}
...
; Function Attrs: nounwind sspstrong uwtable
define linkonce_odr dso_local i8* @_ZNK7RRSched10class_nameEv(%class.RRSched* %0) unnamed_addr #6 comdat align 2 !dbg !2229 {
  call void @llvm.dbg.value(metadata %class.RRSched* %0, metadata !2231, metadata !DIExpression()), !dbg !2233
  ret i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.4, i64 0, i64 0), !dbg !2234
}

; Function Attrs: nounwind sspstrong uwtable
define linkonce_odr dso_local i8* @_ZNK7RRSched10port_countEv(%class.RRSched* %0) unnamed_addr #6 comdat align 2 !dbg !2235 {
  call void @llvm.dbg.value(metadata %class.RRSched* %0, metadata !2237, metadata !DIExpression()), !dbg !2238
  ret i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.5, i64 0, i64 0), !dbg !2239
}

; Function Attrs: nounwind sspstrong uwtable
define linkonce_odr dso_local i8* @_ZNK7RRSched10processingEv(%class.RRSched* %0) unnamed_addr #6 comdat align 2 !dbg !2240 {
  call void @llvm.dbg.value(metadata %class.RRSched* %0, metadata !2242, metadata !DIExpression()), !dbg !2243
  ret i8* getelementptr inbounds ([0 x i8], [0 x i8]* @_ZN7Element4PULLE, i64 0, i64 0), !dbg !2244
}

declare i8* @_ZNK7Element9flow_codeEv(%class.Element*) unnamed_addr #2

; Function Attrs: nounwind sspstrong uwtable
define linkonce_odr dso_local i8* @_ZNK7RRSched5flagsEv(%class.RRSched* %0) unnamed_addr #6 comdat align 2 !dbg !2245 {
  call void @llvm.dbg.value(metadata %class.RRSched* %0, metadata !2247, metadata !DIExpression()), !dbg !2248
  ret i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.6, i64 0, i64 0), !dbg !2249
}
...
define linkonce_odr dso_local zeroext i1 @_ZNK14NotifierSignal6activeEv(%class.NotifierSignal* %0) #10 comdat align 2 !dbg !2094 {
  call void @llvm.dbg.value(metadata %class.NotifierSignal* %0, metadata !2093, metadata !DIExpression()), !dbg !2250
  tail call void asm sideeffect "", "~{memory},~{dirflag},~{fpsr},~{flags}"() #14, !dbg !2251, !srcloc !2108
  %2 = getelementptr inbounds %class.NotifierSignal, %class.NotifierSignal* %0, i64 0, i32 1, !dbg !2254
  %3 = load i32, i32* %2, align 8, !dbg !2254, !tbaa !1975
  %4 = icmp eq i32 %3, 0, !dbg !2254
  br i1 %4, label %12, label %5, !dbg !2255, !prof !2018, !misexpect !2019

5:                                                ; preds = %1
  %6 = getelementptr inbounds %class.NotifierSignal, %class.NotifierSignal* %0, i64 0, i32 0, i32 0, !dbg !2256
  %7 = load %class.atomic_uint32_t*, %class.atomic_uint32_t** %6, align 8, !dbg !2256, !tbaa !1980
  call void @llvm.dbg.value(metadata %class.atomic_uint32_t* %7, metadata !2125, metadata !DIExpression()), !dbg !2257
  call void @llvm.dbg.value(metadata %class.atomic_uint32_t* %7, metadata !2131, metadata !DIExpression()), !dbg !2259
  %8 = getelementptr inbounds %class.atomic_uint32_t, %class.atomic_uint32_t* %7, i64 0, i32 0, !dbg !2261
  %9 = load i32, i32* %8, align 4, !dbg !2261, !tbaa !2137
  %10 = and i32 %9, %3, !dbg !2262
  %11 = icmp ne i32 %10, 0, !dbg !2263
  ret i1 %11, !dbg !2264

12:                                               ; preds = %1
  %13 = bitcast %class.NotifierSignal* %0 to %"struct.NotifierSignal::vmpair"**, !dbg !2265
  %14 = load %"struct.NotifierSignal::vmpair"*, %"struct.NotifierSignal::vmpair"** %13, align 8, !dbg !2265, !tbaa !1980
  call void @llvm.dbg.value(metadata %"struct.NotifierSignal::vmpair"* %14, metadata !2096, metadata !DIExpression()), !dbg !2266
  %15 = getelementptr inbounds %"struct.NotifierSignal::vmpair", %"struct.NotifierSignal::vmpair"* %14, i64 0, i32 1, !dbg !2267
  %16 = load i32, i32* %15, align 8, !dbg !2267, !tbaa !2115
  %17 = icmp eq i32 %16, 0, !dbg !2268
  br i1 %17, label %32, label %23, !dbg !2269

18:                                               ; preds = %23
  %19 = getelementptr inbounds %"struct.NotifierSignal::vmpair", %"struct.NotifierSignal::vmpair"* %25, i64 1, !dbg !2270
  call void @llvm.dbg.value(metadata %"struct.NotifierSignal::vmpair"* %19, metadata !2096, metadata !DIExpression()), !dbg !2266
  call void @llvm.dbg.value(metadata %"struct.NotifierSignal::vmpair"* %19, metadata !2096, metadata !DIExpression()), !dbg !2266
  %20 = getelementptr inbounds %"struct.NotifierSignal::vmpair", %"struct.NotifierSignal::vmpair"* %25, i64 1, i32 1, !dbg !2267
  %21 = load i32, i32* %20, align 8, !dbg !2267, !tbaa !2115
  %22 = icmp eq i32 %21, 0, !dbg !2268
  br i1 %22, label %32, label %23, !dbg !2269, !llvm.loop !2271

23:                                               ; preds = %12, %18
  %24 = phi i32 [ %21, %18 ], [ %16, %12 ]
  %25 = phi %"struct.NotifierSignal::vmpair"* [ %19, %18 ], [ %14, %12 ]
  call void @llvm.dbg.value(metadata %"struct.NotifierSignal::vmpair"* %25, metadata !2096, metadata !DIExpression()), !dbg !2266
  %26 = getelementptr inbounds %"struct.NotifierSignal::vmpair", %"struct.NotifierSignal::vmpair"* %25, i64 0, i32 0, !dbg !2273
  %27 = load %class.atomic_uint32_t*, %class.atomic_uint32_t** %26, align 8, !dbg !2273, !tbaa !2124
  call void @llvm.dbg.value(metadata %class.atomic_uint32_t* %27, metadata !2125, metadata !DIExpression()), !dbg !2274
  call void @llvm.dbg.value(metadata %class.atomic_uint32_t* %27, metadata !2131, metadata !DIExpression()), !dbg !2276
  %28 = getelementptr inbounds %class.atomic_uint32_t, %class.atomic_uint32_t* %27, i64 0, i32 0, !dbg !2278
  %29 = load i32, i32* %28, align 4, !dbg !2278, !tbaa !2137
  %30 = and i32 %29, %24, !dbg !2279
  %31 = icmp eq i32 %30, 0, !dbg !2280
  call void @llvm.dbg.value(metadata %"struct.NotifierSignal::vmpair"* %25, metadata !2096, metadata !DIExpression(DW_OP_plus_uconst, 16, DW_OP_stack_value)), !dbg !2266
  br i1 %31, label %18, label %32, !dbg !2281
...
define linkonce_odr dso_local dereferenceable(16) %"class.Element::Port"* @_ZNK7Element4portEbi(%class.Element* %0, i1 zeroext %1, i32 %2) local_unnamed_addr #11 comdat align 2 !dbg !2282 {
  %4 = alloca %class.Element*, align 8
  %5 = alloca i8, align 1
  %6 = alloca i32, align 4
  store %class.Element* %0, %class.Element** %4, align 8, !tbaa !2217
  call void @llvm.dbg.declare(metadata %class.Element** %4, metadata !2287, metadata !DIExpression()), !dbg !2290
  %7 = zext i1 %1 to i8
  store i8 %7, i8* %5, align 1, !tbaa !2291
  call void @llvm.dbg.declare(metadata i8* %5, metadata !2288, metadata !DIExpression()), !dbg !2293
  store i32 %2, i32* %6, align 4, !tbaa !1960
  call void @llvm.dbg.declare(metadata i32* %6, metadata !2289, metadata !DIExpression()), !dbg !2294
  %8 = load %class.Element*, %class.Element** %4, align 8
  %9 = load i32, i32* %6, align 4, !dbg !2295, !tbaa !1960
  %10 = getelementptr inbounds %class.Element, %class.Element* %8, i32 0, i32 3, !dbg !2295
  %11 = load i8, i8* %5, align 1, !dbg !2295, !tbaa !2291, !range !2296
  %12 = trunc i8 %11 to i1, !dbg !2295
  %13 = zext i1 %12 to i64, !dbg !2295
  %14 = getelementptr inbounds [2 x i32], [2 x i32]* %10, i64 0, i64 %13, !dbg !2295
  %15 = load i32, i32* %14, align 4, !dbg !2295, !tbaa !1960
  %16 = icmp ult i32 %9, %15, !dbg !2295
  br i1 %16, label %17, label %18, !dbg !2295

17:                                               ; preds = %3
  br label %19, !dbg !2295

18:                                               ; preds = %3
  call void @__assert_fail(i8* getelementptr inbounds ([47 x i8], [47 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.2, i64 0, i64 0), i32 437, i8* getelementptr inbounds ([52 x i8], [52 x i8]* @__PRETTY_FUNCTION__._ZNK7Element4portEbi, i64 0, i64 0)) #16, !dbg !2295
  unreachable, !dbg !2295

19:                                               ; preds = %17
  %20 = getelementptr inbounds %class.Element, %class.Element* %8, i32 0, i32 1, !dbg !2297
  %21 = load i8, i8* %5, align 1, !dbg !2298, !tbaa !2291, !range !2296
  %22 = trunc i8 %21 to i1, !dbg !2298
  %23 = zext i1 %22 to i64, !dbg !2297
  %24 = getelementptr inbounds [2 x %"class.Element::Port"*], [2 x %"class.Element::Port"*]* %20, i64 0, i64 %23, !dbg !2297
  %25 = load %"class.Element::Port"*, %"class.Element::Port"** %24, align 8, !dbg !2297, !tbaa !2217
  %26 = load i32, i32* %6, align 4, !dbg !2299, !tbaa !1960
  %27 = sext i32 %26 to i64, !dbg !2297
  %28 = getelementptr inbounds %"class.Element::Port", %"class.Element::Port"* %25, i64 %27, !dbg !2297
  ret %"class.Element::Port"* %28, !dbg !2300
}
...
!1 = !DIFile(filename: "../elements/standard/rrsched.cc", directory: "/home/john/projects/click/ir-dir")
!2 = !{!3, !16, !869, !1174}
...
!1889 = distinct !DISubprogram(name: "RRSched", linkageName: "_ZN7RRSchedC2Ev", scope: !1890, file: !1, line: 24, type: !1898, scopeLine: 26, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1897, retainedNodes: !1921)
!1890 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "RRSched", file: !1891, line: 28, size: 960, flags: DIFlagTypePassByReference | DIFlagNonTrivial, elements: !1892, vtableHolder: !5)
!1891 = !DIFile(filename: "../elements/standard/rrsched.hh", directory: "/home/john/projects/click/ir-dir")
!1892 = !{!1893, !1894, !1895, !1897, !1901, !1906, !1907, !1908, !1909, !1915, !1918}
!1893 = !DIDerivedType(tag: DW_TAG_inheritance, scope: !1890, baseType: !5, flags: DIFlagPublic, extraData: i32 0)
!1894 = !DIDerivedType(tag: DW_TAG_member, name: "_next", scope: !1890, file: !1891, line: 44, baseType: !46, size: 32, offset: 864)
!1895 = !DIDerivedType(tag: DW_TAG_member, name: "_signals", scope: !1890, file: !1891, line: 45, baseType: !1896, size: 64, offset: 896)
!1896 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1176, size: 64)
!1897 = !DISubprogram(name: "RRSched", scope: !1890, file: !1891, line: 30, type: !1898, scopeLine: 30, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1898 = !DISubroutineType(types: !1899)
!1899 = !{null, !1900}
!1900 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1890, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1901 = !DISubprogram(name: "class_name", linkageName: "_ZNK7RRSched10class_nameEv", scope: !1890, file: !1891, line: 32, type: !1902, scopeLine: 32, containingType: !1890, virtualIndex: 9, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual | DISPFlagOptimized)
!1902 = !DISubroutineType(types: !1903)
!1903 = !{!578, !1904}
!1904 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1905, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1905 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1890)
!1906 = !DISubprogram(name: "port_count", linkageName: "_ZNK7RRSched10port_countEv", scope: !1890, file: !1891, line: 33, type: !1902, scopeLine: 33, containingType: !1890, virtualIndex: 10, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual | DISPFlagOptimized)
!1907 = !DISubprogram(name: "processing", linkageName: "_ZNK7RRSched10processingEv", scope: !1890, file: !1891, line: 34, type: !1902, scopeLine: 34, containingType: !1890, virtualIndex: 11, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual | DISPFlagOptimized)
!1908 = !DISubprogram(name: "flags", linkageName: "_ZNK7RRSched5flagsEv", scope: !1890, file: !1891, line: 35, type: !1902, scopeLine: 35, containingType: !1890, virtualIndex: 13, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual | DISPFlagOptimized)
!1909 = !DISubprogram(name: "initialize", linkageName: "_ZN7RRSched10initializeEP12ErrorHandler", scope: !1890, file: !1891, line: 37, type: !1910, scopeLine: 37, containingType: !1890, virtualIndex: 19, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual | DISPFlagOptimized)
!1910 = !DISubroutineType(types: !1911)
!1911 = !{!46, !1900, !1912}
!1912 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1913, size: 64)
!1913 = !DICompositeType(tag: DW_TAG_class_type, name: "ErrorHandler", file: !1914, line: 90, flags: DIFlagFwdDecl, identifier: "_ZTS12ErrorHandler")
!1914 = !DIFile(filename: "../dummy_inc/click/error.hh", directory: "/home/john/projects/click/ir-dir")
!1915 = !DISubprogram(name: "cleanup", linkageName: "_ZN7RRSched7cleanupEN7Element12CleanupStageE", scope: !1890, file: !1891, line: 38, type: !1916, scopeLine: 38, containingType: !1890, virtualIndex: 22, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual | DISPFlagOptimized)
!1916 = !DISubroutineType(types: !1917)
!1917 = !{null, !1900, !3}
!1918 = !DISubprogram(name: "pull", linkageName: "_ZN7RRSched4pullEi", scope: !1890, file: !1891, line: 40, type: !1919, scopeLine: 40, containingType: !1890, virtualIndex: 3, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual | DISPFlagOptimized)
!1919 = !DISubroutineType(types: !1920)
!1920 = !{!90, !1900, !46}
!1921 = !{!1922}
!1922 = !DILocalVariable(name: "this", arg: 1, scope: !1889, type: !1923, flags: DIFlagArtificial | DIFlagObjectPointer)
!1923 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1890, size: 64)
!1924 = !DILocation(line: 0, scope: !1889)
!1925 = !DILocation(line: 26, column: 1, scope: !1889)
!1926 = !DILocation(line: 24, column: 10, scope: !1889)
!1927 = !{!1928, !1928, i64 0}
!1928 = !{!"vtable pointer", !1929, i64 0}
!1929 = !{!"Simple C++ TBAA"}
!1930 = !DILocation(line: 25, column: 7, scope: !1889)
!1931 = !{!1932, !1933, i64 108}
!1932 = !{!"_ZTS7RRSched", !1933, i64 108, !1935, i64 112}
!1933 = !{!"int", !1934, i64 0}
!1934 = !{!"omnipotent char", !1929, i64 0}
!1935 = !{!"any pointer", !1934, i64 0}
!1936 = !DILocation(line: 25, column: 17, scope: !1889)
!1937 = !{!1932, !1935, i64 112}
!1938 = !DILocation(line: 27, column: 1, scope: !1889)
!1939 = distinct !DISubprogram(name: "initialize", linkageName: "_ZN7RRSched10initializeEP12ErrorHandler", scope: !1890, file: !1, line: 30, type: !1910, scopeLine: 31, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1909, retainedNodes: !1940)
!1940 = !{!1941, !1942, !1943}
!1941 = !DILocalVariable(name: "this", arg: 1, scope: !1939, type: !1923, flags: DIFlagArtificial | DIFlagObjectPointer)
!1942 = !DILocalVariable(name: "errh", arg: 2, scope: !1939, file: !1, line: 30, type: !1912)
!1943 = !DILocalVariable(name: "i", scope: !1944, file: !1, line: 34, type: !46)
!1944 = distinct !DILexicalBlock(scope: !1939, file: !1, line: 34, column: 5)
!1945 = !DILocation(line: 0, scope: !1939)
!1946 = !DILocation(line: 32, column: 41, scope: !1947)
!1947 = distinct !DILexicalBlock(scope: !1939, file: !1, line: 32, column: 9)
!1948 = !DILocalVariable(name: "this", arg: 1, scope: !1949, type: !1956, flags: DIFlagArtificial | DIFlagObjectPointer)
!1949 = distinct !DISubprogram(name: "ninputs", linkageName: "_ZNK7Element7ninputsEv", scope: !5, file: !4, line: 417, type: !1950, scopeLine: 418, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1954, retainedNodes: !1955)
!1950 = !DISubroutineType(types: !1951)
!1951 = !{!46, !1952}
!1952 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1953, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1953 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !5)
!1954 = !DISubprogram(name: "ninputs", linkageName: "_ZNK7Element7ninputsEv", scope: !5, file: !4, line: 131, type: !1950, scopeLine: 131, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1955 = !{!1948}
!1956 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1953, size: 64)
!1957 = !DILocation(line: 0, scope: !1949, inlinedAt: !1958)
!1958 = distinct !DILocation(line: 32, column: 41, scope: !1947)
!1959 = !DILocation(line: 419, column: 12, scope: !1949, inlinedAt: !1958)
!1960 = !{!1933, !1933, i64 0}
!1961 = !DILocation(line: 32, column: 22, scope: !1947)
!1962 = !DILocation(line: 32, column: 11, scope: !1947)
!1963 = !DILocation(line: 32, column: 20, scope: !1947)
!1964 = !DILocation(line: 0, scope: !1944)
!1965 = !DILocation(line: 0, scope: !1949, inlinedAt: !1966)
!1966 = distinct !DILocation(line: 34, column: 25, scope: !1967)
!1967 = distinct !DILexicalBlock(scope: !1944, file: !1, line: 34, column: 5)
!1968 = !DILocation(line: 34, column: 5, scope: !1944)
!1969 = !DILocalVariable(name: "this", arg: 1, scope: !1970, type: !1896, flags: DIFlagArtificial | DIFlagObjectPointer)
!1970 = distinct !DISubprogram(name: "NotifierSignal", linkageName: "_ZN14NotifierSignalC2Ev", scope: !1176, file: !1175, line: 173, type: !1192, scopeLine: 174, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1191, retainedNodes: !1971)
!1971 = !{!1969}
!1972 = !DILocation(line: 0, scope: !1970, inlinedAt: !1973)
!1973 = distinct !DILocation(line: 32, column: 22, scope: !1947)
!1974 = !DILocation(line: 174, column: 7, scope: !1970, inlinedAt: !1973)
!1975 = !{!1976, !1933, i64 8}
!1976 = !{!"_ZTS14NotifierSignal", !1934, i64 0, !1933, i64 8}
!1977 = !DILocation(line: 175, column: 8, scope: !1978, inlinedAt: !1973)
!1978 = distinct !DILexicalBlock(scope: !1970, file: !1175, line: 174, column: 24)
!1979 = !DILocation(line: 175, column: 11, scope: !1978, inlinedAt: !1973)
!1980 = !{!1934, !1934, i64 0}
!1981 = distinct !{!1981, !1982}
!1982 = !{!"llvm.loop.unroll.disable"}
!1983 = !DILocation(line: 419, column: 12, scope: !1949, inlinedAt: !1966)
!1984 = !DILocation(line: 0, scope: !1967)
!1985 = !DILocation(line: 0, scope: !1986, inlinedAt: !1992)
!1986 = distinct !DILexicalBlock(scope: !1987, file: !1175, line: 311, column: 29)
!1987 = distinct !DILexicalBlock(scope: !1988, file: !1175, line: 311, column: 9)
!1988 = distinct !DISubprogram(name: "operator=", linkageName: "_ZN14NotifierSignalaSERKS_", scope: !1176, file: !1175, line: 310, type: !1227, scopeLine: 310, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1226, retainedNodes: !1989)
!1989 = !{!1990, !1991}
!1990 = !DILocalVariable(name: "this", arg: 1, scope: !1988, type: !1896, flags: DIFlagArtificial | DIFlagObjectPointer)
!1991 = !DILocalVariable(name: "x", arg: 2, scope: !1988, file: !1175, line: 310, type: !1201)
!1992 = distinct !DILocation(line: 35, column: 14, scope: !1967)
!1993 = !DILocation(line: 0, scope: !1994, inlinedAt: !1992)
!1994 = distinct !DILexicalBlock(scope: !1986, file: !1175, line: 315, column: 6)
!1995 = !DILocation(line: 0, scope: !1996, inlinedAt: !2001)
!1996 = distinct !DILexicalBlock(scope: !1997, file: !1175, line: 198, column: 9)
!1997 = distinct !DILexicalBlock(scope: !1998, file: !1175, line: 197, column: 42)
!1998 = distinct !DISubprogram(name: "~NotifierSignal", linkageName: "_ZN14NotifierSignalD2Ev", scope: !1176, file: !1175, line: 197, type: !1192, scopeLine: 197, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1203, retainedNodes: !1999)
!1999 = !{!2000}
!2000 = !DILocalVariable(name: "this", arg: 1, scope: !1998, type: !1896, flags: DIFlagArtificial | DIFlagObjectPointer)
!2001 = distinct !DILocation(line: 35, column: 2, scope: !1967)
!2002 = !DILocation(line: 35, column: 16, scope: !1967)
!2003 = !DILocalVariable(name: "e", arg: 1, scope: !2004, file: !1175, line: 565, type: !2007)
!2004 = distinct !DISubprogram(name: "upstream_empty_signal", linkageName: "_ZN8Notifier21upstream_empty_signalEP7Elementi", scope: !1255, file: !1175, line: 565, type: !2005, scopeLine: 565, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !2008, retainedNodes: !2009)
!2005 = !DISubroutineType(types: !2006)
!2006 = !{!1176, !2007, !46}
!2007 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !5, size: 64)
!2008 = !DISubprogram(name: "upstream_empty_signal", linkageName: "_ZN8Notifier21upstream_empty_signalEP7Elementi", scope: !1255, file: !1175, line: 108, type: !2005, scopeLine: 108, flags: DIFlagPublic | DIFlagPrototyped | DIFlagStaticMember, spFlags: DISPFlagOptimized)
!2009 = !{!2003, !2010}
!2010 = !DILocalVariable(name: "port", arg: 2, scope: !2004, file: !1175, line: 565, type: !46)
!2011 = !DILocation(line: 0, scope: !2004, inlinedAt: !2012)
!2012 = distinct !DILocation(line: 35, column: 16, scope: !1967)
!2013 = !DILocation(line: 566, column: 12, scope: !2004, inlinedAt: !2012)
!2014 = !DILocation(line: 35, column: 2, scope: !1967)
!2015 = !DILocation(line: 0, scope: !1988, inlinedAt: !1992)
!2016 = !DILocation(line: 311, column: 9, scope: !1987, inlinedAt: !1992)
!2017 = !DILocation(line: 311, column: 9, scope: !1988, inlinedAt: !1992)
!2018 = !{!"branch_weights", i32 1, i32 2000}
!2019 = !{!"misexpect", i64 0, i64 2000, i64 1}
!2020 = !DILocation(line: 312, column: 6, scope: !2021, inlinedAt: !1992)
!2021 = distinct !DILexicalBlock(scope: !1986, file: !1175, line: 312, column: 6)
!2022 = !DILocation(line: 312, column: 6, scope: !1986, inlinedAt: !1992)
!2023 = !{!"misexpect", i64 1, i64 2000, i64 1}
!2024 = !DILocation(line: 313, column: 18, scope: !2021, inlinedAt: !1992)
!2025 = !DILocation(line: 313, column: 6, scope: !2021, inlinedAt: !1992)
!2026 = !DILocation(line: 314, column: 12, scope: !1986, inlinedAt: !1992)
!2027 = !DILocation(line: 314, column: 8, scope: !1986, inlinedAt: !1992)
!2028 = !DILocation(line: 315, column: 6, scope: !1994, inlinedAt: !1992)
!2029 = !DILocation(line: 315, column: 6, scope: !1986, inlinedAt: !1992)
!2030 = !DILocation(line: 316, column: 19, scope: !1994, inlinedAt: !1992)
!2031 = !DILocation(line: 316, column: 12, scope: !1994, inlinedAt: !1992)
!2032 = !DILocation(line: 316, column: 6, scope: !1994, inlinedAt: !1992)
!2033 = !DILocation(line: 318, column: 6, scope: !1994, inlinedAt: !1992)
!2034 = !DILocation(line: 0, scope: !1998, inlinedAt: !2001)
!2035 = !DILocation(line: 198, column: 9, scope: !1996, inlinedAt: !2001)
!2036 = !DILocation(line: 198, column: 9, scope: !1997, inlinedAt: !2001)
!2037 = !DILocation(line: 199, column: 14, scope: !1996, inlinedAt: !2001)
!2038 = !DILocation(line: 199, column: 2, scope: !1996, inlinedAt: !2001)
!2039 = !DILocation(line: 34, column: 37, scope: !1967)
!2040 = !DILocation(line: 34, column: 23, scope: !1967)
!2041 = distinct !{!2041, !1968, !2042}
!2042 = !DILocation(line: 35, column: 55, scope: !1944)
!2043 = !DILocation(line: 37, column: 1, scope: !1967)
!2044 = !DILocation(line: 0, scope: !1998, inlinedAt: !2045)
!2045 = distinct !DILocation(line: 35, column: 2, scope: !1967)
!2046 = !DILocation(line: 198, column: 9, scope: !1996, inlinedAt: !2045)
!2047 = !DILocation(line: 198, column: 9, scope: !1997, inlinedAt: !2045)
!2048 = !DILocation(line: 199, column: 14, scope: !1996, inlinedAt: !2045)
!2049 = !DILocation(line: 199, column: 2, scope: !1996, inlinedAt: !2045)
!2050 = !DILocation(line: 37, column: 1, scope: !1939)
!2051 = distinct !DISubprogram(name: "cleanup", linkageName: "_ZN7RRSched7cleanupEN7Element12CleanupStageE", scope: !1890, file: !1, line: 40, type: !1916, scopeLine: 41, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1915, retainedNodes: !2052)
!2052 = !{!2053, !2054}
!2053 = !DILocalVariable(name: "this", arg: 1, scope: !2051, type: !1923, flags: DIFlagArtificial | DIFlagObjectPointer)
!2054 = !DILocalVariable(arg: 2, scope: !2051, file: !1, line: 40, type: !3)
!2055 = !DILocation(line: 0, scope: !2051)
!2056 = !DILocation(line: 42, column: 14, scope: !2051)
!2057 = !DILocation(line: 42, column: 5, scope: !2051)
!2058 = !DILocation(line: 198, column: 9, scope: !1997, inlinedAt: !2059)
!2059 = distinct !DILocation(line: 42, column: 5, scope: !2051)
!2060 = !DILocation(line: 0, scope: !1998, inlinedAt: !2059)
!2061 = !DILocation(line: 198, column: 9, scope: !1996, inlinedAt: !2059)
!2062 = !DILocation(line: 199, column: 14, scope: !1996, inlinedAt: !2059)
!2063 = !DILocation(line: 199, column: 2, scope: !1996, inlinedAt: !2059)
!2064 = !DILocation(line: 43, column: 1, scope: !2051)
!2065 = distinct !DISubprogram(name: "pull", linkageName: "_ZN7RRSched4pullEi", scope: !1890, file: !1, line: 46, type: !1919, scopeLine: 47, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1918, retainedNodes: !2066)
!2066 = !{!2067, !2068, !2069, !2070, !2071, !2073}
!2067 = !DILocalVariable(name: "this", arg: 1, scope: !2065, type: !1923, flags: DIFlagArtificial | DIFlagObjectPointer)
!2068 = !DILocalVariable(arg: 2, scope: !2065, file: !1, line: 46, type: !46)
!2069 = !DILocalVariable(name: "n", scope: !2065, file: !1, line: 48, type: !46)
!2070 = !DILocalVariable(name: "i", scope: !2065, file: !1, line: 49, type: !46)
!2071 = !DILocalVariable(name: "j", scope: !2072, file: !1, line: 50, type: !46)
!2072 = distinct !DILexicalBlock(scope: !2065, file: !1, line: 50, column: 5)
!2073 = !DILocalVariable(name: "p", scope: !2074, file: !1, line: 51, type: !90)
!2074 = distinct !DILexicalBlock(scope: !2075, file: !1, line: 50, column: 33)
!2075 = distinct !DILexicalBlock(scope: !2072, file: !1, line: 50, column: 5)
!2076 = !DILocation(line: 0, scope: !2065)
!2077 = !DILocation(line: 48, column: 13, scope: !2065)
!2078 = !DILocation(line: 0, scope: !1949, inlinedAt: !2079)
!2079 = distinct !DILocation(line: 48, column: 13, scope: !2065)
!2080 = !DILocation(line: 419, column: 12, scope: !1949, inlinedAt: !2079)
!2081 = !DILocation(line: 49, column: 13, scope: !2065)
!2082 = !DILocation(line: 0, scope: !2072)
!2083 = !DILocation(line: 50, column: 23, scope: !2075)
!2084 = !DILocation(line: 50, column: 5, scope: !2072)
!2085 = !DILocation(line: 0, scope: !2074)
!2086 = !DILocation(line: 51, column: 15, scope: !2074)
!2087 = !DILocalVariable(name: "this", arg: 1, scope: !2088, type: !2090, flags: DIFlagArtificial | DIFlagObjectPointer)
!2088 = distinct !DISubprogram(name: "operator bool (NotifierSignal::*)() const", linkageName: "_ZNK14NotifierSignalcvMS_KFbvEEv", scope: !1176, file: !1175, line: 249, type: !1215, scopeLine: 249, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1214, retainedNodes: !2089)
!2089 = !{!2087}
!2090 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1202, size: 64)
!2091 = !DILocation(line: 0, scope: !2088, inlinedAt: !2092)
!2092 = distinct !DILocation(line: 51, column: 15, scope: !2074)
!2093 = !DILocalVariable(name: "this", arg: 1, scope: !2094, type: !2090, flags: DIFlagArtificial | DIFlagObjectPointer)
!2094 = distinct !DISubprogram(name: "active", linkageName: "_ZNK14NotifierSignal6activeEv", scope: !1176, file: !1175, line: 234, type: !1211, scopeLine: 234, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1210, retainedNodes: !2095)
!2095 = !{!2093, !2096}
!2096 = !DILocalVariable(name: "vm", scope: !2097, file: !1175, line: 241, type: !1184)
!2097 = distinct !DILexicalBlock(scope: !2098, file: !1175, line: 241, column: 2)
!2098 = distinct !DILexicalBlock(scope: !2099, file: !1175, line: 240, column: 10)
!2099 = distinct !DILexicalBlock(scope: !2094, file: !1175, line: 238, column: 9)
!2100 = !DILocation(line: 0, scope: !2094, inlinedAt: !2101)
!2101 = distinct !DILocation(line: 250, column: 12, scope: !2088, inlinedAt: !2092)
!2102 = !DILocation(line: 22, column: 5, scope: !2103, inlinedAt: !2105)
!2103 = distinct !DISubprogram(name: "click_compiler_fence", linkageName: "_Z20click_compiler_fencev", scope: !2104, file: !2104, line: 20, type: !248, scopeLine: 21, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !464)
!2104 = !DIFile(filename: "../dummy_inc/click/machine.hh", directory: "/home/john/projects/click/ir-dir")
!2105 = distinct !DILocation(line: 52, column: 5, scope: !2106, inlinedAt: !2107)
!2106 = distinct !DISubprogram(name: "click_fence", linkageName: "_Z11click_fencev", scope: !2104, file: !2104, line: 42, type: !248, scopeLine: 43, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !464)
!2107 = distinct !DILocation(line: 237, column: 5, scope: !2094, inlinedAt: !2101)
!2108 = !{i32 1824186}
!2109 = !DILocation(line: 238, column: 9, scope: !2099, inlinedAt: !2101)
!2110 = !DILocation(line: 238, column: 9, scope: !2094, inlinedAt: !2101)
!2111 = !DILocation(line: 241, column: 23, scope: !2097, inlinedAt: !2101)
!2112 = !DILocation(line: 0, scope: !2097, inlinedAt: !2101)
!2113 = !DILocation(line: 241, column: 31, scope: !2114, inlinedAt: !2101)
!2114 = distinct !DILexicalBlock(scope: !2097, file: !1175, line: 241, column: 2)
!2115 = !{!2116, !1933, i64 8}
!2116 = !{!"_ZTSN14NotifierSignal6vmpairE", !1935, i64 0, !1933, i64 8}
!2117 = !DILocation(line: 241, column: 27, scope: !2114, inlinedAt: !2101)
!2118 = !DILocation(line: 241, column: 2, scope: !2097, inlinedAt: !2101)
!2119 = !DILocation(line: 241, column: 37, scope: !2114, inlinedAt: !2101)
!2120 = distinct !{!2120, !2118, !2121}
!2121 = !DILocation(line: 243, column: 10, scope: !2097, inlinedAt: !2101)
!2122 = !DILocation(line: 242, column: 16, scope: !2123, inlinedAt: !2101)
!2123 = distinct !DILexicalBlock(scope: !2114, file: !1175, line: 242, column: 10)
!2124 = !{!2116, !1935, i64 0}
!2125 = !DILocalVariable(name: "this", arg: 1, scope: !2126, type: !2128, flags: DIFlagArtificial | DIFlagObjectPointer)
!2126 = distinct !DISubprogram(name: "operator unsigned int", linkageName: "_ZNK15atomic_uint32_tcvjEv", scope: !21, file: !22, line: 109, type: !30, scopeLine: 110, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !34, retainedNodes: !2127)
!2127 = !{!2125}
!2128 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !33, size: 64)
!2129 = !DILocation(line: 0, scope: !2126, inlinedAt: !2130)
!2130 = distinct !DILocation(line: 242, column: 11, scope: !2123, inlinedAt: !2101)
!2131 = !DILocalVariable(name: "this", arg: 1, scope: !2132, type: !2128, flags: DIFlagArtificial | DIFlagObjectPointer)
!2132 = distinct !DISubprogram(name: "value", linkageName: "_ZNK15atomic_uint32_t5valueEv", scope: !21, file: !22, line: 98, type: !30, scopeLine: 99, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !29, retainedNodes: !2133)
!2133 = !{!2131}
!2134 = !DILocation(line: 0, scope: !2132, inlinedAt: !2135)
!2135 = distinct !DILocation(line: 111, column: 12, scope: !2126, inlinedAt: !2130)
!2136 = !DILocation(line: 103, column: 12, scope: !2132, inlinedAt: !2135)
!2137 = !{!2138, !1933, i64 0}
!2138 = !{!"_ZTS15atomic_uint32_t", !1933, i64 0}
!2139 = !DILocation(line: 242, column: 22, scope: !2123, inlinedAt: !2101)
!2140 = !DILocation(line: 242, column: 34, scope: !2123, inlinedAt: !2101)
!2141 = !DILocation(line: 242, column: 10, scope: !2114, inlinedAt: !2101)
!2142 = !DILocation(line: 239, column: 14, scope: !2099, inlinedAt: !2101)
!2143 = !DILocation(line: 0, scope: !2126, inlinedAt: !2144)
!2144 = distinct !DILocation(line: 239, column: 10, scope: !2099, inlinedAt: !2101)
!2145 = !DILocation(line: 0, scope: !2132, inlinedAt: !2146)
!2146 = distinct !DILocation(line: 111, column: 12, scope: !2126, inlinedAt: !2144)
!2147 = !DILocation(line: 103, column: 12, scope: !2132, inlinedAt: !2146)
!2148 = !DILocation(line: 239, column: 17, scope: !2099, inlinedAt: !2101)
!2149 = !DILocation(line: 239, column: 26, scope: !2099, inlinedAt: !2101)
!2150 = !DILocation(line: 250, column: 12, scope: !2088, inlinedAt: !2092)
!2151 = !DILocation(line: 52, column: 3, scope: !2074)
!2152 = !DILocation(line: 53, column: 8, scope: !2153)
!2153 = distinct !DILexicalBlock(scope: !2074, file: !1, line: 53, column: 6)
!2154 = !DILocation(line: 53, column: 6, scope: !2074)
!2155 = !DILocation(line: 55, column: 6, scope: !2074)
!2156 = !DILocation(line: 51, column: 29, scope: !2074)
!2157 = !DILocalVariable(name: "this", arg: 1, scope: !2158, type: !2192, flags: DIFlagArtificial | DIFlagObjectPointer)
!2158 = distinct !DISubprogram(name: "pull", linkageName: "_ZNK7Element4Port4pullEv", scope: !2159, file: !4, line: 655, type: !2178, scopeLine: 656, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !2177, retainedNodes: !2190)
!2159 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "Port", scope: !5, file: !4, line: 214, size: 128, flags: DIFlagTypePassByValue | DIFlagNonTrivial, elements: !2160, identifier: "_ZTSN7Element4PortE")
!2160 = !{!2161, !2162, !2163, !2168, !2171, !2174, !2177, !2180, !2184, !2187}
!2161 = !DIDerivedType(tag: DW_TAG_member, name: "_e", scope: !2159, file: !4, line: 231, baseType: !2007, size: 64)
!2162 = !DIDerivedType(tag: DW_TAG_member, name: "_port", scope: !2159, file: !4, line: 232, baseType: !46, size: 32, offset: 64)
!2163 = !DISubprogram(name: "active", linkageName: "_ZNK7Element4Port6activeEv", scope: !2159, file: !4, line: 216, type: !2164, scopeLine: 216, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!2164 = !DISubroutineType(types: !2165)
!2165 = !{!65, !2166}
!2166 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2167, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!2167 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !2159)
!2168 = !DISubprogram(name: "element", linkageName: "_ZNK7Element4Port7elementEv", scope: !2159, file: !4, line: 217, type: !2169, scopeLine: 217, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!2169 = !DISubroutineType(types: !2170)
!2170 = !{!2007, !2166}
!2171 = !DISubprogram(name: "port", linkageName: "_ZNK7Element4Port4portEv", scope: !2159, file: !4, line: 218, type: !2172, scopeLine: 218, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!2172 = !DISubroutineType(types: !2173)
!2173 = !{!46, !2166}
!2174 = !DISubprogram(name: "push", linkageName: "_ZNK7Element4Port4pushEP6Packet", scope: !2159, file: !4, line: 220, type: !2175, scopeLine: 220, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!2175 = !DISubroutineType(types: !2176)
!2176 = !{null, !2166, !90}
!2177 = !DISubprogram(name: "pull", linkageName: "_ZNK7Element4Port4pullEv", scope: !2159, file: !4, line: 221, type: !2178, scopeLine: 221, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!2178 = !DISubroutineType(types: !2179)
!2179 = !{!90, !2166}
!2180 = !DISubprogram(name: "assign", linkageName: "_ZN7Element4Port6assignEbPS_i", scope: !2159, file: !4, line: 227, type: !2181, scopeLine: 227, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!2181 = !DISubroutineType(types: !2182)
!2182 = !{null, !2183, !65, !2007, !46}
!2183 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2159, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!2184 = !DISubprogram(name: "Port", scope: !2159, file: !4, line: 247, type: !2185, scopeLine: 247, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized)
!2185 = !DISubroutineType(types: !2186)
!2186 = !{null, !2183}
!2187 = !DISubprogram(name: "assign", linkageName: "_ZN7Element4Port6assignEbPS_S1_i", scope: !2159, file: !4, line: 248, type: !2188, scopeLine: 248, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized)
!2188 = !DISubroutineType(types: !2189)
!2189 = !{null, !2183, !65, !2007, !2007, !46}
!2190 = !{!2157, !2191}
!2191 = !DILocalVariable(name: "p", scope: !2158, file: !4, line: 677, type: !90)
!2192 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !2167, size: 64)
!2193 = !DILocation(line: 0, scope: !2158, inlinedAt: !2194)
!2194 = distinct !DILocation(line: 51, column: 38, scope: !2074)
!2195 = !DILocation(line: 657, column: 5, scope: !2158, inlinedAt: !2194)
!2196 = !{!2197, !1935, i64 0}
!2197 = !{!"_ZTSN7Element4PortE", !1935, i64 0, !1933, i64 8}
!2198 = !DILocation(line: 677, column: 26, scope: !2158, inlinedAt: !2194)
!2199 = !{!2197, !1933, i64 8}
!2200 = !DILocation(line: 677, column: 21, scope: !2158, inlinedAt: !2194)
!2201 = !DILocation(line: 55, column: 6, scope: !2202)
!2202 = distinct !DILexicalBlock(scope: !2074, file: !1, line: 55, column: 6)
!2203 = !DILocation(line: 50, column: 29, scope: !2075)
!2204 = distinct !{!2204, !2084, !2205}
!2205 = !DILocation(line: 59, column: 5, scope: !2072)
!2206 = !DILocation(line: 56, column: 12, scope: !2207)
!2207 = distinct !DILexicalBlock(scope: !2202, file: !1, line: 55, column: 9)
!2208 = !DILocation(line: 61, column: 1, scope: !2065)
!2209 = distinct !DISubprogram(name: "input", linkageName: "_ZNK7Element5inputEi", scope: !5, file: !4, line: 448, type: !2210, scopeLine: 449, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !2213, retainedNodes: !2214)
!2210 = !DISubroutineType(types: !2211)
!2211 = !{!2212, !1952, !46}
!2212 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !2167, size: 64)
!2213 = !DISubprogram(name: "input", linkageName: "_ZNK7Element5inputEi", scope: !5, file: !4, line: 136, type: !2210, scopeLine: 136, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!2214 = !{!2215, !2216}
!2215 = !DILocalVariable(name: "this", arg: 1, scope: !2209, type: !1956, flags: DIFlagArtificial | DIFlagObjectPointer)
!2216 = !DILocalVariable(name: "port", arg: 2, scope: !2209, file: !4, line: 448, type: !46)
!2217 = !{!1935, !1935, i64 0}
!2218 = !DILocation(line: 0, scope: !2209)
!2219 = !DILocation(line: 448, column: 20, scope: !2209)
!2220 = !DILocation(line: 450, column: 33, scope: !2209)
!2221 = !DILocation(line: 450, column: 21, scope: !2209)
!2222 = !DILocation(line: 450, column: 5, scope: !2209)
!2223 = distinct !DISubprogram(name: "~RRSched", linkageName: "_ZN7RRSchedD0Ev", scope: !1890, file: !1891, line: 28, type: !1898, scopeLine: 28, flags: DIFlagArtificial | DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !2224, retainedNodes: !2225)
!2224 = !DISubprogram(name: "~RRSched", scope: !1890, type: !1898, containingType: !1890, virtualIndex: 0, flags: DIFlagPublic | DIFlagArtificial | DIFlagPrototyped, spFlags: DISPFlagVirtual | DISPFlagOptimized)
!2225 = !{!2226}
!2226 = !DILocalVariable(name: "this", arg: 1, scope: !2223, type: !1923, flags: DIFlagArtificial | DIFlagObjectPointer)
!2227 = !DILocation(line: 0, scope: !2223)
!2228 = !DILocation(line: 28, column: 7, scope: !2223)
!2229 = distinct !DISubprogram(name: "class_name", linkageName: "_ZNK7RRSched10class_nameEv", scope: !1890, file: !1891, line: 32, type: !1902, scopeLine: 32, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1901, retainedNodes: !2230)
!2230 = !{!2231}
!2231 = !DILocalVariable(name: "this", arg: 1, scope: !2229, type: !2232, flags: DIFlagArtificial | DIFlagObjectPointer)
!2232 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1905, size: 64)
!2233 = !DILocation(line: 0, scope: !2229)
!2234 = !DILocation(line: 32, column: 38, scope: !2229)
!2235 = distinct !DISubprogram(name: "port_count", linkageName: "_ZNK7RRSched10port_countEv", scope: !1890, file: !1891, line: 33, type: !1902, scopeLine: 33, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1906, retainedNodes: !2236)
!2236 = !{!2237}
!2237 = !DILocalVariable(name: "this", arg: 1, scope: !2235, type: !2232, flags: DIFlagArtificial | DIFlagObjectPointer)
!2238 = !DILocation(line: 0, scope: !2235)
!2239 = !DILocation(line: 33, column: 38, scope: !2235)
!2240 = distinct !DISubprogram(name: "processing", linkageName: "_ZNK7RRSched10processingEv", scope: !1890, file: !1891, line: 34, type: !1902, scopeLine: 34, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1907, retainedNodes: !2241)
!2241 = !{!2242}
!2242 = !DILocalVariable(name: "this", arg: 1, scope: !2240, type: !2232, flags: DIFlagArtificial | DIFlagObjectPointer)
!2243 = !DILocation(line: 0, scope: !2240)
!2244 = !DILocation(line: 34, column: 38, scope: !2240)
!2245 = distinct !DISubprogram(name: "flags", linkageName: "_ZNK7RRSched5flagsEv", scope: !1890, file: !1891, line: 35, type: !1902, scopeLine: 35, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1908, retainedNodes: !2246)
!2246 = !{!2247}
!2247 = !DILocalVariable(name: "this", arg: 1, scope: !2245, type: !2232, flags: DIFlagArtificial | DIFlagObjectPointer)
!2248 = !DILocation(line: 0, scope: !2245)
!2249 = !DILocation(line: 35, column: 34, scope: !2245)
!2250 = !DILocation(line: 0, scope: !2094)
!2251 = !DILocation(line: 22, column: 5, scope: !2103, inlinedAt: !2252)
!2252 = distinct !DILocation(line: 52, column: 5, scope: !2106, inlinedAt: !2253)
!2253 = distinct !DILocation(line: 237, column: 5, scope: !2094)
!2254 = !DILocation(line: 238, column: 9, scope: !2099)
!2255 = !DILocation(line: 238, column: 9, scope: !2094)
!2256 = !DILocation(line: 239, column: 14, scope: !2099)
!2257 = !DILocation(line: 0, scope: !2126, inlinedAt: !2258)
!2258 = distinct !DILocation(line: 239, column: 10, scope: !2099)
!2259 = !DILocation(line: 0, scope: !2132, inlinedAt: !2260)
!2260 = distinct !DILocation(line: 111, column: 12, scope: !2126, inlinedAt: !2258)
!2261 = !DILocation(line: 103, column: 12, scope: !2132, inlinedAt: !2260)
!2262 = !DILocation(line: 239, column: 17, scope: !2099)
!2263 = !DILocation(line: 239, column: 26, scope: !2099)
!2264 = !DILocation(line: 246, column: 1, scope: !2094)
!2265 = !DILocation(line: 241, column: 23, scope: !2097)
!2266 = !DILocation(line: 0, scope: !2097)
!2267 = !DILocation(line: 241, column: 31, scope: !2114)
!2268 = !DILocation(line: 241, column: 27, scope: !2114)
!2269 = !DILocation(line: 241, column: 2, scope: !2097)
!2270 = !DILocation(line: 241, column: 37, scope: !2114)
!2271 = distinct !{!2271, !2269, !2272}
!2272 = !DILocation(line: 243, column: 10, scope: !2097)
!2273 = !DILocation(line: 242, column: 16, scope: !2123)
!2274 = !DILocation(line: 0, scope: !2126, inlinedAt: !2275)
!2275 = distinct !DILocation(line: 242, column: 11, scope: !2123)
!2276 = !DILocation(line: 0, scope: !2132, inlinedAt: !2277)
!2277 = distinct !DILocation(line: 111, column: 12, scope: !2126, inlinedAt: !2275)
!2278 = !DILocation(line: 103, column: 12, scope: !2132, inlinedAt: !2277)
!2279 = !DILocation(line: 242, column: 22, scope: !2123)
!2280 = !DILocation(line: 242, column: 34, scope: !2123)
!2281 = !DILocation(line: 242, column: 10, scope: !2114)
!2282 = distinct !DISubprogram(name: "port", linkageName: "_ZNK7Element4portEbi", scope: !5, file: !4, line: 435, type: !2283, scopeLine: 436, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !2285, retainedNodes: !2286)
!2283 = !DISubroutineType(types: !2284)
!2284 = !{!2212, !1952, !65, !46}
!2285 = !DISubprogram(name: "port", linkageName: "_ZNK7Element4portEbi", scope: !5, file: !4, line: 135, type: !2283, scopeLine: 135, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!2286 = !{!2287, !2288, !2289}
!2287 = !DILocalVariable(name: "this", arg: 1, scope: !2282, type: !1956, flags: DIFlagArtificial | DIFlagObjectPointer)
!2288 = !DILocalVariable(name: "isoutput", arg: 2, scope: !2282, file: !4, line: 435, type: !65)
!2289 = !DILocalVariable(name: "port", arg: 3, scope: !2282, file: !4, line: 435, type: !46)
!2290 = !DILocation(line: 0, scope: !2282)
!2291 = !{!2292, !2292, i64 0}
!2292 = !{!"bool", !1934, i64 0}
!2293 = !DILocation(line: 435, column: 20, scope: !2282)
!2294 = !DILocation(line: 435, column: 34, scope: !2282)
!2295 = !DILocation(line: 437, column: 5, scope: !2282)
!2296 = !{i8 0, i8 2}
!2297 = !DILocation(line: 438, column: 12, scope: !2282)
!2298 = !DILocation(line: 438, column: 19, scope: !2282)
!2299 = !DILocation(line: 438, column: 29, scope: !2282)
!2300 = !DILocation(line: 438, column: 5, scope: !2282)
