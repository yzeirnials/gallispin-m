; ModuleID = 'my_ele/Null/MyNullElement.cc'
source_filename = "my_ele/Null/MyNullElement.cc"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

%class.MyNullElement = type { %class.Element.base, [4 x i8] }
...
$_ZN13MyNullElementD0Ev = comdat any

$_ZNK7Element4portEbi = comdat any

@.str = private unnamed_addr constant [14 x i8] c"MyNullElement\00", align 1
@_ZN7Element9PORTS_1_1E = external dso_local constant [0 x i8], align 1
@_ZN7Element4PUSHE = external dso_local constant [0 x i8], align 1
@_ZTV13MyNullElement = dso_local unnamed_addr constant { [29 x i8*] } { [29 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTI13MyNullElement to i8*), i8* bitcast (void (%class.Element*)* @_ZN7ElementD2Ev to i8*), i8* bitcast (void (%class.MyNullElement*)* @_ZN13MyNullElementD0Ev to i8*), i8* bitcast (void (%class.MyNullElement*, i32, %class.Packet*)* @_ZN13MyNullElement4pushEiP6Packet to i8*), i8* bitcast (%class.Packet* (%class.Element*, i32)* @_ZN7Element4pullEi to i8*), i8* bitcast (%class.Packet* (%class.Element*, %class.Packet*)* @_ZN7Element13simple_actionEP6Packet to i8*), i8* bitcast (i1 (%class.Element*, %class.Task*)* @_ZN7Element8run_taskEP4Task to i8*), i8* bitcast (void (%class.Element*, %class.Timer*)* @_ZN7Element9run_timerEP5Timer to i8*), i8* bitcast (void (%class.Element*, i32, i32)* @_ZN7Element8selectedEii to i8*), i8* bitcast (void (%class.Element*, i32)* @_ZN7Element8selectedEi to i8*), i8* bitcast (i8* (%class.MyNullElement*)* @_ZNK13MyNullElement10class_nameEv to i8*), i8* bitcast (i8* (%class.MyNullElement*)* @_ZNK13MyNullElement10port_countEv to i8*), i8* bitcast (i8* (%class.MyNullElement*)* @_ZNK13MyNullElement10processingEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element9flow_codeEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element5flagsEv to i8*), i8* bitcast (i8* (%class.Element*, i8*)* @_ZN7Element4castEPKc to i8*), i8* bitcast (i8* (%class.Element*, i1, i32, i8*)* @_ZN7Element9port_castEbiPKc to i8*), i8* bitcast (i32 (%class.Element*)* @_ZNK7Element15configure_phaseEv to i8*), i8* bitcast (i32 (%class.Element*, %class.Vector*, %class.ErrorHandler*)* @_ZN7Element9configureER6VectorI6StringEP12ErrorHandler to i8*), i8* bitcast (void (%class.Element*)* @_ZN7Element12add_handlersEv to i8*), i8* bitcast (i32 (%class.Element*, %class.ErrorHandler*)* @_ZN7Element10initializeEP12ErrorHandler to i8*), i8* bitcast (void (%class.Element*, %class.Element*, %class.ErrorHandler*)* @_ZN7Element10take_stateEPS_P12ErrorHandler to i8*), i8* bitcast (%class.Element* (%class.Element*)* @_ZNK7Element15hotswap_elementEv to i8*), i8* bitcast (void (%class.Element*, i32)* @_ZN7Element7cleanupENS_12CleanupStageE to i8*), i8* bitcast (void (%class.String*, %class.Element*)* @_ZNK7Element11declarationEv to i8*), i8* bitcast (i1 (%class.Element*)* @_ZNK7Element20can_live_reconfigureEv to i8*), i8* bitcast (i32 (%class.Element*, %class.Vector*, %class.ErrorHandler*)* @_ZN7Element16live_reconfigureER6VectorI6StringEP12ErrorHandler to i8*), i8* bitcast (i32 (%class.Element*, i32, i8*)* @_ZN7Element5llrpcEjPv to i8*)] }, align 8
@_ZTVN10__cxxabiv120__si_class_type_infoE = external dso_local global i8*
@_ZTS13MyNullElement = dso_local constant [16 x i8] c"13MyNullElement\00", align 1
@_ZTI7Element = external dso_local constant i8*
@_ZTI13MyNullElement = dso_local constant { i8*, i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @_ZTS13MyNullElement, i32 0, i32 0), i8* bitcast (i8** @_ZTI7Element to i8*) }, align 8
...
define dso_local i8* @_ZNK13MyNullElement10class_nameEv(%class.MyNullElement* nocapture readnone %0) unnamed_addr #0 align 2 !dbg !1167 {
  call void @llvm.dbg.value(metadata %class.MyNullElement* undef, metadata !1190, metadata !DIExpression()), !dbg !1192
  ret i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i64 0, i64 0), !dbg !1193
}
...
; Function Attrs: norecurse nounwind readnone uwtable
define dso_local i8* @_ZNK13MyNullElement10port_countEv(%class.MyNullElement* nocapture readnone %0) unnamed_addr #0 align 2 !dbg !1194 {
  call void @llvm.dbg.value(metadata %class.MyNullElement* undef, metadata !1196, metadata !DIExpression()), !dbg !1197
  ret i8* getelementptr inbounds ([0 x i8], [0 x i8]* @_ZN7Element9PORTS_1_1E, i64 0, i64 0), !dbg !1198
}

; Function Attrs: norecurse nounwind readnone uwtable
define dso_local i8* @_ZNK13MyNullElement10processingEv(%class.MyNullElement* nocapture readnone %0) unnamed_addr #0 align 2 !dbg !1199 {
  call void @llvm.dbg.value(metadata %class.MyNullElement* undef, metadata !1201, metadata !DIExpression()), !dbg !1202
  ret i8* getelementptr inbounds ([0 x i8], [0 x i8]* @_ZN7Element4PUSHE, i64 0, i64 0), !dbg !1203
}

; Function Attrs: uwtable
define dso_local void @_ZN13MyNullElement4pushEiP6Packet(%class.MyNullElement* %0, i32 %1, %class.Packet* %2) unnamed_addr #2 align 2 !dbg !1204 {
  call void @llvm.dbg.value(metadata %class.MyNullElement* %0, metadata !1206, metadata !DIExpression()), !dbg !1210
  call void @llvm.dbg.value(metadata i32 undef, metadata !1208, metadata !DIExpression()), !dbg !1210
  call void @llvm.dbg.value(metadata %class.Packet* %2, metadata !1209, metadata !DIExpression()), !dbg !1210
  %4 = bitcast %class.MyNullElement* %0 to %class.Element*, !dbg !1211
  %5 = tail call nonnull align 8 dereferenceable(12) %"class.Element::Port"* @_ZNK7Element6outputEi(%class.Element* %4, i32 0), !dbg !1211
  tail call void @_ZNK7Element4Port4pushEP6Packet(%"class.Element::Port"* nonnull %5, %class.Packet* %2), !dbg !1212
  ret void, !dbg !1213
}

; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(12) %"class.Element::Port"* @_ZNK7Element6outputEi(%class.Element* %0, i32 %1) local_unnamed_addr #3 comdat align 2 !dbg !1214 {
  %3 = alloca %class.Element*, align 8
  %4 = alloca i32, align 4
  store %class.Element* %0, %class.Element** %3, align 8, !tbaa !1257
  call void @llvm.dbg.declare(metadata %class.Element** %3, metadata !1254, metadata !DIExpression()), !dbg !1261
  store i32 %1, i32* %4, align 4, !tbaa !1262
  call void @llvm.dbg.declare(metadata i32* %4, metadata !1256, metadata !DIExpression()), !dbg !1264
  %5 = load %class.Element*, %class.Element** %3, align 8
  %6 = load i32, i32* %4, align 4, !dbg !1265, !tbaa !1262
  %7 = call nonnull align 8 dereferenceable(12) %"class.Element::Port"* @_ZNK7Element4portEbi(%class.Element* %5, i1 zeroext true, i32 %6), !dbg !1266
  ret %"class.Element::Port"* %7, !dbg !1267
}

; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @_ZNK7Element4Port4pushEP6Packet(%"class.Element::Port"* %0, %class.Packet* %1) local_unnamed_addr #3 comdat align 2 !dbg !1268 {
  %3 = alloca %"class.Element::Port"*, align 8
  %4 = alloca %class.Packet*, align 8
  store %"class.Element::Port"* %0, %"class.Element::Port"** %3, align 8, !tbaa !1257
  call void @llvm.dbg.declare(metadata %"class.Element::Port"** %3, metadata !1270, metadata !DIExpression()), !dbg !1273
  store %class.Packet* %1, %class.Packet** %4, align 8, !tbaa !1257
  call void @llvm.dbg.declare(metadata %class.Packet** %4, metadata !1272, metadata !DIExpression()), !dbg !1274
  %5 = load %"class.Element::Port"*, %"class.Element::Port"** %3, align 8
  %6 = getelementptr inbounds %"class.Element::Port", %"class.Element::Port"* %5, i32 0, i32 0, !dbg !1275
  %7 = load %class.Element*, %class.Element** %6, align 8, !dbg !1275, !tbaa !1276
  %8 = icmp ne %class.Element* %7, null, !dbg !1275
  br i1 %8, label %9, label %12, !dbg !1275

9:                                                ; preds = %2
  %10 = load %class.Packet*, %class.Packet** %4, align 8, !dbg !1275, !tbaa !1257
  %11 = icmp ne %class.Packet* %10, null, !dbg !1275
  br label %12

12:                                               ; preds = %9, %2
  %13 = phi i1 [ false, %2 ], [ %11, %9 ], !dbg !1273
...
15:                                               ; preds = %12
  call void @__assert_fail(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.3, i64 0, i64 0), i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.2, i64 0, i64 0), i32 611, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @__PRETTY_FUNCTION__._ZNK7Element4Port4pushEP6Packet, i64 0, i64 0)) #10, !dbg !1275
  unreachable, !dbg !1275

16:                                               ; preds = %14
  %17 = getelementptr inbounds %"class.Element::Port", %"class.Element::Port"* %5, i32 0, i32 0, !dbg !1278
  %18 = load %class.Element*, %class.Element** %17, align 8, !dbg !1278, !tbaa !1276
  %19 = getelementptr inbounds %"class.Element::Port", %"class.Element::Port"* %5, i32 0, i32 1, !dbg !1279
  %20 = load i32, i32* %19, align 8, !dbg !1279, !tbaa !1280
  %21 = load %class.Packet*, %class.Packet** %4, align 8, !dbg !1281, !tbaa !1257
  %22 = bitcast %class.Element* %18 to void (%class.Element*, i32, %class.Packet*)***, !dbg !1282
  %23 = load void (%class.Element*, i32, %class.Packet*)**, void (%class.Element*, i32, %class.Packet*)*** %22, align 8, !dbg !1282, !tbaa !1283
  %24 = getelementptr inbounds void (%class.Element*, i32, %class.Packet*)*, void (%class.Element*, i32, %class.Packet*)** %23, i64 2, !dbg !1282
  %25 = load void (%class.Element*, i32, %class.Packet*)*, void (%class.Element*, i32, %class.Packet*)** %24, align 8, !dbg !1282
  call void %25(%class.Element* %18, i32 %20, %class.Packet* %21), !dbg !1282
  ret void, !dbg !1285
}

; Function Attrs: nounwind
declare dso_local void @_ZN7ElementD2Ev(%class.Element*) unnamed_addr #4

; Function Attrs: nounwind uwtable
define linkonce_odr dso_local void @_ZN13MyNullElementD0Ev(%class.MyNullElement* %0) unnamed_addr #5 comdat align 2 !dbg !1286 {
  call void @llvm.dbg.value(metadata %class.MyNullElement* %0, metadata !1288, metadata !DIExpression()), !dbg !1289
  %2 = bitcast %class.MyNullElement* %0 to %class.Element*, !dbg !1290
  tail call void @_ZN7ElementD2Ev(%class.Element* %2) #11, !dbg !1290
  %3 = bitcast %class.MyNullElement* %0 to i8*, !dbg !1290
  tail call void @_ZdlPv(i8* %3) #12, !dbg !1290
  ret void, !dbg !1291
}

declare dso_local %class.Packet* @_ZN7Element4pullEi(%class.Element*, i32) unnamed_addr #6

declare dso_local %class.Packet* @_ZN7Element13simple_actionEP6Packet(%class.Element*, %class.Packet*) unnamed_addr #6

declare dso_local zeroext i1 @_ZN7Element8run_taskEP4Task(%class.Element*, %class.Task*) unnamed_addr #6

declare dso_local void @_ZN7Element9run_timerEP5Timer(%class.Element*, %class.Timer*) unnamed_addr #6

declare dso_local void @_ZN7Element8selectedEii(%class.Element*, i32, i32) unnamed_addr #6

declare dso_local void @_ZN7Element8selectedEi(%class.Element*, i32) unnamed_addr #6

declare dso_local i8* @_ZNK7Element9flow_codeEv(%class.Element*) unnamed_addr #6

declare dso_local i8* @_ZNK7Element5flagsEv(%class.Element*) unnamed_addr #6

declare dso_local i8* @_ZN7Element4castEPKc(%class.Element*, i8*) unnamed_addr #6

declare dso_local i8* @_ZN7Element9port_castEbiPKc(%class.Element*, i1 zeroext, i32, i8*) unnamed_addr #6

declare dso_local i32 @_ZNK7Element15configure_phaseEv(%class.Element*) unnamed_addr #6

declare dso_local i32 @_ZN7Element9configureER6VectorI6StringEP12ErrorHandler(%class.Element*, %class.Vector* nonnull align 1, %class.ErrorHandler*) unnamed_addr #6

declare dso_local void @_ZN7Element12add_handlersEv(%class.Element*) unnamed_addr #6

declare dso_local i32 @_ZN7Element10initializeEP12ErrorHandler(%class.Element*, %class.ErrorHandler*) unnamed_addr #6

declare dso_local void @_ZN7Element10take_stateEPS_P12ErrorHandler(%class.Element*, %class.Element*, %class.ErrorHandler*) unnamed_addr #6

declare dso_local %class.Element* @_ZNK7Element15hotswap_elementEv(%class.Element*) unnamed_addr #6

declare dso_local void @_ZN7Element7cleanupENS_12CleanupStageE(%class.Element*, i32) unnamed_addr #6

declare dso_local void @_ZNK7Element11declarationEv(%class.String* sret align 8, %class.Element*) unnamed_addr #6

declare dso_local zeroext i1 @_ZNK7Element20can_live_reconfigureEv(%class.Element*) unnamed_addr #6

declare dso_local i32 @_ZN7Element16live_reconfigureER6VectorI6StringEP12ErrorHandler(%class.Element*, %class.Vector* nonnull align 1, %class.ErrorHandler*) unnamed_addr #6

declare dso_local i32 @_ZN7Element5llrpcEjPv(%class.Element*, i32, i8*) unnamed_addr #6

; Function Attrs: noinline nounwind optnone uwtable
define linkonce_odr dso_local nonnull align 8 dereferenceable(12) %"class.Element::Port"* @_ZNK7Element4portEbi(%class.Element* %0, i1 zeroext %1, i32 %2) local_unnamed_addr #7 comdat align 2 !dbg !1292 {
  %4 = alloca %class.Element*, align 8
  %5 = alloca i8, align 1
  %6 = alloca i32, align 4
  store %class.Element* %0, %class.Element** %4, align 8, !tbaa !1257
  call void @llvm.dbg.declare(metadata %class.Element** %4, metadata !1297, metadata !DIExpression()), !dbg !1300
  %7 = zext i1 %1 to i8
  store i8 %7, i8* %5, align 1, !tbaa !1301
  call void @llvm.dbg.declare(metadata i8* %5, metadata !1298, metadata !DIExpression()), !dbg !1303
  store i32 %2, i32* %6, align 4, !tbaa !1262
  call void @llvm.dbg.declare(metadata i32* %6, metadata !1299, metadata !DIExpression()), !dbg !1304
  %8 = load %class.Element*, %class.Element** %4, align 8
  %9 = load i32, i32* %6, align 4, !dbg !1305, !tbaa !1262
  %10 = getelementptr inbounds %class.Element, %class.Element* %8, i32 0, i32 3, !dbg !1305
  %11 = load i8, i8* %5, align 1, !dbg !1305, !tbaa !1301, !range !1306
  %12 = trunc i8 %11 to i1, !dbg !1305
  %13 = zext i1 %12 to i64, !dbg !1305
  %14 = getelementptr inbounds [2 x i32], [2 x i32]* %10, i64 0, i64 %13, !dbg !1305
  %15 = load i32, i32* %14, align 4, !dbg !1305, !tbaa !1262
  %16 = icmp ult i32 %9, %15, !dbg !1305
  br i1 %16, label %17, label %18, !dbg !1305

17:                                               ; preds = %3
  br label %19, !dbg !1305

18:                                               ; preds = %3
  call void @__assert_fail(i8* getelementptr inbounds ([47 x i8], [47 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.2, i64 0, i64 0), i32 437, i8* getelementptr inbounds ([52 x i8], [52 x i8]* @__PRETTY_FUNCTION__._ZNK7Element4portEbi, i64 0, i64 0)) #10, !dbg !1305
  unreachable, !dbg !1305

19:                                               ; preds = %17
  %20 = getelementptr inbounds %class.Element, %class.Element* %8, i32 0, i32 1, !dbg !1307
  %21 = load i8, i8* %5, align 1, !dbg !1308, !tbaa !1301, !range !1306
  %22 = trunc i8 %21 to i1, !dbg !1308
  %23 = zext i1 %22 to i64, !dbg !1307
  %24 = getelementptr inbounds [2 x %"class.Element::Port"*], [2 x %"class.Element::Port"*]* %20, i64 0, i64 %23, !dbg !1307
  %25 = load %"class.Element::Port"*, %"class.Element::Port"** %24, align 8, !dbg !1307, !tbaa !1257
  %26 = load i32, i32* %6, align 4, !dbg !1309, !tbaa !1262
  %27 = sext i32 %26 to i64, !dbg !1307
  %28 = getelementptr inbounds %"class.Element::Port", %"class.Element::Port"* %25, i64 %27, !dbg !1307
  ret %"class.Element::Port"* %28, !dbg !1310
}
...
attributes #3 = { noinline optnone uwtable "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "frame-pointer"="none" "less-precise-fpmad"="false" "min-legal-vector-width"="0" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
...
!llvm.dbg.cu = !{!0}
!llvm.module.flags = !{!1163, !1164, !1165}
!llvm.ident = !{!1166}

!0 = distinct !DICompileUnit(language: DW_LANG_C_plus_plus_14, file: !1, producer: "Ubuntu clang version 11.0.0-2~ubuntu20.04.1", isOptimized: true, runtimeVersion: 0, emissionKind: FullDebug, enums: !2, retainedTypes: !1162, splitDebugInlining: false, nameTableKind: None)
!1 = !DIFile(filename: "my_ele/Null/MyNullElement.cc", directory: "/home/chenyz/packages/click/click-llvm-ir-selfmade")
!2 = !{!3, !857}
...
!4 = !DIFile(filename: "../dummy_inc/click/packet.hh", directory: "/home/chenyz/packages/click/click-llvm-ir-selfmade")
...
!9 = !DIFile(filename: "../dummy_inc/click/atomic.hh", directory: "/home/chenyz/packages/click/click-llvm-ir-selfmade")
...
!134 = !DIFile(filename: "/usr/lib/llvm-11/lib/clang/11.0.0/include/stddef.h", directory: "")
...
!157 = !DICompositeType(tag: DW_TAG_structure_type, name: "click_ether", file: !4, line: 24, flags: DIFlagFwdDecl | DIFlagNonTrivial, identifier: "_ZTS11click_ether")
...
!164 = !DIFile(filename: "../dummy_inc/clicknet/ip.h", directory: "/home/chenyz/packages/click/click-llvm-ir-selfmade")
...
!186 = !DICompositeType(tag: DW_TAG_structure_type, name: "click_ip6", file: !4, line: 27, flags: DIFlagFwdDecl | DIFlagNonTrivial, identifier: "_ZTS9click_ip6")
!187 = !DISubprogram(name: "transport_header", linkageName: "_ZNK14WritablePacket16transport_headerEv", scope: !141, file: !4, line: 789, type: !145, scopeLine: 789, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!188 = !DISubprogram(name: "icmp_header", linkageName: "_ZNK14WritablePacket11icmp_headerEv", scope: !141, file: !4, line: 790, type: !189, scopeLine: 790, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!189 = !DISubroutineType(types: !190)
!190 = !{!191, !147}
!191 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !192, size: 64)
!192 = !DICompositeType(tag: DW_TAG_structure_type, name: "click_icmp", file: !4, line: 26, flags: DIFlagFwdDecl | DIFlagNonTrivial, identifier: "_ZTS10click_icmp")
!193 = !DISubprogram(name: "tcp_header", linkageName: "_ZNK14WritablePacket10tcp_headerEv", scope: !141, file: !4, line: 791, type: !194, scopeLine: 791, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!194 = !DISubroutineType(types: !195)
!195 = !{!196, !147}
!196 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !197, size: 64)
!197 = !DICompositeType(tag: DW_TAG_structure_type, name: "click_tcp", file: !4, line: 28, flags: DIFlagFwdDecl | DIFlagNonTrivial, identifier: "_ZTS9click_tcp")
...
!202 = !DICompositeType(tag: DW_TAG_structure_type, name: "click_udp", file: !4, line: 29, flags: DIFlagFwdDecl | DIFlagNonTrivial, identifier: "_ZTS9click_udp")
...
!387 = !DIFile(filename: "../dummy_inc/click/timestamp.hh", directory: "/home/chenyz/packages/click/click-llvm-ir-selfmade")
...
!422 = !DIFile(filename: "/usr/include/x86_64-linux-gnu/bits/types/struct_timeval.h", directory: "")
!423 = !{!424, !426}
...
!434 = !DIFile(filename: "/usr/include/x86_64-linux-gnu/bits/types/struct_timespec.h", directory: "")
!435 = !{!436, !437}
...
!451 = !DIFile(filename: "../dummy_inc/click/config.h", directory: "/home/chenyz/packages/click/click-llvm-ir-selfmade")
!452 = !{}
...
!506 = !DIFile(filename: "../dummy_inc/click/glue.hh", directory: "/home/chenyz/packages/click/click-llvm-ir-selfmade")
...
!555 = !DIFile(filename: "../dummy_inc/click/string.hh", directory: "/home/chenyz/packages/click/click-llvm-ir-selfmade")
...
!910 = !DICompositeType(tag: DW_TAG_structure_type, name: "device", file: !506, line: 326, flags: DIFlagFwdDecl | DIFlagNonTrivial, identifier: "_ZTS6device")
...
!937 = !DIFile(filename: "../dummy_inc/click/ipaddress.hh", directory: "/home/chenyz/packages/click/click-llvm-ir-selfmade")
...
!1166 = !{!"Ubuntu clang version 11.0.0-2~ubuntu20.04.1"}
!1167 = distinct !DISubprogram(name: "class_name", linkageName: "_ZNK13MyNullElement10class_nameEv", scope: !1168, file: !1, line: 5, type: !1180, scopeLine: 5, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1179, retainedNodes: !1189)
!1168 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "MyNullElement", file: !1169, line: 5, size: 896, flags: DIFlagTypePassByReference | DIFlagNonTrivial, elements: !1170, vtableHolder: !1172)
!1169 = !DIFile(filename: "my_ele/Null/MyNullElement.hh", directory: "/home/chenyz/packages/click/click-llvm-ir-selfmade")
!1170 = !{!1171, !1174, !1178, !1179, !1184, !1185, !1186}
!1171 = !DIDerivedType(tag: DW_TAG_inheritance, scope: !1168, baseType: !1172, flags: DIFlagPublic, extraData: i32 0)
!1172 = !DICompositeType(tag: DW_TAG_class_type, name: "Element", file: !1173, line: 29, flags: DIFlagFwdDecl | DIFlagNonTrivial, identifier: "_ZTS7Element")
!1173 = !DIFile(filename: "../dummy_inc/click/element.hh", directory: "/home/chenyz/packages/click/click-llvm-ir-selfmade")
!1174 = !DISubprogram(name: "MyNullElement", scope: !1168, file: !1169, line: 7, type: !1175, scopeLine: 7, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1175 = !DISubroutineType(types: !1176)
!1176 = !{null, !1177}
!1177 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1168, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1178 = !DISubprogram(name: "~MyNullElement", scope: !1168, file: !1169, line: 8, type: !1175, scopeLine: 8, containingType: !1168, virtualIndex: 0, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual | DISPFlagOptimized)
!1179 = !DISubprogram(name: "class_name", linkageName: "_ZNK13MyNullElement10class_nameEv", scope: !1168, file: !1169, line: 9, type: !1180, scopeLine: 9, containingType: !1168, virtualIndex: 9, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual | DISPFlagOptimized)
...
!1184 = !DISubprogram(name: "port_count", linkageName: "_ZNK13MyNullElement10port_countEv", scope: !1168, file: !1169, line: 10, type: !1180, scopeLine: 10, containingType: !1168, virtualIndex: 10, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual | DISPFlagOptimized)
!1185 = !DISubprogram(name: "processing", linkageName: "_ZNK13MyNullElement10processingEv", scope: !1168, file: !1169, line: 11, type: !1180, scopeLine: 11, containingType: !1168, virtualIndex: 11, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual | DISPFlagOptimized)
!1186 = !DISubprogram(name: "push", linkageName: "_ZN13MyNullElement4pushEiP6Packet", scope: !1168, file: !1169, line: 12, type: !1187, scopeLine: 12, containingType: !1168, virtualIndex: 2, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual | DISPFlagOptimized)
!1187 = !DISubroutineType(types: !1188)
!1188 = !{null, !1177, !34, !78}
!1189 = !{!1190}
!1190 = !DILocalVariable(name: "this", arg: 1, scope: !1167, type: !1191, flags: DIFlagArtificial | DIFlagObjectPointer)
!1191 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1183, size: 64)
!1192 = !DILocation(line: 0, scope: !1167)
!1193 = !DILocation(line: 5, column: 49, scope: !1167)
!1194 = distinct !DISubprogram(name: "port_count", linkageName: "_ZNK13MyNullElement10port_countEv", scope: !1168, file: !1, line: 6, type: !1180, scopeLine: 6, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1184, retainedNodes: !1195)
!1195 = !{!1196}
!1196 = !DILocalVariable(name: "this", arg: 1, scope: !1194, type: !1191, flags: DIFlagArtificial | DIFlagObjectPointer)
!1197 = !DILocation(line: 0, scope: !1194)
!1198 = !DILocation(line: 6, column: 49, scope: !1194)
!1199 = distinct !DISubprogram(name: "processing", linkageName: "_ZNK13MyNullElement10processingEv", scope: !1168, file: !1, line: 7, type: !1180, scopeLine: 7, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1185, retainedNodes: !1200)
!1200 = !{!1201}
!1201 = !DILocalVariable(name: "this", arg: 1, scope: !1199, type: !1191, flags: DIFlagArtificial | DIFlagObjectPointer)
!1202 = !DILocation(line: 0, scope: !1199)
!1203 = !DILocation(line: 7, column: 49, scope: !1199)
!1204 = distinct !DISubprogram(name: "push", linkageName: "_ZN13MyNullElement4pushEiP6Packet", scope: !1168, file: !1, line: 8, type: !1187, scopeLine: 8, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1186, retainedNodes: !1205)
!1205 = !{!1206, !1208, !1209}
!1206 = !DILocalVariable(name: "this", arg: 1, scope: !1204, type: !1207, flags: DIFlagArtificial | DIFlagObjectPointer)
!1207 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1168, size: 64)
!1208 = !DILocalVariable(name: "port", arg: 2, scope: !1204, file: !1, line: 8, type: !34)
!1209 = !DILocalVariable(name: "p", arg: 3, scope: !1204, file: !1, line: 8, type: !78)
!1210 = !DILocation(line: 0, scope: !1204)
!1211 = !DILocation(line: 9, column: 9, scope: !1204)
!1212 = !DILocation(line: 9, column: 19, scope: !1204)
!1213 = !DILocation(line: 10, column: 5, scope: !1204)
!1214 = distinct !DISubprogram(name: "output", linkageName: "_ZNK7Element6outputEi", scope: !1172, file: !1173, line: 460, type: !1215, scopeLine: 461, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1252, retainedNodes: !1253)
...
!1219 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "Port", scope: !1172, file: !1173, line: 214, size: 128, flags: DIFlagTypePassByValue | DIFlagNonTrivial, elements: !1220, identifier: "_ZTSN7Element4PortE")
!1220 = !{!1221, !1223, !1224, !1228, !1231, !1234, !1237, !1240, !1244, !1247}
!1221 = !DIDerivedType(tag: DW_TAG_member, name: "_e", scope: !1219, file: !1173, line: 231, baseType: !1222, size: 64)
!1222 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1172, size: 64)
!1223 = !DIDerivedType(tag: DW_TAG_member, name: "_port", scope: !1219, file: !1173, line: 232, baseType: !34, size: 32, offset: 64)
!1224 = !DISubprogram(name: "active", linkageName: "_ZNK7Element4Port6activeEv", scope: !1219, file: !1173, line: 216, type: !1225, scopeLine: 216, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1225 = !DISubroutineType(types: !1226)
!1226 = !{!53, !1227}
!1227 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1218, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1228 = !DISubprogram(name: "element", linkageName: "_ZNK7Element4Port7elementEv", scope: !1219, file: !1173, line: 217, type: !1229, scopeLine: 217, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1229 = !DISubroutineType(types: !1230)
!1230 = !{!1222, !1227}
!1231 = !DISubprogram(name: "port", linkageName: "_ZNK7Element4Port4portEv", scope: !1219, file: !1173, line: 218, type: !1232, scopeLine: 218, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1232 = !DISubroutineType(types: !1233)
!1233 = !{!34, !1227}
!1234 = !DISubprogram(name: "push", linkageName: "_ZNK7Element4Port4pushEP6Packet", scope: !1219, file: !1173, line: 220, type: !1235, scopeLine: 220, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1235 = !DISubroutineType(types: !1236)
!1236 = !{null, !1227, !78}
!1237 = !DISubprogram(name: "pull", linkageName: "_ZNK7Element4Port4pullEv", scope: !1219, file: !1173, line: 221, type: !1238, scopeLine: 221, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1238 = !DISubroutineType(types: !1239)
!1239 = !{!78, !1227}
!1240 = !DISubprogram(name: "assign", linkageName: "_ZN7Element4Port6assignEbPS_i", scope: !1219, file: !1173, line: 227, type: !1241, scopeLine: 227, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1241 = !DISubroutineType(types: !1242)
!1242 = !{null, !1243, !53, !1222, !34}
!1243 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1219, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1244 = !DISubprogram(name: "Port", scope: !1219, file: !1173, line: 247, type: !1245, scopeLine: 247, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1245 = !DISubroutineType(types: !1246)
!1246 = !{null, !1243}
!1247 = !DISubprogram(name: "assign", linkageName: "_ZN7Element4Port6assignEbPS_S1_i", scope: !1219, file: !1173, line: 248, type: !1248, scopeLine: 248, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1248 = !DISubroutineType(types: !1249)
!1249 = !{null, !1243, !53, !1222, !1222, !34}
!1250 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1251, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1251 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1172)
!1252 = !DISubprogram(name: "output", linkageName: "_ZNK7Element6outputEi", scope: !1172, file: !1173, line: 137, type: !1215, scopeLine: 137, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1253 = !{!1254, !1256}
!1254 = !DILocalVariable(name: "this", arg: 1, scope: !1214, type: !1255, flags: DIFlagArtificial | DIFlagObjectPointer)
!1255 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1251, size: 64)
!1256 = !DILocalVariable(name: "port", arg: 2, scope: !1214, file: !1173, line: 460, type: !34)
!1257 = !{!1258, !1258, i64 0}
!1258 = !{!"any pointer", !1259, i64 0}
!1259 = !{!"omnipotent char", !1260, i64 0}
!1260 = !{!"Simple C++ TBAA"}
!1261 = !DILocation(line: 0, scope: !1214)
!1262 = !{!1263, !1263, i64 0}
!1263 = !{!"int", !1259, i64 0}
!1264 = !DILocation(line: 460, column: 21, scope: !1214)
!1265 = !DILocation(line: 462, column: 32, scope: !1214)
!1266 = !DILocation(line: 462, column: 21, scope: !1214)
!1267 = !DILocation(line: 462, column: 5, scope: !1214)
!1268 = distinct !DISubprogram(name: "push", linkageName: "_ZNK7Element4Port4pushEP6Packet", scope: !1219, file: !1173, line: 609, type: !1235, scopeLine: 610, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1234, retainedNodes: !1269)
!1269 = !{!1270, !1272}
!1270 = !DILocalVariable(name: "this", arg: 1, scope: !1268, type: !1271, flags: DIFlagArtificial | DIFlagObjectPointer)
!1271 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1218, size: 64)
!1272 = !DILocalVariable(name: "p", arg: 2, scope: !1268, file: !1173, line: 609, type: !78)
!1273 = !DILocation(line: 0, scope: !1268)
!1274 = !DILocation(line: 609, column: 29, scope: !1268)
!1275 = !DILocation(line: 611, column: 5, scope: !1268)
!1276 = !{!1277, !1258, i64 0}
!1277 = !{!"_ZTSN7Element4PortE", !1258, i64 0, !1263, i64 8}
!1278 = !DILocation(line: 633, column: 5, scope: !1268)
!1279 = !DILocation(line: 633, column: 14, scope: !1268)
!1280 = !{!1277, !1263, i64 8}
!1281 = !DILocation(line: 633, column: 21, scope: !1268)
!1282 = !DILocation(line: 633, column: 9, scope: !1268)
!1283 = !{!1284, !1284, i64 0}
!1284 = !{!"vtable pointer", !1260, i64 0}
!1285 = !DILocation(line: 636, column: 1, scope: !1268)
!1286 = distinct !DISubprogram(name: "~MyNullElement", linkageName: "_ZN13MyNullElementD0Ev", scope: !1168, file: !1169, line: 8, type: !1175, scopeLine: 8, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1178, retainedNodes: !1287)
!1287 = !{!1288}
!1288 = !DILocalVariable(name: "this", arg: 1, scope: !1286, type: !1207, flags: DIFlagArtificial | DIFlagObjectPointer)
!1289 = !DILocation(line: 0, scope: !1286)
!1290 = !DILocation(line: 8, column: 22, scope: !1286)
!1291 = !DILocation(line: 8, column: 24, scope: !1286)
!1292 = distinct !DISubprogram(name: "port", linkageName: "_ZNK7Element4portEbi", scope: !1172, file: !1173, line: 435, type: !1293, scopeLine: 436, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1295, retainedNodes: !1296)
!1293 = !DISubroutineType(types: !1294)
!1294 = !{!1217, !1250, !53, !34}
!1295 = !DISubprogram(name: "port", linkageName: "_ZNK7Element4portEbi", scope: !1172, file: !1173, line: 135, type: !1293, scopeLine: 135, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1296 = !{!1297, !1298, !1299}
!1297 = !DILocalVariable(name: "this", arg: 1, scope: !1292, type: !1255, flags: DIFlagArtificial | DIFlagObjectPointer)
!1298 = !DILocalVariable(name: "isoutput", arg: 2, scope: !1292, file: !1173, line: 435, type: !53)
!1299 = !DILocalVariable(name: "port", arg: 3, scope: !1292, file: !1173, line: 435, type: !34)
!1300 = !DILocation(line: 0, scope: !1292)
!1301 = !{!1302, !1302, i64 0}
!1302 = !{!"bool", !1259, i64 0}
!1303 = !DILocation(line: 435, column: 20, scope: !1292)
!1304 = !DILocation(line: 435, column: 34, scope: !1292)
!1305 = !DILocation(line: 437, column: 5, scope: !1292)
!1306 = !{i8 0, i8 2}
!1307 = !DILocation(line: 438, column: 12, scope: !1292)
!1308 = !DILocation(line: 438, column: 19, scope: !1292)
!1309 = !DILocation(line: 438, column: 29, scope: !1292)
!1310 = !DILocation(line: 438, column: 5, scope: !1292)
