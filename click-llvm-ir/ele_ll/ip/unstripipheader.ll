; ModuleID = '../elements/ip/unstripipheader.cc'
source_filename = "../elements/ip/unstripipheader.cc"
...
@_ZTS15UnstripIPHeader = dso_local constant [18 x i8] c"15UnstripIPHeader\00", align 1
@_ZTI7Element = external constant i8*
@_ZTI15UnstripIPHeader = dso_local constant { i8*, i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([18 x i8], [18 x i8]* @_ZTS15UnstripIPHeader, i32 0, i32 0), i8* bitcast (i8** @_ZTI7Element to i8*) }, align 8
@.str.2 = private unnamed_addr constant [16 x i8] c"UnstripIPHeader\00", align 1
@_ZN7Element9PORTS_1_1E = external constant [0 x i8], align 1

@_ZN15UnstripIPHeaderC1Ev = dso_local unnamed_addr alias void (%class.UnstripIPHeader*), void (%class.UnstripIPHeader*)* @_ZN15UnstripIPHeaderC2Ev
@_ZN15UnstripIPHeaderD1Ev = dso_local unnamed_addr alias void (%class.UnstripIPHeader*), void (%class.UnstripIPHeader*)* @_ZN15UnstripIPHeaderD2Ev

; Function Attrs: sspstrong uwtable
define dso_local void @_ZN15UnstripIPHeaderC2Ev(%class.UnstripIPHeader* %0) unnamed_addr #0 align 2 !dbg !1792 {
  call void @llvm.dbg.value(metadata %class.UnstripIPHeader* %0, metadata !1814, metadata !DIExpression()), !dbg !1816
  %2 = bitcast %class.UnstripIPHeader* %0 to %class.Element*, !dbg !1817
  tail call void @_ZN7ElementC2Ev(%class.Element* %2), !dbg !1818
  %3 = getelementptr %class.UnstripIPHeader, %class.UnstripIPHeader* %0, i64 0, i32 0, i32 0, !dbg !1817
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [29 x i8*] }, { [29 x i8*] }* @_ZTV15UnstripIPHeader, i64 0, inrange i32 0, i64 2) to i32 (...)**), i32 (...)*** %3, align 8, !dbg !1817, !tbaa !1819
  ret void, !dbg !1822
}
...
define dso_local void @_ZN15UnstripIPHeaderD2Ev(%class.UnstripIPHeader* %0) unnamed_addr #4 align 2 !dbg !1823 {
  call void @llvm.dbg.value(metadata %class.UnstripIPHeader* %0, metadata !1825, metadata !DIExpression()), !dbg !1826
  %2 = bitcast %class.UnstripIPHeader* %0 to %class.Element*, !dbg !1827
  tail call void @_ZN7ElementD2Ev(%class.Element* %2) #10, !dbg !1827
  ret void, !dbg !1829
}

; Function Attrs: nounwind sspstrong uwtable
define dso_local void @_ZN15UnstripIPHeaderD0Ev(%class.UnstripIPHeader* %0) unnamed_addr #4 align 2 !dbg !1830 {
  call void @llvm.dbg.value(metadata %class.UnstripIPHeader* %0, metadata !1832, metadata !DIExpression()), !dbg !1833
  call void @llvm.dbg.value(metadata %class.UnstripIPHeader* %0, metadata !1825, metadata !DIExpression()) #10, !dbg !1834
  %2 = bitcast %class.UnstripIPHeader* %0 to %class.Element*, !dbg !1836
  tail call void @_ZN7ElementD2Ev(%class.Element* %2) #10, !dbg !1836
  %3 = bitcast %class.UnstripIPHeader* %0 to i8*, !dbg !1837
  tail call void @_ZdlPv(i8* %3) #11, !dbg !1837
  ret void, !dbg !1838
}
...
; Function Attrs: sspstrong uwtable
define dso_local %class.Packet* @_ZN15UnstripIPHeader13simple_actionEP6Packet(%class.UnstripIPHeader* nocapture readnone %0, %class.Packet* %1) unnamed_addr #0 align 2 !dbg !1839 {
  call void @llvm.dbg.value(metadata %class.UnstripIPHeader* undef, metadata !1841, metadata !DIExpression()), !dbg !1845
  call void @llvm.dbg.value(metadata %class.Packet* %1, metadata !1842, metadata !DIExpression()), !dbg !1845
  %3 = tail call i8* @_ZNK6Packet14network_headerEv(%class.Packet* %1), !dbg !1846
  %4 = icmp eq i8* %3, null, !dbg !1846
  br i1 %4, label %5, label %6, !dbg !1846

5:                                                ; preds = %2
  tail call void @__assert_fail(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.1, i64 0, i64 0), i32 34, i8* getelementptr inbounds ([57 x i8], [57 x i8]* @__PRETTY_FUNCTION__._ZN15UnstripIPHeader13simple_actionEP6Packet, i64 0, i64 0)) #12, !dbg !1846
  unreachable, !dbg !1846

6:                                                ; preds = %2
  %7 = tail call i8* @_ZNK6Packet14network_headerEv(%class.Packet* %1), !dbg !1847
  %8 = tail call i8* @_ZNK6Packet4dataEv(%class.Packet* %1), !dbg !1848
  %9 = ptrtoint i8* %7 to i64, !dbg !1849
  %10 = ptrtoint i8* %8 to i64, !dbg !1849
  %11 = sub i64 %9, %10, !dbg !1849
  call void @llvm.dbg.value(metadata i64 %11, metadata !1843, metadata !DIExpression()), !dbg !1845
  %12 = icmp slt i64 %11, 0, !dbg !1850
  br i1 %12, label %13, label %18, !dbg !1852

13:                                               ; preds = %6
  %14 = trunc i64 %11 to i32, !dbg !1853
  %15 = sub i32 0, %14, !dbg !1853
  %16 = tail call %class.WritablePacket* @_ZN6Packet4pushEj(%class.Packet* %1, i32 %15), !dbg !1854
  %17 = getelementptr %class.WritablePacket, %class.WritablePacket* %16, i64 0, i32 0, !dbg !1855
  call void @llvm.dbg.value(metadata %class.Packet* %17, metadata !1842, metadata !DIExpression()), !dbg !1845
  br label %18, !dbg !1856

18:                                               ; preds = %13, %6
  %19 = phi %class.Packet* [ %17, %13 ], [ %1, %6 ]
  call void @llvm.dbg.value(metadata %class.Packet* %19, metadata !1842, metadata !DIExpression()), !dbg !1845
  ret %class.Packet* %19, !dbg !1857
}
...
define linkonce_odr dso_local %class.WritablePacket* @_ZN6Packet4pushEj(%class.Packet* %0, i32 %1) local_unnamed_addr #8 comdat align 2 !dbg !1858 {
  %3 = alloca %class.WritablePacket*, align 8
  %4 = alloca %class.Packet*, align 8
  %5 = alloca i32, align 4
  %6 = alloca %class.WritablePacket*, align 8
  store %class.Packet* %0, %class.Packet** %4, align 8, !tbaa !1865
  call void @llvm.dbg.declare(metadata %class.Packet** %4, metadata !1860, metadata !DIExpression()), !dbg !1868
  store i32 %1, i32* %5, align 4, !tbaa !1869
  call void @llvm.dbg.declare(metadata i32* %5, metadata !1861, metadata !DIExpression()), !dbg !1871
  %7 = load %class.Packet*, %class.Packet** %4, align 8
  %8 = call i32 @_ZNK6Packet8headroomEv(%class.Packet* %7), !dbg !1872
  %9 = load i32, i32* %5, align 4, !dbg !1873, !tbaa !1869
  %10 = icmp uge i32 %8, %9, !dbg !1874
  br i1 %10, label %11, label %26, !dbg !1875

11:                                               ; preds = %2
  %12 = call zeroext i1 @_ZNK6Packet6sharedEv(%class.Packet* %7), !dbg !1876
  br i1 %12, label %26, label %13, !dbg !1877

13:                                               ; preds = %11
  %14 = bitcast %class.WritablePacket** %6 to i8*, !dbg !1878
  call void @llvm.lifetime.start.p0i8(i64 8, i8* %14) #10, !dbg !1878
  call void @llvm.dbg.declare(metadata %class.WritablePacket** %6, metadata !1862, metadata !DIExpression()), !dbg !1879
  %15 = bitcast %class.Packet* %7 to %class.WritablePacket*, !dbg !1880
  store %class.WritablePacket* %15, %class.WritablePacket** %6, align 8, !dbg !1879, !tbaa !1865
  %16 = load i32, i32* %5, align 4, !dbg !1881, !tbaa !1869
  %17 = load %class.WritablePacket*, %class.WritablePacket** %6, align 8, !dbg !1882, !tbaa !1865
  %18 = bitcast %class.WritablePacket* %17 to %class.Packet*, !dbg !1883
  %19 = getelementptr inbounds %class.Packet, %class.Packet* %18, i32 0, i32 3, !dbg !1883
  %20 = load i8*, i8** %19, align 8, !dbg !1884, !tbaa !1885
  %21 = zext i32 %16 to i64, !dbg !1884
  %22 = sub i64 0, %21, !dbg !1884
  %23 = getelementptr inbounds i8, i8* %20, i64 %22, !dbg !1884
  store i8* %23, i8** %19, align 8, !dbg !1884, !tbaa !1885
  %24 = load %class.WritablePacket*, %class.WritablePacket** %6, align 8, !dbg !1890, !tbaa !1865
  store %class.WritablePacket* %24, %class.WritablePacket** %3, align 8, !dbg !1891
  %25 = bitcast %class.WritablePacket** %6 to i8*, !dbg !1892
  call void @llvm.lifetime.end.p0i8(i64 8, i8* %25) #10, !dbg !1892
  br label %29

26:                                               ; preds = %11, %2
  %27 = load i32, i32* %5, align 4, !dbg !1893, !tbaa !1869
  %28 = call %class.WritablePacket* @_ZN6Packet14expensive_pushEj(%class.Packet* %7, i32 %27), !dbg !1894
  store %class.WritablePacket* %28, %class.WritablePacket** %3, align 8, !dbg !1895
  br label %29, !dbg !1895

29:                                               ; preds = %26, %13
  %30 = load %class.WritablePacket*, %class.WritablePacket** %3, align 8, !dbg !1896
  ret %class.WritablePacket* %30, !dbg !1896
}
...
; Function Attrs: nounwind sspstrong uwtable
define linkonce_odr dso_local i8* @_ZNK15UnstripIPHeader10class_nameEv(%class.UnstripIPHeader* %0) unnamed_addr #4 comdat align 2 !dbg !1897 {
  call void @llvm.dbg.value(metadata %class.UnstripIPHeader* %0, metadata !1899, metadata !DIExpression()), !dbg !1901
  ret i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.2, i64 0, i64 0), !dbg !1902
}

; Function Attrs: nounwind sspstrong uwtable
define linkonce_odr dso_local i8* @_ZNK15UnstripIPHeader10port_countEv(%class.UnstripIPHeader* %0) unnamed_addr #4 comdat align 2 !dbg !1903 {
  call void @llvm.dbg.value(metadata %class.UnstripIPHeader* %0, metadata !1905, metadata !DIExpression()), !dbg !1906
  ret i8* getelementptr inbounds ([0 x i8], [0 x i8]* @_ZN7Element9PORTS_1_1E, i64 0, i64 0), !dbg !1907
}
...
define linkonce_odr dso_local i32 @_ZNK6Packet8headroomEv(%class.Packet* %0) local_unnamed_addr #9 comdat align 2 !dbg !1908 {
  call void @llvm.dbg.value(metadata %class.Packet* %0, metadata !1910, metadata !DIExpression()), !dbg !1911
  %2 = tail call i8* @_ZNK6Packet4dataEv(%class.Packet* %0), !dbg !1912
  call void @llvm.dbg.value(metadata %class.Packet* %0, metadata !1913, metadata !DIExpression()), !dbg !1916
  %3 = getelementptr inbounds %class.Packet, %class.Packet* %0, i64 0, i32 2, !dbg !1918
  %4 = bitcast i8** %3 to i64*, !dbg !1918
  %5 = load i64, i64* %4, align 8, !dbg !1918, !tbaa !1919
  %6 = ptrtoint i8* %2 to i64, !dbg !1920
  %7 = sub i64 %6, %5, !dbg !1920
  %8 = trunc i64 %7 to i32, !dbg !1912
  ret i32 %8, !dbg !1921
}
...
!1 = !DIFile(filename: "../elements/ip/unstripipheader.cc", directory: "/home/john/projects/click/ir-dir")
!2 = !{!3, !857}
...
!1792 = distinct !DISubprogram(name: "UnstripIPHeader", linkageName: "_ZN15UnstripIPHeaderC2Ev", scope: !1793, file: !1, line: 23, type: !1800, scopeLine: 24, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1799, retainedNodes: !1813)
!1793 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "UnstripIPHeader", file: !1794, line: 19, size: 896, flags: DIFlagTypePassByReference | DIFlagNonTrivial, elements: !1795, vtableHolder: !1797)
!1794 = !DIFile(filename: "../elements/ip/unstripipheader.hh", directory: "/home/john/projects/click/ir-dir")
!1795 = !{!1796, !1799, !1803, !1804, !1809, !1810}
...
!1799 = !DISubprogram(name: "UnstripIPHeader", scope: !1793, file: !1794, line: 21, type: !1800, scopeLine: 21, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1800 = !DISubroutineType(types: !1801)
!1801 = !{null, !1802}
!1802 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1793, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1803 = !DISubprogram(name: "~UnstripIPHeader", scope: !1793, file: !1794, line: 22, type: !1800, scopeLine: 22, containingType: !1793, virtualIndex: 0, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual | DISPFlagOptimized)
!1804 = !DISubprogram(name: "class_name", linkageName: "_ZNK15UnstripIPHeader10class_nameEv", scope: !1793, file: !1794, line: 24, type: !1805, scopeLine: 24, containingType: !1793, virtualIndex: 9, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual | DISPFlagOptimized)
...
!1809 = !DISubprogram(name: "port_count", linkageName: "_ZNK15UnstripIPHeader10port_countEv", scope: !1793, file: !1794, line: 25, type: !1805, scopeLine: 25, containingType: !1793, virtualIndex: 10, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual | DISPFlagOptimized)
!1810 = !DISubprogram(name: "simple_action", linkageName: "_ZN15UnstripIPHeader13simple_actionEP6Packet", scope: !1793, file: !1794, line: 27, type: !1811, scopeLine: 27, containingType: !1793, virtualIndex: 4, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual | DISPFlagOptimized)
!1811 = !DISubroutineType(types: !1812)
!1812 = !{!78, !1802, !78}
!1813 = !{!1814}
!1814 = !DILocalVariable(name: "this", arg: 1, scope: !1792, type: !1815, flags: DIFlagArtificial | DIFlagObjectPointer)
!1815 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1793, size: 64)
!1816 = !DILocation(line: 0, scope: !1792)
!1817 = !DILocation(line: 24, column: 1, scope: !1792)
!1818 = !DILocation(line: 23, column: 18, scope: !1792)
!1819 = !{!1820, !1820, i64 0}
!1820 = !{!"vtable pointer", !1821, i64 0}
!1821 = !{!"Simple C++ TBAA"}
!1822 = !DILocation(line: 25, column: 1, scope: !1792)
!1823 = distinct !DISubprogram(name: "~UnstripIPHeader", linkageName: "_ZN15UnstripIPHeaderD2Ev", scope: !1793, file: !1, line: 27, type: !1800, scopeLine: 28, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1803, retainedNodes: !1824)
!1824 = !{!1825}
!1825 = !DILocalVariable(name: "this", arg: 1, scope: !1823, type: !1815, flags: DIFlagArtificial | DIFlagObjectPointer)
!1826 = !DILocation(line: 0, scope: !1823)
!1827 = !DILocation(line: 29, column: 1, scope: !1828)
!1828 = distinct !DILexicalBlock(scope: !1823, file: !1, line: 28, column: 1)
!1829 = !DILocation(line: 29, column: 1, scope: !1823)
!1830 = distinct !DISubprogram(name: "~UnstripIPHeader", linkageName: "_ZN15UnstripIPHeaderD0Ev", scope: !1793, file: !1, line: 27, type: !1800, scopeLine: 28, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1803, retainedNodes: !1831)
!1831 = !{!1832}
!1832 = !DILocalVariable(name: "this", arg: 1, scope: !1830, type: !1815, flags: DIFlagArtificial | DIFlagObjectPointer)
!1833 = !DILocation(line: 0, scope: !1830)
!1834 = !DILocation(line: 0, scope: !1823, inlinedAt: !1835)
!1835 = distinct !DILocation(line: 28, column: 1, scope: !1830)
!1836 = !DILocation(line: 29, column: 1, scope: !1828, inlinedAt: !1835)
!1837 = !DILocation(line: 28, column: 1, scope: !1830)
!1838 = !DILocation(line: 29, column: 1, scope: !1830)
!1839 = distinct !DISubprogram(name: "simple_action", linkageName: "_ZN15UnstripIPHeader13simple_actionEP6Packet", scope: !1793, file: !1, line: 32, type: !1811, scopeLine: 33, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1810, retainedNodes: !1840)
!1840 = !{!1841, !1842, !1843}
!1841 = !DILocalVariable(name: "this", arg: 1, scope: !1839, type: !1815, flags: DIFlagArtificial | DIFlagObjectPointer)
!1842 = !DILocalVariable(name: "p", arg: 2, scope: !1839, file: !1, line: 32, type: !78)
!1843 = !DILocalVariable(name: "offset", scope: !1839, file: !1, line: 35, type: !1844)
!1844 = !DIDerivedType(tag: DW_TAG_typedef, name: "ptrdiff_t", file: !134, line: 35, baseType: !395)
!1845 = !DILocation(line: 0, scope: !1839)
!1846 = !DILocation(line: 34, column: 5, scope: !1839)
!1847 = !DILocation(line: 35, column: 27, scope: !1839)
!1848 = !DILocation(line: 35, column: 49, scope: !1839)
!1849 = !DILocation(line: 35, column: 44, scope: !1839)
!1850 = !DILocation(line: 36, column: 16, scope: !1851)
!1851 = distinct !DILexicalBlock(scope: !1839, file: !1, line: 36, column: 9)
!1852 = !DILocation(line: 36, column: 9, scope: !1839)
!1853 = !DILocation(line: 37, column: 14, scope: !1851)
!1854 = !DILocation(line: 37, column: 9, scope: !1851)
!1855 = !DILocation(line: 37, column: 6, scope: !1851)
!1856 = !DILocation(line: 37, column: 2, scope: !1851)
!1857 = !DILocation(line: 38, column: 5, scope: !1839)
!1858 = distinct !DISubprogram(name: "push", linkageName: "_ZN6Packet4pushEj", scope: !5, file: !4, line: 1547, type: !277, scopeLine: 1548, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !276, retainedNodes: !1859)
!1859 = !{!1860, !1861, !1862}
!1860 = !DILocalVariable(name: "this", arg: 1, scope: !1858, type: !78, flags: DIFlagArtificial | DIFlagObjectPointer)
!1861 = !DILocalVariable(name: "len", arg: 2, scope: !1858, file: !4, line: 1547, type: !12)
!1862 = !DILocalVariable(name: "q", scope: !1863, file: !4, line: 1550, type: !140)
!1863 = distinct !DILexicalBlock(scope: !1864, file: !4, line: 1549, column: 41)
!1864 = distinct !DILexicalBlock(scope: !1858, file: !4, line: 1549, column: 9)
!1865 = !{!1866, !1866, i64 0}
!1866 = !{!"any pointer", !1867, i64 0}
!1867 = !{!"omnipotent char", !1821, i64 0}
!1868 = !DILocation(line: 0, scope: !1858)
!1869 = !{!1870, !1870, i64 0}
!1870 = !{!"int", !1867, i64 0}
!1871 = !DILocation(line: 1547, column: 23, scope: !1858)
!1872 = !DILocation(line: 1549, column: 9, scope: !1864)
!1873 = !DILocation(line: 1549, column: 23, scope: !1864)
!1874 = !DILocation(line: 1549, column: 20, scope: !1864)
!1875 = !DILocation(line: 1549, column: 27, scope: !1864)
!1876 = !DILocation(line: 1549, column: 31, scope: !1864)
!1877 = !DILocation(line: 1549, column: 9, scope: !1858)
!1878 = !DILocation(line: 1550, column: 2, scope: !1863)
!1879 = !DILocation(line: 1550, column: 18, scope: !1863)
!1880 = !DILocation(line: 1550, column: 22, scope: !1863)
!1881 = !DILocation(line: 1554, column: 14, scope: !1863)
!1882 = !DILocation(line: 1554, column: 2, scope: !1863)
!1883 = !DILocation(line: 1554, column: 5, scope: !1863)
!1884 = !DILocation(line: 1554, column: 11, scope: !1863)
!1885 = !{!1886, !1866, i64 24}
!1886 = !{!"_ZTS6Packet", !1887, i64 0, !1866, i64 8, !1866, i64 16, !1866, i64 24, !1866, i64 32, !1866, i64 40, !1888, i64 48, !1866, i64 152, !1866, i64 160}
!1887 = !{!"_ZTS15atomic_uint32_t", !1870, i64 0}
!1888 = !{!"_ZTSN6Packet7AllAnnoE", !1867, i64 0, !1866, i64 48, !1866, i64 56, !1866, i64 64, !1889, i64 72, !1867, i64 76, !1866, i64 88, !1866, i64 96}
!1889 = !{!"_ZTSN6Packet10PacketTypeE", !1867, i64 0}
!1890 = !DILocation(line: 1561, column: 9, scope: !1863)
!1891 = !DILocation(line: 1561, column: 2, scope: !1863)
!1892 = !DILocation(line: 1562, column: 5, scope: !1864)
!1893 = !DILocation(line: 1563, column: 24, scope: !1864)
!1894 = !DILocation(line: 1563, column: 9, scope: !1864)
!1895 = !DILocation(line: 1563, column: 2, scope: !1864)
!1896 = !DILocation(line: 1564, column: 1, scope: !1858)
!1897 = distinct !DISubprogram(name: "class_name", linkageName: "_ZNK15UnstripIPHeader10class_nameEv", scope: !1793, file: !1794, line: 24, type: !1805, scopeLine: 24, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1804, retainedNodes: !1898)
!1898 = !{!1899}
!1899 = !DILocalVariable(name: "this", arg: 1, scope: !1897, type: !1900, flags: DIFlagArtificial | DIFlagObjectPointer)
!1900 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1808, size: 64)
!1901 = !DILocation(line: 0, scope: !1897)
!1902 = !DILocation(line: 24, column: 37, scope: !1897)
!1903 = distinct !DISubprogram(name: "port_count", linkageName: "_ZNK15UnstripIPHeader10port_countEv", scope: !1793, file: !1794, line: 25, type: !1805, scopeLine: 25, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1809, retainedNodes: !1904)
!1904 = !{!1905}
!1905 = !DILocalVariable(name: "this", arg: 1, scope: !1903, type: !1900, flags: DIFlagArtificial | DIFlagObjectPointer)
!1906 = !DILocation(line: 0, scope: !1903)
!1907 = !DILocation(line: 25, column: 37, scope: !1903)
!1908 = distinct !DISubprogram(name: "headroom", linkageName: "_ZNK6Packet8headroomEv", scope: !5, file: !4, line: 969, type: !259, scopeLine: 970, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !261, retainedNodes: !1909)
!1909 = !{!1910}
!1910 = !DILocalVariable(name: "this", arg: 1, scope: !1908, type: !1100, flags: DIFlagArtificial | DIFlagObjectPointer)
!1911 = !DILocation(line: 0, scope: !1908)
!1912 = !DILocation(line: 971, column: 12, scope: !1908)
!1913 = !DILocalVariable(name: "this", arg: 1, scope: !1914, type: !1100, flags: DIFlagArtificial | DIFlagObjectPointer)
!1914 = distinct !DISubprogram(name: "buffer", linkageName: "_ZNK6Packet6bufferEv", scope: !5, file: !4, line: 924, type: !253, scopeLine: 925, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !263, retainedNodes: !1915)
!1915 = !{!1913}
!1916 = !DILocation(line: 0, scope: !1914, inlinedAt: !1917)
!1917 = distinct !DILocation(line: 971, column: 21, scope: !1908)
!1918 = !DILocation(line: 929, column: 12, scope: !1914, inlinedAt: !1917)
!1919 = !{!1886, !1866, i64 16}
!1920 = !DILocation(line: 971, column: 19, scope: !1908)
!1921 = !DILocation(line: 971, column: 5, scope: !1908)
