; ModuleID = '../elements/local/forceip.cc'
source_filename = "../elements/local/forceip.cc"
...
@_ZTV7ForceIP = dso_local unnamed_addr constant { [29 x i8*] } { [29 x i8*] [i8* null, i8* bitcast ({ i8*, i8*, i8* }* @_ZTI7ForceIP to i8*), i8* bitcast (void (%class.ForceIP*)* @_ZN7ForceIPD2Ev to i8*), i8* bitcast (void (%class.ForceIP*)* @_ZN7ForceIPD0Ev to i8*), i8* bitcast (void (%class.Element*, i32, %class.Packet*)* @_ZN7Element4pushEiP6Packet to i8*), i8* bitcast (%class.Packet* (%class.Element*, i32)* @_ZN7Element4pullEi to i8*), i8* bitcast (%class.Packet* (%class.ForceIP*, %class.Packet*)* @_ZN7ForceIP13simple_actionEP6Packet to i8*), i8* bitcast (i1 (%class.Element*, %class.Task*)* @_ZN7Element8run_taskEP4Task to i8*), i8* bitcast (void (%class.Element*, %class.Timer*)* @_ZN7Element9run_timerEP5Timer to i8*), i8* bitcast (void (%class.Element*, i32, i32)* @_ZN7Element8selectedEii to i8*), i8* bitcast (void (%class.Element*, i32)* @_ZN7Element8selectedEi to i8*), i8* bitcast (i8* (%class.ForceIP*)* @_ZNK7ForceIP10class_nameEv to i8*), i8* bitcast (i8* (%class.ForceIP*)* @_ZNK7ForceIP10port_countEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element10processingEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element9flow_codeEv to i8*), i8* bitcast (i8* (%class.Element*)* @_ZNK7Element5flagsEv to i8*), i8* bitcast (i8* (%class.Element*, i8*)* @_ZN7Element4castEPKc to i8*), i8* bitcast (i8* (%class.Element*, i1, i32, i8*)* @_ZN7Element9port_castEbiPKc to i8*), i8* bitcast (i32 (%class.Element*)* @_ZNK7Element15configure_phaseEv to i8*), i8* bitcast (i32 (%class.Element*, %class.Vector*, %class.ErrorHandler*)* @_ZN7Element9configureER6VectorI6StringEP12ErrorHandler to i8*), i8* bitcast (void (%class.Element*)* @_ZN7Element12add_handlersEv to i8*), i8* bitcast (i32 (%class.Element*, %class.ErrorHandler*)* @_ZN7Element10initializeEP12ErrorHandler to i8*), i8* bitcast (void (%class.Element*, %class.Element*, %class.ErrorHandler*)* @_ZN7Element10take_stateEPS_P12ErrorHandler to i8*), i8* bitcast (%class.Element* (%class.Element*)* @_ZNK7Element15hotswap_elementEv to i8*), i8* bitcast (void (%class.Element*, i32)* @_ZN7Element7cleanupENS_12CleanupStageE to i8*), i8* bitcast (void (%class.String*, %class.Element*)* @_ZNK7Element11declarationEv to i8*), i8* bitcast (i1 (%class.Element*)* @_ZNK7Element20can_live_reconfigureEv to i8*), i8* bitcast (i32 (%class.Element*, %class.Vector*, %class.ErrorHandler*)* @_ZN7Element16live_reconfigureER6VectorI6StringEP12ErrorHandler to i8*), i8* bitcast (i32 (%class.Element*, i32, i8*)* @_ZN7Element5llrpcEjPv to i8*)] }, align 8
@_ZTVN10__cxxabiv120__si_class_type_infoE = external global i8*
@_ZTS7ForceIP = dso_local constant [9 x i8] c"7ForceIP\00", align 1
@_ZTI7Element = external constant i8*
@_ZTI7ForceIP = dso_local constant { i8*, i8*, i8* } { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @_ZTS7ForceIP, i32 0, i32 0), i8* bitcast (i8** @_ZTI7Element to i8*) }, align 8
@.str = private unnamed_addr constant [8 x i8] c"ForceIP\00", align 1
@_ZN7Element9PORTS_1_1E = external constant [0 x i8], align 1

@_ZN7ForceIPC1Ev = dso_local unnamed_addr alias void (%class.ForceIP*), void (%class.ForceIP*)* @_ZN7ForceIPC2Ev
@_ZN7ForceIPD1Ev = dso_local unnamed_addr alias void (%class.ForceIP*), void (%class.ForceIP*)* @_ZN7ForceIPD2Ev

; Function Attrs: sspstrong uwtable
define dso_local void @_ZN7ForceIPC2Ev(%class.ForceIP* %0) unnamed_addr #0 align 2 !dbg !1795 {
  call void @llvm.dbg.value(metadata %class.ForceIP* %0, metadata !1818, metadata !DIExpression()), !dbg !1820
  %2 = bitcast %class.ForceIP* %0 to %class.Element*, !dbg !1821
  tail call void @_ZN7ElementC2Ev(%class.Element* %2), !dbg !1822
  %3 = getelementptr %class.ForceIP, %class.ForceIP* %0, i64 0, i32 0, i32 0, !dbg !1821
  store i32 (...)** bitcast (i8** getelementptr inbounds ({ [29 x i8*] }, { [29 x i8*] }* @_ZTV7ForceIP, i64 0, inrange i32 0, i64 2) to i32 (...)**), i32 (...)*** %3, align 8, !dbg !1821, !tbaa !1823
  %4 = getelementptr inbounds %class.ForceIP, %class.ForceIP* %0, i64 0, i32 1, !dbg !1826
  store i32 0, i32* %4, align 4, !dbg !1828, !tbaa !1829
  ret void, !dbg !1833
}
...
define dso_local void @_ZN7ForceIPD2Ev(%class.ForceIP* %0) unnamed_addr #3 align 2 !dbg !1834 {
  call void @llvm.dbg.value(metadata %class.ForceIP* %0, metadata !1836, metadata !DIExpression()), !dbg !1837
  %2 = bitcast %class.ForceIP* %0 to %class.Element*, !dbg !1838
  tail call void @_ZN7ElementD2Ev(%class.Element* %2) #6, !dbg !1838
  ret void, !dbg !1840
}

; Function Attrs: nounwind sspstrong uwtable
define dso_local void @_ZN7ForceIPD0Ev(%class.ForceIP* %0) unnamed_addr #3 align 2 !dbg !1841 {
  call void @llvm.dbg.value(metadata %class.ForceIP* %0, metadata !1843, metadata !DIExpression()), !dbg !1844
  call void @llvm.dbg.value(metadata %class.ForceIP* %0, metadata !1836, metadata !DIExpression()) #6, !dbg !1845
  %2 = bitcast %class.ForceIP* %0 to %class.Element*, !dbg !1847
  tail call void @_ZN7ElementD2Ev(%class.Element* %2) #6, !dbg !1847
  %3 = bitcast %class.ForceIP* %0 to i8*, !dbg !1848
  tail call void @_ZdlPv(i8* %3) #7, !dbg !1848
  ret void, !dbg !1849
}
...
; Function Attrs: sspstrong uwtable
define dso_local %class.Packet* @_ZN7ForceIP13simple_actionEP6Packet(%class.ForceIP* nocapture %0, %class.Packet* %1) unnamed_addr #0 align 2 !dbg !1850 {
  call void @llvm.dbg.value(metadata %class.ForceIP* %0, metadata !1852, metadata !DIExpression()), !dbg !1858
  call void @llvm.dbg.value(metadata %class.Packet* %1, metadata !1853, metadata !DIExpression()), !dbg !1858
  %3 = tail call %class.WritablePacket* @_ZN6Packet9uniqueifyEv(%class.Packet* %1), !dbg !1859
  call void @llvm.dbg.value(metadata %class.WritablePacket* %3, metadata !1854, metadata !DIExpression()), !dbg !1858
  %4 = tail call i8* @_ZNK14WritablePacket4dataEv(%class.WritablePacket* %3), !dbg !1860
  %5 = bitcast i8* %4 to %struct.click_ip*, !dbg !1861
  call void @llvm.dbg.value(metadata %struct.click_ip* %5, metadata !1855, metadata !DIExpression()), !dbg !1858
  %6 = getelementptr %class.WritablePacket, %class.WritablePacket* %3, i64 0, i32 0, !dbg !1862
  %7 = tail call i32 @_ZNK6Packet6lengthEv(%class.Packet* %6), !dbg !1862
  call void @llvm.dbg.value(metadata i32 %7, metadata !1856, metadata !DIExpression()), !dbg !1858
  %8 = load i8, i8* %4, align 4, !dbg !1863
  %9 = and i8 %8, 15, !dbg !1863
  %10 = or i8 %9, 64, !dbg !1863
  store i8 %10, i8* %4, align 4, !dbg !1863
  %11 = trunc i32 %7 to i16, !dbg !1864
  %12 = tail call i16 @llvm.bswap.i16(i16 %11) #6
  %13 = getelementptr inbounds i8, i8* %4, i64 2, !dbg !1865
  %14 = bitcast i8* %13 to i16*, !dbg !1865
  store i16 %12, i16* %14, align 2, !dbg !1866, !tbaa !1867
  %15 = getelementptr inbounds %class.ForceIP, %class.ForceIP* %0, i64 0, i32 1, !dbg !1871
  %16 = load i32, i32* %15, align 4, !dbg !1873, !tbaa !1829
  %17 = add nsw i32 %16, 1, !dbg !1873
  store i32 %17, i32* %15, align 4, !dbg !1873, !tbaa !1829
  %18 = and i32 %16, 7, !dbg !1874
  %19 = icmp eq i32 %18, 1, !dbg !1875
  br i1 %19, label %23, label %20, !dbg !1876

20:                                               ; preds = %2
  %21 = getelementptr inbounds i8, i8* %4, i64 6, !dbg !1877
  %22 = bitcast i8* %21 to i16*, !dbg !1877
  store i16 0, i16* %22, align 2, !dbg !1879, !tbaa !1880
  br label %23, !dbg !1881

23:                                               ; preds = %2, %20
  %24 = load i8, i8* %4, align 4, !dbg !1882
  %25 = shl i8 %24, 2, !dbg !1883
  %26 = and i8 %25, 60, !dbg !1883
  %27 = zext i8 %26 to i32, !dbg !1883
  call void @llvm.dbg.value(metadata i32 %27, metadata !1857, metadata !DIExpression()), !dbg !1858
  %28 = icmp ult i8 %26, 20, !dbg !1884
  %29 = icmp ult i32 %7, %27, !dbg !1886
  %30 = or i1 %28, %29, !dbg !1887
  br i1 %30, label %31, label %38, !dbg !1887

31:                                               ; preds = %23
  %32 = lshr i32 %7, 2, !dbg !1888
  %33 = trunc i32 %32 to i8, !dbg !1890
  %34 = and i8 %33, 15, !dbg !1890
  %35 = and i8 %24, -16, !dbg !1890
  %36 = or i8 %35, %34, !dbg !1890
  store i8 %36, i8* %4, align 4, !dbg !1890
  %37 = and i32 %7, 60, !dbg !1891
  br label %38, !dbg !1892

38:                                               ; preds = %23, %31
  %39 = phi i32 [ %27, %23 ], [ %37, %31 ], !dbg !1891
  %40 = getelementptr inbounds i8, i8* %4, i64 10, !dbg !1893
  %41 = bitcast i8* %40 to i16*, !dbg !1893
  store i16 0, i16* %41, align 2, !dbg !1894, !tbaa !1895
  %42 = tail call zeroext i16 @click_in_cksum(i8* nonnull %4, i32 %39), !dbg !1896
  store i16 %42, i16* %41, align 2, !dbg !1897, !tbaa !1895
  tail call void @_ZN6Packet13set_ip_headerEPK8click_ipj(%class.Packet* %6, %struct.click_ip* nonnull %5, i32 %27), !dbg !1898
  ret %class.Packet* %6, !dbg !1899
}
...
declare !dbg !1163 zeroext i16 @click_in_cksum(i8*, i32) local_unnamed_addr #1

declare void @_ZN6Packet13set_ip_headerEPK8click_ipj(%class.Packet*, %struct.click_ip*, i32) local_unnamed_addr #1
...
; Function Attrs: nounwind sspstrong uwtable
define linkonce_odr dso_local i8* @_ZNK7ForceIP10class_nameEv(%class.ForceIP* %0) unnamed_addr #3 comdat align 2 !dbg !1900 {
  call void @llvm.dbg.value(metadata %class.ForceIP* %0, metadata !1902, metadata !DIExpression()), !dbg !1904
  ret i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0), !dbg !1905
}

; Function Attrs: nounwind sspstrong uwtable
define linkonce_odr dso_local i8* @_ZNK7ForceIP10port_countEv(%class.ForceIP* %0) unnamed_addr #3 comdat align 2 !dbg !1906 {
  call void @llvm.dbg.value(metadata %class.ForceIP* %0, metadata !1908, metadata !DIExpression()), !dbg !1909
  ret i8* getelementptr inbounds ([0 x i8], [0 x i8]* @_ZN7Element9PORTS_1_1E, i64 0, i64 0), !dbg !1910
}
...
!1 = !DIFile(filename: "../elements/local/forceip.cc", directory: "/home/john/projects/click/ir-dir")
!2 = !{!3, !857}
...
!1162 = !{!162, !80, !1163, !103}
!1163 = !DISubprogram(name: "click_in_cksum", scope: !164, file: !164, line: 131, type: !1164, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !452)
...
!1795 = distinct !DISubprogram(name: "ForceIP", linkageName: "_ZN7ForceIPC2Ev", scope: !1796, file: !1, line: 25, type: !1804, scopeLine: 26, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1803, retainedNodes: !1817)
!1796 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "ForceIP", file: !1797, line: 26, size: 896, flags: DIFlagTypePassByReference | DIFlagNonTrivial, elements: !1798, vtableHolder: !1800)
!1797 = !DIFile(filename: "../elements/local/forceip.hh", directory: "/home/john/projects/click/ir-dir")
!1798 = !{!1799, !1802, !1803, !1807, !1808, !1813, !1814}
...
!1802 = !DIDerivedType(tag: DW_TAG_member, name: "_count", scope: !1796, file: !1797, line: 28, baseType: !34, size: 32, offset: 864)
!1803 = !DISubprogram(name: "ForceIP", scope: !1796, file: !1797, line: 32, type: !1804, scopeLine: 32, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1804 = !DISubroutineType(types: !1805)
!1805 = !{null, !1806}
!1806 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1796, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1807 = !DISubprogram(name: "~ForceIP", scope: !1796, file: !1797, line: 33, type: !1804, scopeLine: 33, containingType: !1796, virtualIndex: 0, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual | DISPFlagOptimized)
!1808 = !DISubprogram(name: "class_name", linkageName: "_ZNK7ForceIP10class_nameEv", scope: !1796, file: !1797, line: 35, type: !1809, scopeLine: 35, containingType: !1796, virtualIndex: 9, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual | DISPFlagOptimized)
!1809 = !DISubroutineType(types: !1810)
!1810 = !{!566, !1811}
!1811 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1812, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1812 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1796)
!1813 = !DISubprogram(name: "port_count", linkageName: "_ZNK7ForceIP10port_countEv", scope: !1796, file: !1797, line: 36, type: !1809, scopeLine: 36, containingType: !1796, virtualIndex: 10, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual | DISPFlagOptimized)
!1814 = !DISubprogram(name: "simple_action", linkageName: "_ZN7ForceIP13simple_actionEP6Packet", scope: !1796, file: !1797, line: 38, type: !1815, scopeLine: 38, containingType: !1796, virtualIndex: 4, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagVirtual | DISPFlagOptimized)
!1815 = !DISubroutineType(types: !1816)
!1816 = !{!78, !1806, !78}
!1817 = !{!1818}
!1818 = !DILocalVariable(name: "this", arg: 1, scope: !1795, type: !1819, flags: DIFlagArtificial | DIFlagObjectPointer)
!1819 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1796, size: 64)
!1820 = !DILocation(line: 0, scope: !1795)
!1821 = !DILocation(line: 26, column: 1, scope: !1795)
!1822 = !DILocation(line: 25, column: 10, scope: !1795)
!1823 = !{!1824, !1824, i64 0}
!1824 = !{!"vtable pointer", !1825, i64 0}
!1825 = !{!"Simple C++ TBAA"}
!1826 = !DILocation(line: 27, column: 3, scope: !1827)
!1827 = distinct !DILexicalBlock(scope: !1795, file: !1, line: 26, column: 1)
!1828 = !DILocation(line: 27, column: 10, scope: !1827)
!1829 = !{!1830, !1831, i64 108}
!1830 = !{!"_ZTS7ForceIP", !1831, i64 108}
!1831 = !{!"int", !1832, i64 0}
!1832 = !{!"omnipotent char", !1825, i64 0}
!1833 = !DILocation(line: 28, column: 1, scope: !1795)
!1834 = distinct !DISubprogram(name: "~ForceIP", linkageName: "_ZN7ForceIPD2Ev", scope: !1796, file: !1, line: 30, type: !1804, scopeLine: 31, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1807, retainedNodes: !1835)
!1835 = !{!1836}
!1836 = !DILocalVariable(name: "this", arg: 1, scope: !1834, type: !1819, flags: DIFlagArtificial | DIFlagObjectPointer)
!1837 = !DILocation(line: 0, scope: !1834)
!1838 = !DILocation(line: 32, column: 1, scope: !1839)
!1839 = distinct !DILexicalBlock(scope: !1834, file: !1, line: 31, column: 1)
!1840 = !DILocation(line: 32, column: 1, scope: !1834)
!1841 = distinct !DISubprogram(name: "~ForceIP", linkageName: "_ZN7ForceIPD0Ev", scope: !1796, file: !1, line: 30, type: !1804, scopeLine: 31, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1807, retainedNodes: !1842)
!1842 = !{!1843}
!1843 = !DILocalVariable(name: "this", arg: 1, scope: !1841, type: !1819, flags: DIFlagArtificial | DIFlagObjectPointer)
!1844 = !DILocation(line: 0, scope: !1841)
!1845 = !DILocation(line: 0, scope: !1834, inlinedAt: !1846)
!1846 = distinct !DILocation(line: 31, column: 1, scope: !1841)
!1847 = !DILocation(line: 32, column: 1, scope: !1839, inlinedAt: !1846)
!1848 = !DILocation(line: 31, column: 1, scope: !1841)
!1849 = !DILocation(line: 32, column: 1, scope: !1841)
!1850 = distinct !DISubprogram(name: "simple_action", linkageName: "_ZN7ForceIP13simple_actionEP6Packet", scope: !1796, file: !1, line: 35, type: !1815, scopeLine: 36, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1814, retainedNodes: !1851)
!1851 = !{!1852, !1853, !1854, !1855, !1856, !1857}
!1852 = !DILocalVariable(name: "this", arg: 1, scope: !1850, type: !1819, flags: DIFlagArtificial | DIFlagObjectPointer)
!1853 = !DILocalVariable(name: "p_in", arg: 2, scope: !1850, file: !1, line: 35, type: !78)
!1854 = !DILocalVariable(name: "p", scope: !1850, file: !1, line: 37, type: !140)
!1855 = !DILocalVariable(name: "ip", scope: !1850, file: !1, line: 38, type: !162)
!1856 = !DILocalVariable(name: "plen", scope: !1850, file: !1, line: 39, type: !16)
!1857 = !DILocalVariable(name: "hlen", scope: !1850, file: !1, line: 48, type: !16)
!1858 = !DILocation(line: 0, scope: !1850)
!1859 = !DILocation(line: 37, column: 29, scope: !1850)
!1860 = !DILocation(line: 38, column: 50, scope: !1850)
!1861 = !DILocation(line: 38, column: 18, scope: !1850)
!1862 = !DILocation(line: 39, column: 22, scope: !1850)
!1863 = !DILocation(line: 41, column: 12, scope: !1850)
!1864 = !DILocation(line: 42, column: 16, scope: !1850)
!1865 = !DILocation(line: 42, column: 7, scope: !1850)
!1866 = !DILocation(line: 42, column: 14, scope: !1850)
!1867 = !{!1868, !1869, i64 2}
!1868 = !{!"_ZTS8click_ip", !1831, i64 0, !1831, i64 0, !1832, i64 1, !1869, i64 2, !1869, i64 4, !1869, i64 6, !1832, i64 8, !1832, i64 9, !1869, i64 10, !1870, i64 12, !1870, i64 16}
!1869 = !{!"short", !1832, i64 0}
!1870 = !{!"_ZTS7in_addr", !1831, i64 0}
!1871 = !DILocation(line: 44, column: 7, scope: !1872)
!1872 = distinct !DILexicalBlock(scope: !1850, file: !1, line: 44, column: 6)
!1873 = !DILocation(line: 44, column: 13, scope: !1872)
!1874 = !DILocation(line: 44, column: 16, scope: !1872)
!1875 = !DILocation(line: 44, column: 21, scope: !1872)
!1876 = !DILocation(line: 44, column: 6, scope: !1850)
!1877 = !DILocation(line: 45, column: 9, scope: !1878)
!1878 = distinct !DILexicalBlock(scope: !1872, file: !1, line: 44, column: 26)
!1879 = !DILocation(line: 45, column: 16, scope: !1878)
!1880 = !{!1868, !1869, i64 6}
!1881 = !DILocation(line: 46, column: 3, scope: !1878)
!1882 = !DILocation(line: 48, column: 23, scope: !1850)
!1883 = !DILocation(line: 48, column: 29, scope: !1850)
!1884 = !DILocation(line: 49, column: 11, scope: !1885)
!1885 = distinct !DILexicalBlock(scope: !1850, file: !1, line: 49, column: 6)
!1886 = !DILocation(line: 49, column: 38, scope: !1885)
!1887 = !DILocation(line: 49, column: 30, scope: !1885)
!1888 = !DILocation(line: 50, column: 22, scope: !1889)
!1889 = distinct !DILexicalBlock(scope: !1885, file: !1, line: 49, column: 45)
!1890 = !DILocation(line: 50, column: 15, scope: !1889)
!1891 = !DILocation(line: 54, column: 62, scope: !1850)
!1892 = !DILocation(line: 51, column: 3, scope: !1889)
!1893 = !DILocation(line: 53, column: 7, scope: !1850)
!1894 = !DILocation(line: 53, column: 14, scope: !1850)
!1895 = !{!1868, !1869, i64 10}
!1896 = !DILocation(line: 54, column: 16, scope: !1850)
!1897 = !DILocation(line: 54, column: 14, scope: !1850)
!1898 = !DILocation(line: 56, column: 6, scope: !1850)
!1899 = !DILocation(line: 58, column: 3, scope: !1850)
!1900 = distinct !DISubprogram(name: "class_name", linkageName: "_ZNK7ForceIP10class_nameEv", scope: !1796, file: !1797, line: 35, type: !1809, scopeLine: 35, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1808, retainedNodes: !1901)
!1901 = !{!1902}
!1902 = !DILocalVariable(name: "this", arg: 1, scope: !1900, type: !1903, flags: DIFlagArtificial | DIFlagObjectPointer)
!1903 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1812, size: 64)
!1904 = !DILocation(line: 0, scope: !1900)
!1905 = !DILocation(line: 35, column: 37, scope: !1900)
!1906 = distinct !DISubprogram(name: "port_count", linkageName: "_ZNK7ForceIP10port_countEv", scope: !1796, file: !1797, line: 36, type: !1809, scopeLine: 36, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1813, retainedNodes: !1907)
!1907 = !{!1908}
!1908 = !DILocalVariable(name: "this", arg: 1, scope: !1906, type: !1903, flags: DIFlagArtificial | DIFlagObjectPointer)
!1909 = !DILocation(line: 0, scope: !1906)
!1910 = !DILocation(line: 36, column: 37, scope: !1906)
